            ...
            if (Helper.TrustTest(publicKey, token))
            {
                if (obj != null)
                {
                    ...
                    if (objFromDB == null)
                    {
                        ...
                        if (obj.ThongTinNhanVien.HasValue && obj.WebGroupID.HasValue && obj.WebGroupID == new Guid("00000000-0000-0000-0000-000000000008"))
                        {
                            objForSave.GiangVienThinhGiang = obj.ThongTinNhanVien;
                            objForSave.ThongTinNhanVien = null;
                        }
                    }
                    else
                    {
