...
namespace HRMWeb_Service
{
    ...
    public partial class Service1 : IService1
    {
                    ...
                    foreach (var obj in objList)
                    {
                        if (obj != null)
                        {
                            ...
                            if (objFromDB.TrangThai != 1)
                            {
                                ...
                                {
                                    HRMWebApp.Helpers.Helper.ErrorLog("ChamCongNgayNghi_AcceptList", ex);
                                    throw ex;
                                }                             
                            }
                        }
                    ...
                    foreach (var obj in objList)
                    {
                        if (obj != null)
                        {
                            ...
                            if (objFromDB.TrangThai != 0)
                            {
                                ...
                                {
                                    HRMWebApp.Helpers.Helper.ErrorLog("ChamCongNgayNghi_CancelList", ex);
                                    throw ex;
                                }
                            }
                        }
        ...
        {
            return CC_ChamCongNgayNghi_Factory.New().KiemTraTruNgayDiDuong(nam, idNhanVien);
        }
        ...
        {//DANG SD
            if (Helper.TrustTest(publicKey, token))
            {
                    ...
                    TimeSpan.FromSeconds(360)))
                {
                    ...
                    {
                        HRMWebApp.Helpers.Helper.ErrorLog("ChamCongNgayNghi_TaoMoi", ex);
                        throw ex;
                    }
                }
            }
        ...
        public bool ChamCongNgayNghi_DeleteList(String publicKey, String token, List<DTO_ChamCongNgayNghi_Find> objList)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                    ...
                    TimeSpan.FromSeconds(360)))
                {
                    ...
                    foreach (var obj in objList)
                    {
                        if (obj != null)
                        {
                            ...
                            if (objFromDB.TrangThai != 1)
                            {
                                ...
                                {
                                    HRMWebApp.Helpers.Helper.ErrorLog("ChamCongNgayNghi_DeleteList", ex);
                                    throw ex;
                                }
                            }
                        }
                    ...
                    {
                        HRMWebApp.Helpers.Helper.ErrorLog("ChamCongNgayNghi_DeleteList 2", ex);
                        throw ex;
                    }
                }
                return false;
