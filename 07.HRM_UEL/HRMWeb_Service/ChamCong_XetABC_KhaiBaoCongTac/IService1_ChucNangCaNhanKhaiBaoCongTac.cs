...
namespace HRMWeb_Service
{
    public partial interface IService1
    {
        ...
        [OperationContract]
        DTO_CC_KhaiBaoCongTac CaNhanKhaiBaoCongTac_KhaiBaoMoi(String publicKey, String token, String noiDung, String diaDiem, DateTime tuNgay, DateTime denNgay, byte buoi, int gioBatDau, int phutBatDau, int gioKetThuc, int phutKetThuc, Guid webUserId);
