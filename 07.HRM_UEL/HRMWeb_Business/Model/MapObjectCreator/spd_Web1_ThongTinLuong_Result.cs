...
namespace HRMWeb_Business.Model.MapObjectCreator
{
    ...
    [DataContract]
    public partial class spd_Web1_ThongTinLuong_Result
    {
    	[DataMember]
    	...
    	[DataMember]
        public Nullable<int> PCDacBiet { get; set; }
    	[DataMember]
        public Nullable<int> PCDacThu { get; set; }
    	[DataMember]
    	...
    	[DataMember]
        public Nullable<int> HSPCKiemNhiem2 { get; set; }
    	[DataMember]
