...
namespace HRMWeb_Business.Model.MapObjectCreator
{
    ...
    public partial class Mdl_CC_QuanLyViPham
    {
        /*
    	ko xai
    	public Mdl_CC_QuanLyViPham()
        {
            this.CC_QuanLyViPham_File = new HashSet<Mdl_CC_QuanLyViPham_File>();
        }*/
    	...
    	[DataMember]
        public Nullable<int> TrangThai_HD { get; set; }
    	...
    	//[DataMember]
        //public virtual ICollection<Mdl_CC_QuanLyViPham_File> CC_QuanLyViPham_File { get; set; }
    }
}
