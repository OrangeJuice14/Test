...
namespace HRMWeb_Business.Model
{
    ...
    public partial class WebUser : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_CC_DangKyChamCongNgoaiGio_WebUsers", "CC_DangKyChamCongNgoaiGio")]
        public EntityCollection<CC_DangKyChamCongNgoaiGio> CC_DangKyChamCongNgoaiGio
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<CC_DangKyChamCongNgoaiGio>("ERPModel.FK_CC_DangKyChamCongNgoaiGio_WebUsers", "CC_DangKyChamCongNgoaiGio");
            }
            set
            {
                if ((value != null))
                {
    				...
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<CC_DangKyChamCongNgoaiGio>("ERPModel.FK_CC_DangKyChamCongNgoaiGio_WebUsers", "CC_DangKyChamCongNgoaiGio", value);
