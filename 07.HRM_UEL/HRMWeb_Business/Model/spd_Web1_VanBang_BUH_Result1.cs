...
namespace HRMWeb_Business.Model
{
    ...
    /// </summary>
    [EdmComplexTypeAttribute(NamespaceName="ERPModel", Name="spd_Web1_VanBang_BUH_Result1")]
    [DataContractAttribute(IsReference=true)]
    [Serializable()]
    public partial class spd_Web1_VanBang_BUH_Result1 : ComplexObject
    {
        #region Factory Method
    
        /// <summary>
        /// Create a new spd_Web1_VanBang_BUH_Result1 object.
        /// </summary>
        /// <param name="xepLoai">Initial value of the XepLoai property.</param>
        public static spd_Web1_VanBang_BUH_Result1 Createspd_Web1_VanBang_BUH_Result1(string xepLoai)
        {
            spd_Web1_VanBang_BUH_Result1 spd_Web1_VanBang_BUH_Result1 = new spd_Web1_VanBang_BUH_Result1();
            spd_Web1_VanBang_BUH_Result1.XepLoai = xepLoai;
            return spd_Web1_VanBang_BUH_Result1;
        }
