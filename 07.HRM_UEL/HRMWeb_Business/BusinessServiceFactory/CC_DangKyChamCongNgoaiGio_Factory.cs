...
namespace HRMWeb_Business.BusinessServiceFactory
{
    public class CC_DangKyChamCongNgoaiGio_Factory : BaseFactory<Entities, CC_DangKyChamCongNgoaiGio>
    {
        ...
        public IQueryable<DTO_CC_DangKyChamCongNgoaiGio> QuanLyDangKyChamCongNgoaiGio_Find(DateTime? tuNgay, DateTime? denNgay, Guid IDBoPhan, byte? trangthai)
        {
            var result = (from o in this.ObjectSet
                          where o.IDBoPhan == IDBoPhan
                          && o.Ngay >= tuNgay && o.Ngay <= denNgay
                          && (trangthai == null || o.Duyet == trangthai)
                          orderby o.Ngay.Value
                          select new DTO_CC_DangKyChamCongNgoaiGio()
                          {
                              Oid = o.Oid,
