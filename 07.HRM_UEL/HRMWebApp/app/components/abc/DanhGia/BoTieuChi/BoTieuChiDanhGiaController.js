...
define(['app/app',
    'app/components/abc/DanhGia/DanhGiaDongNghiep/ListDongNghiep/ListDongNghiepController',
    ...
    'app/services/abc/ABC_UserDanhGiaService'], function (app) {
        ...
        app.controller('BoTieuChiDanhGiaController',
            ['$scope', '$rootScope', '$timeout', '$modal', '$state', '$stateParams', '$modalInstance', 'KyDanhGiaId', 'ABC_ListDongNghiepService', 'ABC_UserDanhGiaService',
                function ($scope, $rootScope, $timeout, $modal, $state, $stateParams, $modalInstance, KyDanhGiaId, ABC_ListDongNghiepService, ABC_UserDanhGiaService) {
                    ...
                    var GetUserNow = new Promise(function (resolve, reject) {
                        ABC_UserDanhGiaService.GetUserAndListBoTieuChiPhanQuyen($rootScope.session.UserId, $scope.KyDanhGiaId).then(res => {
                            if (res.data == null) {
                                reject();
                                $scope.User = "ERRORS";
                            } else {
