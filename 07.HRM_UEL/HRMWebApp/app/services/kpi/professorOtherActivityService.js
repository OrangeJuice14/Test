define(['app/app'], function (app) {
    ...
    app.factory('professorOtherActivityService', ['$http', '$q', function ($http, $q) {
        return {
            ...
            getMaxOrderNumberActivity: function (planKPIDetailId) {
                return $http.get('/Api/professorOtherActivityApi/GetMaxOrderNumberActivity?planKPIDetailId=' + planKPIDetailId);
            },
            Save: function (Obj)
            {
