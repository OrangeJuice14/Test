define(['app/app'], function (app) {
    ...
    app.factory('ABC_CriterionService', ['$http', '$q', function ($http, $q) {
        ...
        serviceResult.getListByRatingType = function (ratingType) {
            return $http.get('/Api/ABC_CriterionApi/GetListByRatingType?ratingTypeId=' + ratingType);
        }
        ...
        serviceResult.saveCriterionsOfRatingTypes = function (Obj) {
            var deferred = $q.defer();
            $http({
                method: 'Put',
                url: '/Api/ABC_CriterionApi/PutCriterionsOfRatingTypes',
                data: Obj
            }).success(function (result) {
                deferred.resolve(result);
            });
        ...
        serviceResult.saveRatingDetailOfCriterions = function (Obj) {
            var deferred = $q.defer();
            $http({
                method: 'Put',
                url: '/Api/ABC_CriterionApi/PutRatingDetailOfCriterions',
                data: Obj
            }).success(function (result) {
                deferred.resolve(result);
            });
        ...
        serviceResult.saveCriterionDetailsOfCriterionCopys = function (Obj) {
            var deferred = $q.defer();
            $http({
                method: 'Put',
                url: '/Api/ABC_CriterionApi/PutCriterionDetailsOfCriterionCopys',
                data: Obj
            }).success(function (result) {
                deferred.resolve(result);
            });
