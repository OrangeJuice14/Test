define(['app/app'], function (app) {
    ...
    app.factory('ABC_UserDanhGiaService', ['$http', '$q', function ($http, $q) {
        ...
        serviceResult.GetUserWithGroupDanhGiaId = function (userId, kyDanhGiaId, groupDanhGiaId) {
            return $http.get('/Api/ABC_UserDanhGiaApi/GetUserWithGroupDanhGiaId?userId=' + userId + '&kyDanhGiaId=' + kyDanhGiaId + '&groupDanhGiaId=' + groupDanhGiaId);
        }

        serviceResult.GetUserAndListBoTieuChiPhanQuyen = function (userId, kyDanhGiaId) {
            return $http.get('/Api/ABC_UserDanhGiaApi/GetUserAndListBoTieuChiPhanQuyen?userId=' + userId + '&kyDanhGiaId=' + kyDanhGiaId);
        }
        serviceResult.GetUser = function (userId, kyDanhGiaId) {
            return $http.get('/Api/ABC_UserDanhGiaApi/GetUser?userId=' + userId + '&kyDanhGiaId=' + kyDanhGiaId);
        }
        ...
        serviceResult.GetListUserDanhGiaInDonVi = function (boTieuChiId, kyDanhGiaId, userId, groupDanhGiaId, donViId) {
            return $http.get('/Api/ABC_UserDanhGiaApi/GetListUserDanhGiaInDonVi?boTieuChiId=' + boTieuChiId + '&kyDanhGiaId=' + kyDanhGiaId + '&userId=' + userId + '&groupDanhGiaId= ' + groupDanhGiaId + '&donViId=' + donViId);
        }
