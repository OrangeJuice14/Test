define(['app/app'], function (app) {
    ...
    app.factory('evaluationBoardService', ['$http', '$q', function ($http, $q) {
        ...
        serviceResult.getListStaffByDepartment = function (departmentId) {
            return $http.get('/Api/aBC_EvaluationBoardApi/GetListStaffByDepartment?departmentId=' + departmentId);
        }
        ...
        serviceResult.getCheckTimeRating = function (evaluationId) {
            return $http.get('/Api/aBC_EvaluationBoardApi/GetCheckTimeRating?evaluationId=' + evaluationId);
        }
