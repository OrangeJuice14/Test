define(['angularAMD', 'ui-route', 'ui-validate', 'ui-bootstrap', 'kendo', 'ui-bootstrap-tpls', 'ckeditor', 'angular-sanitize'], function (angularAMD) {
    "use strict";
    ...
    HRMWebApp.config(['$stateProvider', '$urlRouterProvider', '$locationProvider', function ($stateProvider, $urlRouterProvider, $locationProvider) {
        ...
        $stateProvider.state('site', {
            ...
            .state('quanlyvipham_report', angularAMD.route({
                data: {
                    roles: ['kpi/quanlyvipham_report']
                },
                resolve: {
                    authorize: ['authorization',
                        function (authorization) {
                ...
                url: '/kpi/quanlyvipham_report',
                templateUrl: '/app/views/chamcong/QuanLyChamCong/QuanLyViPham_ThongKe.html'
            }))
            // Bang luong
            ...
            // Bang luong thỉnh giảng
            .state('bangluongthinhgiang', angularAMD.route({
                data: {
                    roles: ['kpi/bangluongthinhgiang']
                },
                resolve: {
                    authorize: ['authorization',
                        function (authorization) {
                ...
                url: '/kpi/bangluongthinhgiang',
                templateUrl: '/app/views/chamcong/BangLuong/ManageThinhGiang.html'
            }))
            ...
            .state('evaluationBoardInformation', angularAMD.route({
                data: {
                    roles: ['kpi/evaluationBoardInformation']
                },
                url: '/kpi/evaluationBoardInformation',
                templateUrl: '/app/views/abc/evaluationBoardInformation/manage.html',
                controller: 'evaluationBoardInformationController',
                controllerUrl: 'app/controllers/abc/evaluationBoardInformationController'
            }))
            .state('ABC_RatingDetail', angularAMD.route({
                ...
                templateUrl: '/app/views/abc/ABC_RatingDetail/manageAll.html',
            ...
            //.state('ABC_RatingTypeUserRole', angularAMD.route({
            //    data: {
            //        role: ['kpi/ABC_RatingTypeUserRole']
            //    },
            //    url: '/kpi/ABC_RatingTypeUserRole',
            ...
            .state('userClassEvaluationBoard', angularAMD.route({
                data: {
                    roles: ['kpi/userClassEvaluationBoard']
                },
                url: '/kpi/userClassEvaluationBoard',
                templateUrl: '/app/views/abc/ABC_ClassEvaluationBoard/manage.html',
                controller: 'ABC_ClassEvaluationBoardController',
                controllerUrl: 'app/controllers/abc/ABC_ClassEvaluationBoardController'
            }))
            .state('ABC_ClassRatingDetail', angularAMD.route({
                data: {
                    roles: ['kpi/ABC_ClassRatingDetail']
                },
                url: '/kpi/ABC_ClassRatingDetail/:evaluationId/:staffId/:supervisorId/:departmentId/:isAdminRating/:isSupervisor',
                templateUrl: '/app/views/abc/ABC_ClassRatingDetail/manage.html',
                controller: 'ABC_ClassRatingDetailController',
                controllerUrl: 'app/controllers/abc/ABC_ClassRatingDetailController'
            }))
            .state('PhanQuyenBoPhanDuToan', angularAMD.route({
                url: '/kpi/PhanQuyenBoPhanDuToan',
                views: {
                    '': { templateUrl: '/app/views/kpi/PhanQuyenBoPhanDuToan/PhanQuyenBoPhanDuToan.html' },
                    'staff@PhanQuyenBoPhanDuToan': angularAMD.route({
                        templateUrl: '/app/views/kpi/PhanQuyenBoPhanDuToan/PhanQuyenBoPhanDuToan.Staffs.html',
                        controller: 'StaffPhanQuyenBoPhanDuToanController',
                        controllerUrl: 'app/controllers/kpi/PhanQuyenBoPhanDuToanController'
                    }),
                    'department@PhanQuyenBoPhanDuToan': angularAMD.route({
                        templateUrl: '/app/views/kpi/PhanQuyenBoPhanDuToan/PhanQuyenBoPhanDuToan.Departments.html',
                        controller: 'DepartmentPhanQuyenBoPhanDuToanController',
                        controllerUrl: 'app/controllers/kpi/PhanQuyenBoPhanDuToanController'
                    })
                }
            }))
            //-------------------------------------------------------------ABC_Quản lý DanhGia New-------------------------------------------------
            .state('QuanLyKyDanhGia', angularAMD.route({
                data: {
                    roles: ['kpi/QuanLyKyDanhGia']
                },
                url: '/kpi/QuanLyKyDanhGia',
                templateUrl: '/app/components/abc/QuanLyDanhGia/QuanLyKyDanhGia/QuanLyKyDanhGia.html',
                controller: 'QuanLyKyDanhGiaController',
                controllerUrl: 'app/components/abc/QuanLyDanhGia/QuanLyKyDanhGia/QuanLyKyDanhGiaController'
            }))
            .state('QuanLyBoTieuChi', angularAMD.route({
                data: {
                    roles: ['kpi/QuanLyBoTieuChi']
                },
                url: '/kpi/QuanLyBoTieuChi',
                templateUrl: '/app/components/abc/QuanLyDanhGia/BoTieuChi/BoTieuChi.html',
                controller: 'BoTieuChiController',
                controllerUrl: 'app/components/abc/QuanLyDanhGia/BoTieuChi/BoTieuChiController'
            }))
            .state('QuanLyTieuChi', angularAMD.route({
                url: '/kpi/TieuChi/:BoTieuChiId',
                templateUrl: '/app/components/abc/QuanLyDanhGia/TieuChi/TieuChi.html',
                controller: 'TieuChiController',
                controllerUrl: 'app/components/abc/QuanLyDanhGia/TieuChi/TieuChiController'
            }))
            .state('ABC_GroupDanhGia', angularAMD.route({
                url: '/kpi/ABC_GroupDanhGia',
                templateUrl: '/app/components/abc/QuanLyDanhGia/GroupDanhGia/GroupDanhGia.html',
                controller: 'GroupDanhGiaController',
                controllerUrl: 'app/components/abc/QuanLyDanhGia/GroupDanhGia/GroupDanhGiaController'
            }))
            .state('ABC_UserGroupDanhGiaRole', angularAMD.route({
                url: '/kpi/ABC_UserGroupDanhGiaRole',
                templateUrl: '/app/components/abc/QuanLyDanhGia/UserGroupDanhGiaRole/UserGroupDanhGiaRole.html',
                controller: 'UserGroupDanhGiaRoleController',
                controllerUrl: 'app/components/abc/QuanLyDanhGia/UserGroupDanhGiaRole/UserGroupDanhGiaRoleController'
            }))
            .state('ABC_QuanLyDonVi', angularAMD.route({
                url: '/kpi/ABC_QuanLyDonVi',
                views: {
                    '': { templateUrl: '/app/components/abc/QuanLyDanhGia/QuanLyDonVi/QuanLyDonVi.html' },
                    'staff@ABC_QuanLyDonVi': angularAMD.route({
                        templateUrl: '/app/components/abc/QuanLyDanhGia/QuanLyDonVi/QuanLyDonVi.Staffs.html',
                        controller: 'StaffQuanLyDonViController',
                        controllerUrl: 'app/components/abc/QuanLyDanhGia/QuanLyDonVi/StaffQuanLyDonViController'
                    }),
                    'department@ABC_QuanLyDonVi': angularAMD.route({
                        templateUrl: '/app/components/abc/QuanLyDanhGia/QuanLyDonVi/QuanLyDonVi.Departments.html',
                        controller: 'DepartmentQuanLyDonViController',
                        controllerUrl: 'app/components/abc/QuanLyDanhGia/QuanLyDonVi/DepartmentQuanLyDonViController'
                    })
                }
            }))
            //------------------------------------------------------ Đánh giá ------------------------------------------------------
            .state('ABC_KyDanhGia', angularAMD.route({
                url: '/kpi/ABC_KyDanhGia',
                templateUrl: '/app/components/abc/DanhGia/KyDanhGia/KyDanhGia.html',
                controller: 'KyDanhGiaController',
                controllerUrl: 'app/components/abc/DanhGia/KyDanhGia/KyDanhGiaController'
            }))
            .state('TuDanhGia', angularAMD.route({
                url: '/kpi/ABC_TuDanhGia/:KyDanhGiaId/:BoTieuChiId/:GroupDanhGiaId',
                templateUrl: '/app/components/abc/DanhGia/TuDanhGia/TuDanhGia.html',
                controller: 'TuDanhGiaController',
                controllerUrl: 'app/components/abc/DanhGia/TuDanhGia/TuDanhGiaController'
            }))
            .state('DanhGiaDongNghiep', angularAMD.route({
                url: '/kpi/DanhGiaDongNghiep/:KyDanhGiaId/:BoTieuChiId/:GroupDanhGiaId/:NhanVienWebUserId',
                templateUrl: '/app/components/abc/DanhGia/DanhGiaDongNghiep/DanhGiaDongNghiep.html',
                controller: 'DanhGiaDongNghiepController',
                controllerUrl: 'app/components/abc/DanhGia/DanhGiaDongNghiep/DanhGiaDongNghiepController'
            }))
    }]);
    ...
    HRMWebApp.run(['$rootScope', '$state', '$stateParams', '$rootElement', 'authorization', 'principal',
        function ($rootScope, $state, $stateParams, $rootElement, authorization, principal) {
            $rootScope.$on('$stateChangeStart', function (event, toState, toStateParams) {
                ...
                //mobile và tablet khi chuyển trang sẽ ẩn menu
                if ($(window).width() <= 991) {
