...
namespace HRMWebApp.ChamCong.Core.Controllers
{
    public class WebServicesController : Controller
    {
        ...
        public ActionResult Save_QuanLyUser(QuanLyUser obj)
        {
            ...
            return _service.Save_WebUser_Json(PublicKey, _token, jsonObject.Content).ToJSON();
        }
        ...
        public ActionResult Save_DangKyChamCongNgoaiGio(DangKyChamCongNgoaiGio obj, Guid idwebuser)
        {
            //var js = new JavaScriptSerializer();
            var jsonObject = obj.ToJSON();
            _service.Save_DangKyChamCongNgoaiGio_Json(PublicKey, _token, jsonObject.Content, idwebuser);
            return Helper.JsonSucess();
        }
        ...
        public ActionResult ChamCongNhanh(DateTime tuNgay, DateTime denNgay, string idHinhThucNghi, string idBoPhan, string idLoaiNhanSu, string webUserId)
        {
            ...
            return _service.ChamCongNhanh(PublicKey, _token, tuNgay, denNgay, formatHinhThucNghiId, formatBoPhanId, formatLoaiNhanSuId, new Guid(webUserId)).ToJSON();
        }
        ...
        public string QuanLyDangKyChamCongNgoaiGio_Find(DateTime? tuNgay, DateTime? denNgay, string IDBoPhan,byte? trangthai)
        {
            return _service.QuanLyDangKyChamCongNgoaiGio_Find_Json(PublicKey, _token, tuNgay, denNgay, new Guid(IDBoPhan), trangthai);
        }
        ...
        public string TongHopTienGiangVaThuNhapKhac(Guid nhanVien, Guid kyTinhLuong, Guid? soChungTu, Guid? kyTinhPMS)
        {
            return _service.TongHopTienGiangVaThuNhapKhac(PublicKey, _token, nhanVien, kyTinhLuong, soChungTu, kyTinhPMS);
        }
        ...
        public string ChiTietThanhToanPMS(Guid nhanVien, Guid kyTinhLuong, Guid? soChungTu, Guid? kyTinhPMS)
        {
            return _service.ChiTietThanhToanPMS(PublicKey, _token, nhanVien, kyTinhLuong, soChungTu, kyTinhPMS);
        }
        public string ChiTietTheoDoiTruTietChuan(Guid nhanVien, Guid kyTinhLuong, Guid soChungTu)
        {
            return _service.ChiTietTheoDoiTruTietChuan(PublicKey, _token, nhanVien, kyTinhLuong, soChungTu);
        }
        public string WebUser_KiemTraLoaiNhanVien(string MaQuanLy)
        {
            return _service.WebUser_KiemTraLoaiNhanVien(PublicKey, _token, MaQuanLy);
        }
        public string ThuLaoGiangDay_ThinhGiang(Guid nhanVien, Guid kyTinhLuong, Guid kyTinhPMS)
        {
            return _service.ThuLaoGiangDay_ThinhGiang(PublicKey, _token, nhanVien, kyTinhLuong, kyTinhPMS);
        }
        public string GetNamHocPMS()
        {
            return _service.GetNamHocPMS(PublicKey, _token);
        }
        public string GetKyTinhPMSTheoNamHoc(Guid namHocOid)
        {
            return _service.GetKyTinhPMSTheoNamHoc(PublicKey, _token, namHocOid);
        }
        ...
        public string QuanLyViPham_Find(int ngay, int thang, int nam, string boPhanId, Guid webUserId, Guid? nhanVienId)
        {
            ...
            return _service.QuanLyViPham_Find_Json(PublicKey, _token, ngay, thang, nam, boPhanGuid, webUserId, nhanVienId);
        }
        public string QuanLyViPham_ThongKe_Find(DateTime? tuNgay, DateTime? denNgay, string boPhanId, Guid webUserId, Guid? nhanVienId)
        {
            Guid boPhanGuid = Guid.Empty;
            if (boPhanId!="" && boPhanId!=null)
            {
            ...
            return _service.QuanLyViPham_ThongKe_Find(PublicKey, _token, tuNgay, denNgay, boPhanGuid, webUserId, nhanVienId);
        }
        public ActionResult QuanLyViPham_UpdateGiaiTrinh(Guid quanLyViPhamOid, string giaiTrinh)
        {
            return _service.QuanLyViPham_UpdateGiaiTrinh(PublicKey, _token, quanLyViPhamOid, giaiTrinh).ToJSON();
        }

        public ActionResult QuanLyViPham_UploadFile(IEnumerable<HttpPostedFileBase> files, Guid quanLyViPhamOid, Guid webUserId)
        {
            string result = "";
            try
            {
                ...
                if (files != null)
                {
                    ...
                    string filePath = "~/" + "Files/QuanLyViPham/" + now.Year;
                    ...
                    foreach (var file in files)
                    {
                        ...
                        var actualFileName = string.Format("{0}{1}", fileId, extension);
                        var physicalPath = System.IO.Path.Combine(Server.MapPath(filePath), actualFileName);
                        ...
                        file.SaveAs(physicalPath); //lưu file vào server

                        //insert vào db
                        _service.QuanLyViPham_SaveFile(PublicKey, _token, filePath + "/" + actualFileName, fileId, fileNameWithoutExtension, extension, file.ContentLength, quanLyViPhamOid, webUserId);
                    }
                }
            }
            catch (Exception e)
        ...
        public ActionResult QuanLyViPham_ThayDoiTrangThaiList(List<DTO_QuanLyViPham_Find> list, Guid webUserId, int trangthai)
        {
            return _service.QuanLyViPham_ThayDoiTrangThaiList(PublicKey, _token, list, webUserId, trangthai).ToJSON();
        }

        public ActionResult QuanLyViPham_RemoveFile(Guid quanLyViPhamFileOid)
        {
            return _service.QuanLyViPham_RemoveFile(PublicKey, _token, quanLyViPhamFileOid).ToJSON();
        }
        ...
        public FileResult DownloadFile(string filePath, string fileName)
        {
            ...
            {
                Helpers.Helper.ErrorLog("WebServicesController/DownloadFile", ex);
                throw;
            }
        }
        ...
        public ActionResult GetDanhMucUpDateHoSoNhanVienAll()
        {
            ...
            //Quốc gia
            result["QuocGia"] = _service.QuanHeGiaDinh_GetListQuocGiaALL(PublicKey, _token);

            //Tỉnh thành
            result["TinhThanh"] = _service.HoSoNhanVien_GetListTinhThanhALL(PublicKey, _token);

            //Tình trạng hôn nhân
            result["TinhTrangHonNhan"] = _service.HoSoNhanVien_GetListTinhTrangHonNhanALL(PublicKey, _token);
            
            //Tôn giáo
            result["TonGiao"] = _service.HoSoNhanVien_GetListTonGiaoALL(PublicKey, _token);

            //Quan hệ
            result["QuanHe"] = _service.QuanHeGiaDinh_GetListQuanHeALL(PublicKey, _token);

            //Loại giảm trừ gia cảnh
            result["LoaiGiamTruGiaCanh"] = _service.QuanHeGiaDinh_GetListLoaiGiamTruGiaCanhALL(PublicKey, _token);

            return Json(result);
        }
        public string HoSoNhanVien_GetByNhanVien(string nhanVienId)
        {
            String json = "";
            Guid thongTinNhanVien = nhanVienId == null ? Guid.Empty : new Guid(nhanVienId);
            json = _service.HoSoNhanVien_GetByNhanVien(PublicKey, _token, thongTinNhanVien);
            return json;
        }
        public ActionResult HoSoNhanVien_CapNhat(Guid Oid, Guid? tonGiao, int? chieuCao, int? canNang, Guid? tinhTrangHonNhan, string cMND, DateTime? ngayCap, Guid? noiCap, string dienThoaiDiDong)
        {
            _service.HoSoNhanVien_CapNhat(PublicKey, _token, Oid, tonGiao, chieuCao, canNang, tinhTrangHonNhan, cMND, ngayCap, noiCap, dienThoaiDiDong);
            return Helper.JsonSucess();
        }
        public string QuanHeGiaDinh_GetByOid(string id)
        {
            String json = "";
            Guid oid = id == null ? Guid.Empty : new Guid(id);
            json = _service.QuanHeGiaDinh_GetByOid(PublicKey, _token, oid);
            return json;
        }
        public ActionResult QuanHeGiaDinh_ThemMoi(Guid? oid, Guid thongTinNhanVien, string hoTenNguoiThan, DateTime? ngaySinhFull, int? namSinh, string noiSinh, Guid? quocTich, string cMND, string soHoChieu, Guid? quanHe, Guid? loaiGiamTruGiaCanh, bool? phuThuoc, bool? lienHeKhanCap, string dienThoaiDiDong, byte? gioiTinh, Guid? queQuan, string ngheNghiepHienTai, string noiLamViec, byte? tinhTrang)
        {
            _service.QuanHeGiaDinh_ThemMoi(PublicKey, _token, oid, thongTinNhanVien, hoTenNguoiThan, ngaySinhFull, namSinh, noiSinh, quocTich, cMND, soHoChieu, quanHe, loaiGiamTruGiaCanh, phuThuoc, lienHeKhanCap, dienThoaiDiDong, gioiTinh, queQuan, ngheNghiepHienTai, noiLamViec, tinhTrang);
            return Helper.JsonSucess();
        }
        public ActionResult QuanHeGiaDinh_CapNhat(Guid oid, Guid thongTinNhanVien, string hoTenNguoiThan, DateTime? ngaySinhFull, int? namSinh, string noiSinh, Guid? quocTich, string cMND, string soHoChieu, Guid? quanHe, Guid? loaiGiamTruGiaCanh, bool? phuThuoc, bool? lienHeKhanCap, string dienThoaiDiDong, byte? gioiTinh, Guid? queQuan, string ngheNghiepHienTai, string noiLamViec, byte? tinhTrang)
        {
            _service.QuanHeGiaDinh_CapNhat(PublicKey, _token, oid, thongTinNhanVien, hoTenNguoiThan, ngaySinhFull, namSinh, noiSinh, quocTich, cMND, soHoChieu, quanHe, loaiGiamTruGiaCanh, phuThuoc, lienHeKhanCap, dienThoaiDiDong, gioiTinh, queQuan, ngheNghiepHienTai, noiLamViec, tinhTrang);
            return Helper.JsonSucess();
        }
        public ActionResult QuanHeGiaDinh_Xoa(Guid oid)
        {
            _service.QuanHeGiaDinh_Xoa(PublicKey, _token, oid);
            return Helper.JsonSucess();
        }
