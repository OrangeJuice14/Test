...
namespace HRMWebApp.KPI.Core.Security
{
    ...
    public class AuthenticationController : Controller
    {
        ...
        public ActionResult LogOff()
        {
            ...
            return HRMWebApp.Helpers.Helper.JsonSucess();
        }


        public async Task<ActionResult> Login(string userName, string password, string captchaString)
        {
            CustomUserManager PCustomUserManager = new CustomUserManager();
            ...
            if (user != null)
            {
                ...
                {
                    user.Redirect_Url = "kpi/HoSoNhanSu";
                }
                else
                {
                    user.Redirect_Url = "kpi/AccountInfo";
                }
                user.Result_Code = 1;
                return user.ToJSON();
            }
        ...
        public ActionResult GetUserSessionInfo()
        {
            ...
            if (currentUserId != null)
            {
                ...
                result.access_token = new Token().GenerateToken(userName, currentUserId);
            }
        ...
        public async Task<ActionResult> Login_GmailCallback(string error, string code)
        {
            ...
            {
                HRMWebApp.Helpers.Helper.ErrorLog("Login_GmailCallback", ex);
                throw ex;
            }
        }
        ...
        private string GetEmail(string accessToken)
        {
            ...
            {
                HRMWebApp.Helpers.Helper.ErrorLog("GetEmail: access_token=" + accessToken, ex);
                throw ex;
            }
        }
    }
