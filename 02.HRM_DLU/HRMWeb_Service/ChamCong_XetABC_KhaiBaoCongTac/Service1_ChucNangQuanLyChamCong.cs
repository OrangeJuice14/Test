...
namespace HRMWeb_Service
{
        ...
        */
        ...
        public IEnumerable<DTO_QuanLyChamCong_Find> QuanLyChamCong_Find(String publicKey, String token, int ngay, int thang, int nam, Guid? boPhanId, int trangThaiChamCong, Boolean? diHoc, String maNhanSu, Guid webUserId, Guid? idLoaiNhanSu)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                ...
                {
                    DateTime date = new DateTime(nam, thang, ngay);
                    list = factory.FindForQuanlyChamCong(date, boPhanId,trangThaiChamCong, diHoc, maNhanSu, webUserId, idLoaiNhanSu);
                }
                else
                {
        ...
        public IEnumerable<DTO_ThoiGianQuetVanTay> ThoiGianQuetVanTay_Find(String publicKey, String token, DateTime tungay, DateTime denngay, Guid nhanvien)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                DateTime denNgay = denngay.AddDays(1).AddSeconds(-1);
                //
                CC_ChamCongTheoNgay_Factory factory = CC_ChamCongTheoNgay_Factory.New();
                IEnumerable<DTO_ThoiGianQuetVanTay> list = factory.Context.spd_WebChamCong_ThoiGianQuetVanTayCanBo(nhanvien,tungay, denNgay).Map<DTO_ThoiGianQuetVanTay>();
                //
                return list.OrderBy(x=>x.STT);
            }
            else
            {
                return null;
        ...
        public IEnumerable<DTO_ThongKeSoGioLamViec> ThongKeSoGioLamViec_Find(String publicKey, String token, DateTime tungay, DateTime denngay, Guid nhanvien)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                DateTime denNgay = denngay.AddDays(1).AddSeconds(-1);
                //
                CC_ChamCongTheoNgay_Factory factory = CC_ChamCongTheoNgay_Factory.New();
                IEnumerable<DTO_ThongKeSoGioLamViec> list = factory.Context.spd_WebChamCong_ThongKeSoGioLamViecCanBo(nhanvien, tungay, denNgay).Map<DTO_ThongKeSoGioLamViec>();
                //
                return list.OrderBy(x => x.STT);
            }
            else
        ...
        public String ThoiGianQuetVanTay_Find_Json(String publicKey, String token, DateTime tungay, DateTime denngay, Guid nhanvien)
        {//DANG SD
            IEnumerable<DTO_ThoiGianQuetVanTay> list = ThoiGianQuetVanTay_Find(publicKey, token, tungay,denngay,nhanvien);
            String json = JsonConvert.SerializeObject(list);
            return json;
        }

        public String ThongKeSoGioLamViec_Find_Json(String publicKey, String token, DateTime tungay, DateTime denngay, Guid nhanvien)
        {//DANG SD
            IEnumerable<DTO_ThongKeSoGioLamViec> list = ThongKeSoGioLamViec_Find(publicKey, token, tungay, denngay, nhanvien);
            String json = JsonConvert.SerializeObject(list);
            return json;
        }
   ...
   int ngay, int thang, int nam, Guid nhanVienID)
        ...
        public IEnumerable<DTO_QuanLyChamCong_ThongTinChamCongThang> QuanLyChamCong_ThongTinChamCongThang(String publicKey, String token, int thang, int nam, Guid boPhanId, String maNhanSu, Guid idLoaiNhanSu)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                CC_ChamCongTheoNgay_Factory factory = CC_ChamCongTheoNgay_Factory.New();
        ...
        public String QuanLyChamCong_ThongTinChamCongThang_Json(String publicKey, String token, int thang, int nam, Guid boPhanId, String maNhanSu, Guid idLoaiNhanSu)
        {
        ...
        public IEnumerable<DTO_QuanLyChamCong_ThongTinChamCongThang> QuanLyChamCong_ThongTinChamCongThang_Cua1NhanVien(String publicKey, String token, int thang, int nam, Guid nhanVienID)
        {
            if (Helper.TrustTest(publicKey, token))
            {
        ...
        public String QuanLyChamCong_ThongTinChamCongThang_Cua1NhanVien_Json(String publicKey, String token, int thang, int nam, Guid nhanVienID)
        {
            //
