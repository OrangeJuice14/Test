    ...
    public partial class Service1 : IService1
    {
        ...
        {//DANG SD
            if (Helper.TrustTest(publicKey, token))
            {
                ...
                {
                        Boolean daChamCong = (idHinhThucNghi != HinhThucNghiConst.KhongXacDinhId && idHinhThucNghi != HinhThucNghiConst.NghiKhongLuongId);

                        factory.Context.spd_WebChamCong_TaoDanhSachChoCaThang(thang, nam,idHinhThucNghi, webUserId, daChamCong);
