...
namespace HRMWeb_Service
{
    public partial interface IService1
    {
        ...
        */
        ...
        [OperationContract]
        IEnumerable<DTO_QuanLyChamCong_ThongTinChamCongThang> QuanLyChamCong_ThongTinChamCongThang_Cua1NhanVien(String publicKey, String token, int thang, int nam, Guid nhanVienID);

        [OperationContract]
        String QuanLyChamCong_ThongTinChamCongThang_Cua1NhanVien_Json(String publicKey, String token,int thang, int nam, Guid nhanVienID);
