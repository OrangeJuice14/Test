...
namespace HRMWeb_Service
{
    ...
    public partial class Service1 : IService1
    {
        ...
        public IEnumerable<DTO_KyTinhLuong> GetYearKyTinhLuong(String publicKey, String token)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                KyTinhLuong_Factory factory = KyTinhLuong_Factory.New();
                IEnumerable<DTO_KyTinhLuong> list = factory.GetYearDistinct();
                return list;
            }
            else
            {
        ...
        public String GetYearKyTinhLuong_Json(String publicKey, String token)
        {//DANG SD
            IEnumerable<DTO_KyTinhLuong> list = GetYearKyTinhLuong(publicKey, token);
            String json = JsonConvert.SerializeObject(list);
            return json;
        }
