define(['app/app'], function (app) {
    ...
    app.factory('agentObjectService', ['$http', '$q', function ($http, $q) {
        ...
        serviceResult.getList_LoaiThuNhapKhac = function () {
            return $http.get('/Api/agentObjectApi/GetList_LoaiThuNhapKhac');
        }
        ...
        serviceResult.SaveThuNhapKhac = function (Obj) {
            var deferred = $q.defer();
            $http({
                method: 'Put',
                url: '/Api/agentObjectApi/PutThuNhapKhac',
                data: Obj
            }).success(function (result) {
                deferred.resolve(result);
            });
