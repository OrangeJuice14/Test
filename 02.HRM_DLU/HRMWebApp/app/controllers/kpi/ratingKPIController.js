...
define(['app/app', 'app/services/kpi/ratingKPIService', 'app/services/kpi/targetGroupDetailService', 'app/services/kpi/criterionService', 'app/services/kpi/staffService', 'app/services/kpi/planKPIService', 'app/services/kpi/authService', 'app/services/kpi/fileAttachmentService', 'app/controllers/kpi/ratingKPIInformationController', 'app/directives/directives','moment'], function (app) {
    "use strict";
    
    app.controller('ratingKPIController', ['$scope','$document', '$modal', '$rootScope', '$state', '$stateParams', 'ratingKPIService', 'targetGroupDetailService', 'criterionService','staffService','planKPIService', 'authService','fileAttachmentService',
    function ($scope, $document, $modal, $rootScope, $state, $stateParams, ratingKPIService, targetGroupDetailService, criterionService, staffService, planKPIService, authService, fileAttachmentService) {
