define(['angularAMD', 'ui-route', 'ui-validate', 'ui-bootstrap', 'kendo', 'ui-bootstrap-tpls','angular-sanitize'], function (angularAMD) {
    ...
    HRMWebApp.config(['$stateProvider', '$urlRouterProvider','$locationProvider', function ($stateProvider, $urlRouterProvider, $locationProvider,ngSanitize) {
        ...
        ////////////////////***********  CHAM CONG ********************///////////////////////////
            ...
            .state('thoigianquetvantay', angularAMD.route({
                data: {
                    roles: ['kpi/thoigianquetvantay']
                },
                resolve: {
                    authorize: ['authorization',
                        function (authorization) {
                ...
                url: '/kpi/thoigianquetvantay',
                templateUrl: '/app/views/chamcong/QuanLyChamCong/ThoiGianQuetVanTay.html'
            }))
            .state('thongkesogiolamviec', angularAMD.route({
                data: {
                    roles: ['kpi/thongkesogiolamviec']
                },
                resolve: {
                    authorize: ['authorization',
                        function (authorization) {
                ...
                url: '/kpi/thongkesogiolamviec',
                templateUrl: '/app/views/chamcong/QuanLyChamCong/ThongKeSoGioLamViec.html'
            }))
