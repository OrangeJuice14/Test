    ...
    public class PlanDetailExport : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            switch (op)
            {
                case 1:
                    {
                        ProfessorPlanExportToExcelProcess(planId, agentObjectId, userRole, context);
                    }
                    break;
                case 2:
                    {
                ...
                case 8:
                    {
                        SubFacultyPlanExportToExcelProcess(planId, agentObjectId, userRole, context);
                    }
                    break;
                case 7:
                    {
                        SubDepartmentPlanExportToExcelProcess(planId, agentObjectId, userRole, context);
                    }
                    break;
                case 10:
                    {
                        PrinciplePlanExportToExcelProcess(planId, agentObjectId, userRole, context);
                    }
                    break;
                case 11:
                    { VicePrincipalPlanExportToExcelProcess(planId, agentObjectId, userRole, context); }
                    break;
                    //case 6:
                    //    {
        ...
        //8. phó khoa
        public void SubFacultyPlanExportToExcelProcess(Guid planId, Guid agentObjectId, int userRole, HttpContext context)
        {
            PlanDetailMakingDTO detailResult = new PlanDetailMakingDTO();
            //string ip = System.Web.HttpContext.Current.Request.UserHostAddress;
        ...
        //7. Phó phòng
        public void SubDepartmentPlanExportToExcelProcess(Guid planId, Guid agentObjectId, int userRole, HttpContext context)
        {
            PlanDetailMakingDTO detailResult = new PlanDetailMakingDTO();
            //string ip = System.Web.HttpContext.Current.Request.UserHostAddress;
        ...
        //10. Hiệu trưởng
        public void PrinciplePlanExportToExcelProcess(Guid planId, Guid agentObjectId, int userRole, HttpContext context)
        {
            PlanDetailMakingDTO detailResult = new PlanDetailMakingDTO();
            //string ip = System.Web.HttpContext.Current.Request.UserHostAddress;
        ...
        public void SubjectPlanExportToExcelProcess(Guid planId, Guid agentObjectId, int userRole, HttpContext context)
        {
            ...
            foreach (TargetGroupPlanMakingDTO tg in detailResult.TargetGroupPlanMakings)
            {
                ...
                sheet.Rows[rowIndex].Cells[3].Value = "Nguồn lực cần có";
                sheet.Rows[rowIndex].Cells[4].Value = "Chỉ đạo";
                sheet.Rows[rowIndex].Cells[5].Value = "Thực hiện";
                sheet.Rows[rowIndex].Cells[6].Value = "KPIs thực hiện năm học trước";
                sheet.Rows[rowIndex].Cells[7].Value = "KPIs đăng ký của đơn vị";
                sheet.Rows[rowIndex].Cells[8].Value = "Đơn vị tính";
                sheet.Rows[rowIndex].Cells[9].Value = "Thời gian bắt đầu";
                sheet.Rows[rowIndex].Cells[10].Value = "Thời gian kết thúc";
                ...
                foreach (PlanKPIMakingDetailDTO pmd in tg.PlanKPIDetails)
                {
                    ...
                    {
                        SetCellFormat(sheet, subRowIndex++, 5, 5, false, true, false, true, false);
                    }
                    foreach (string strSS in pmd.SubStaffNames)
                    {
                        sheet.Rows[subRowIndex].Cells[5].Value = "- " + strSS;
                        if (subRowIndex == rowIndex)
                        {
                            SetCellFormat(sheet, subRowIndex++, 5, 5, false, true, false, true, false);
                        }
                        ...
                        {
                            SetCellFormat(sheet, subRowIndex++, 5, 5, false, true, false, false, false);
                        }
                    }
                    //subRowIndex--;
                    subRowIndexs.Add(subRowIndex);
                    ...
                    WorksheetMergedCellsRegion mergedPreviousKPI = sheet.MergedCellsRegions.Add(rowIndex, 6, subRowIndex, 6);
                    mergedPreviousKPI.Value = pmd.PreviousKPI;
                    SetRegionBorder(mergedPreviousKPI, true, false, false, false);

                    rowIndex = subRowIndex + 1;
                    SetCellFormat(sheet, rowIndex, 7, 7, true, false, false, true, false);
                    SetCellFormat(sheet, rowIndex, 8, 8, false, false, false, true, false);
                    SetCellFormat(sheet, rowIndex, 9, 9, true, true, false, true, false);
                    SetCellFormat(sheet, rowIndex, 10, 10, true, true, false, true, false);
                    #endregion
                }
                for (int i = beginIndex; i < rowIndex; i++)
                {
                    SetCellFormat(sheet, i, 7, 7, true, false, false, false, false);
        ...
        public void ProfessorPlanExportToExcelProcess(Guid planId, Guid agentObjectId, int userRole, HttpContext context)
        {
            ...
            WorksheetMergedCellsRegion merged1 = sheet.MergedCellsRegions.Add(rowIndex, 0, rowIndex, 8);
            ...
            WorksheetMergedCellsRegion merged2 = sheet.MergedCellsRegions.Add(rowIndex, 0, rowIndex, 8);
            ...
            WorksheetMergedCellsRegion mergedHoTen2 = sheet.MergedCellsRegions.Add(rowIndex, 2, rowIndex, 8);
            ...
            WorksheetMergedCellsRegion mergedKhoa = sheet.MergedCellsRegions.Add(rowIndex, 0, rowIndex, 1);
            WorksheetMergedCellsRegion mergedKhoa2 = sheet.MergedCellsRegions.Add(rowIndex, 2, rowIndex, 8);
            ...
            WorksheetMergedCellsRegion mergedBoMon = sheet.MergedCellsRegions.Add(rowIndex, 0, rowIndex, 1);
            WorksheetMergedCellsRegion mergedBoMon2 = sheet.MergedCellsRegions.Add(rowIndex, 2, rowIndex, 8);
            ...
            WorksheetMergedCellsRegion mergedDoiTuong2 = sheet.MergedCellsRegions.Add(rowIndex, 2, rowIndex, 8);
            ...
            WorksheetMergedCellsRegion mergedMSGV2 = sheet.MergedCellsRegions.Add(rowIndex, 2, rowIndex, 8);
            ...
            WorksheetMergedCellsRegion mergedCapTren = sheet.MergedCellsRegions.Add(rowIndex, 0, rowIndex, 1);
            WorksheetMergedCellsRegion mergedCapTren2 = sheet.MergedCellsRegions.Add(rowIndex, 2, rowIndex, 8);
            mergedCapTren.Value = "Cấp trên trực tiếp";
            ...
            WorksheetMergedCellsRegion mergedThoiNMT = sheet.MergedCellsRegions.Add(rowIndex, 0, rowIndex, 7);
            mergedThoiNMT.Value = "Nhóm mục tiêu (NMT)";
            BackgroundColor(sheet, rowIndex, 0, 8, Color.LightGray);
            SetRegionBorder(mergedThoiNMT, true, false, false, true);
            sheet.Rows[rowIndex].Cells[8].Value = "Tỷ trọng";
            SetCellFormat(sheet, rowIndex, 7, 8, true, false, true, true, true);
            ...
            foreach (TargetGroupPlanMakingDTO tg in detailResult.TargetGroupPlanMakings)
            {
                WorksheetMergedCellsRegion mergedThoiNMT1 = sheet.MergedCellsRegions.Add(rowIndex, 0, rowIndex, 7);
                mergedThoiNMT1.Value = "NMT " + stt++ + ": " + tg.TargetGroupName;
                sheet.Rows[rowIndex].Cells[8].Value = tg.Density + " %";
            ...
            foreach (TargetGroupPlanMakingDTO tg in detailResult.TargetGroupPlanMakings)
            {
                if (tg.TargetGroupDetailTypeId == 0)
                {
                    ...
                    sheet.Rows[rowIndex].Cells[1].Value = "Mục tiêu chi tiết";
                    sheet.Rows[rowIndex].Cells[2].Value = "Nội dung cụ thể";
                    sheet.Rows[rowIndex].Cells[3].Value = "Phương pháp thực hiện";
                    sheet.Rows[rowIndex].Cells[4].Value = "Nguồn lực cần có";
                    ...
                    foreach (PlanKPIMakingDetailDTO pmd in tg.PlanKPIDetails)
                    {
                        ...
                        WorksheetMergedCellsRegion mergedNoiDungCuThe = sheet.MergedCellsRegions.Add(rowIndex, 2, subRowIndex, 2);
                        mergedNoiDungCuThe.Value = pmd.Name;
                        SetRegionBorder(mergedNoiDungCuThe, false, true, false, false);

                        WorksheetMergedCellsRegion mergedPhuongPhap = sheet.MergedCellsRegions.Add(rowIndex, 3, subRowIndex, 3);
                        mergedPhuongPhap.Value = pmd.ExecuteMethod;
                        SetRegionBorder(mergedPhuongPhap, true, false, false, false);

                        WorksheetMergedCellsRegion mergedBasicResource = sheet.MergedCellsRegions.Add(rowIndex, 4, subRowIndex, 4);
                        mergedBasicResource.Value = pmd.BasicResource;
                        SetRegionBorder(mergedBasicResource, true, false, false, false);
                        ...
                        WorksheetMergedCellsRegion mergedStartTime = sheet.MergedCellsRegions.Add(rowIndex, 7, subRowIndex, 7);
                        mergedStartTime.Value = pmd.StartDateString;
                        SetRegionBorder(mergedStartTime, true, false, false, false);

                        WorksheetMergedCellsRegion mergedEndTime = sheet.MergedCellsRegions.Add(rowIndex, 8, subRowIndex, 8);
                        mergedEndTime.Value = pmd.EndTimeString;
                        SetRegionBorder(mergedEndTime, true, false, false, false);


                        rowIndex = subRowIndex + 1;
                        SetCellFormat(sheet, subRowIndex, 2, 2, false, false, false, false, true);
                        SetCellFormat(sheet, subRowIndex, 3, 3, false, false, false, false, true);
                        SetCellFormat(sheet, subRowIndex, 4, 4, false, false, false, false, true);
                        SetCellFormat(sheet, subRowIndex, 5, 5, false, false, false, false, false);
                        SetCellFormat(sheet, subRowIndex, 6, 6, false, false, false, false, true);
                ...
                if (tg.TargetGroupDetailTypeId == 5)
                {
                    ...
                    sheet.Rows[rowIndex].Cells[1].Value = "Mục tiêu chi tiết";
                    sheet.Rows[rowIndex].Cells[2].Value = "Nội dung cụ thể";
                    sheet.Rows[rowIndex].Cells[3].Value = "Chỉ tiêu đăng ký thực hiện";
                    sheet.Rows[rowIndex].Cells[4].Value = "Phương pháp thực hiện";
                    sheet.Rows[rowIndex].Cells[5].Value = "Nguồn lực cần có";
                    sheet.Rows[rowIndex].Cells[6].Value = "Kết quả thực hiện năm học trước";
                    sheet.Rows[rowIndex].Cells[7].Value = "Thời gian bắt đầu";
                    sheet.Rows[rowIndex].Cells[8].Value = "Thời gian kết thúc";
                    SetCellFormat(sheet, rowIndex, 1, 8, true, false, true, true, true);
                    BackgroundColor(sheet, rowIndex, 1, 8, Color.LightGray);
                    ...
                    foreach (PlanKPIMakingDetailDTO pmd in tg.PlanKPIDetails)
                    {
                        ...
                        {
                            sheet.Rows[subRowIndex].Cells[2].Value = "- " + me.Name;
                            sheet.Rows[subRowIndex].Cells[3].Value = me.NumberOfResearch;
                        ...
                        WorksheetMergedCellsRegion mergedPhuongPhap = sheet.MergedCellsRegions.Add(rowIndex, 4, subRowIndex, 4);
                        mergedPhuongPhap.Value = pmd.ExecuteMethod;
                        SetRegionBorder(mergedPhuongPhap, true, false, false, false);
                        ...
                        for (int i = beginRow; i <= subRowIndex; i++)
                        {
                            ...
                            SetCellFormat(sheet, i, 5, 5, true, false, false, false, false);
                            SetCellFormat(sheet, i, 6, 6, true, false, false, false, false);
                            SetCellFormat(sheet, i, 7, 7, true, false, false, false, false);
                            SetCellFormat(sheet, i, 8, 8, false, false, false, false, false);
                        }
                        #endregion
                ...
                if (tg.TargetGroupDetailTypeId == 4)
                {
                    ...
                    sheet.Columns[8].Width = 50 * 90;
                    sheet.Columns[9].Width = 50 * 90;
                    WorksheetMergedCellsRegion mergedStt = sheet.MergedCellsRegions.Add(rowIndex, 0, rowIndex + 1, 0);
                    mergedStt.Value = "STT";
                    BackgroundColor(sheet, rowIndex, 0, 1, Color.LightGray);
                    SetRegionBorder(mergedStt, true, false, true, true);
                    ...
                    sheet.Rows[rowIndex].Cells[1].Value = "Mục tiêu chi tiết";
                    sheet.Rows[rowIndex].Cells[2].Value = "Nội dung cụ thể";
                    sheet.Rows[rowIndex].Cells[3].Value = "Số giờ";
                    sheet.Rows[rowIndex].Cells[4].Value = "Chỉ tiêu đăng ký thực hiện";
                    sheet.Rows[rowIndex].Cells[5].Value = "Phương pháp thực hiện";
                    sheet.Rows[rowIndex].Cells[6].Value = "Nguồn lực cần có";
                    sheet.Rows[rowIndex].Cells[7].Value = "Kết quả thực hiện năm học trước";
                    ...
                    foreach (PlanKPIMakingDetailDTO pmd in tg.PlanKPIDetails)
                    {
                        ...
                        {
                            sheet.Rows[subRowIndex].Cells[2].Value = me.Name;
                            sheet.Rows[subRowIndex].Cells[3].Value = me.NumberOfHour;
                            sheet.Rows[subRowIndex].Cells[4].Value = me.NumberOfTime;
                            SetCellFormat(sheet, subRowIndex, 3, 3, true, false, false, false, false);
                        ...
                        WorksheetMergedCellsRegion mergedPhuongPhap = sheet.MergedCellsRegions.Add(rowIndex, 5, subRowIndex, 5);
                        mergedPhuongPhap.Value = pmd.ExecuteMethod;
                        SetRegionBorder(mergedPhuongPhap, true, false, false, false);

                        WorksheetMergedCellsRegion mergedBasicResource = sheet.MergedCellsRegions.Add(rowIndex, 6, subRowIndex, 6);
                        mergedBasicResource.Value = pmd.BasicResource;
                        SetRegionBorder(mergedBasicResource, true, false, false, false);
                        ...
                        WorksheetMergedCellsRegion mergedStartTime = sheet.MergedCellsRegions.Add(rowIndex, 8, subRowIndex, 8);
                        mergedStartTime.Value = pmd.StartDateString;
                        SetRegionBorder(mergedStartTime, true, false, false, false);

                        WorksheetMergedCellsRegion mergedEndTime = sheet.MergedCellsRegions.Add(rowIndex, 9, subRowIndex, 9);
                        mergedEndTime.Value = pmd.EndTimeString;
                        SetRegionBorder(mergedEndTime, true, false, false, false);
        ...
        // 11.P. Hiệu trưởng
        public void VicePrincipalPlanExportToExcelProcess(Guid planId, Guid agentObjectId, int userRole, HttpContext context)
        {
            PlanDetailMakingDTO detailResult = new PlanDetailMakingDTO();
            //string ip = System.Web.HttpContext.Current.Request.UserHostAddress;
