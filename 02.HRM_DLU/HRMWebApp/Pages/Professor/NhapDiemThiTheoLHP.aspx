            ...
            <table cellpadding="0" cellspacing="5" border="0" width="100%">
                ...
                <tr>
                    <td colspan="4" style="text-align: right">
                        ...
                        &nbsp;<asp:Button ID="btnGanVang" runat="server" Text="Gán vắng" OnClick="btnGanVang_Click" />
                        &nbsp;<asp:Button ID="btnBoGanVang" runat="server" Text="Bỏ gán vắng" OnClick="btnBoGanVang_Click" />      
                        <asp:Button ID="btnImportDiem" runat="server" Text="Import Điểm" OnClick="btnImportDiem_Click" Visible="false"/>
                        <asp:FileUpload ID="FileUpload1" runat="server" />
                        <asp:Button ID="btnExportDiem" runat="server" Text="Export Điểm" OnClick="btnExportDiem_Click" />
