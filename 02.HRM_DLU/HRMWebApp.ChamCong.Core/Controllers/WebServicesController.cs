...
namespace HRMWebApp.ChamCong.Core.Controllers
{
    public class WebServicesController : Controller
    {
        ...
        public string ThoiGianQuetVanTay_Find(DateTime tungay, DateTime denngay,string nhanvien)
        {
            //
            ...
            //
            string json = _service.ThoiGianQuetVanTay_Find_Json(PublicKey, _token, tungay, denngay, idNhanVien);
            return json;
        }

        public string ThongKeSoGioLamViec_Find(DateTime tungay, DateTime denngay, string nhanvien)
        {
            //
            Guid idNhanVien = Guid.Empty;
            if (!string.IsNullOrEmpty(nhanvien))
            ...
            //
            string json = _service.ThongKeSoGioLamViec_Find_Json(PublicKey, _token, tungay, denngay, idNhanVien);
            return json;
        }
        ...
        {
            return _service.ChamCongNgayNghi_GetList_HinhThucNghi_Json(PublicKey, _token);
        }
        ...
        public ActionResult CauHinhChamCong_Save(string oid, string sogiaydiduong, string songaynghiphep)
        {
            ...
            //
            if (_service.CauHinhChamCong_Save(PublicKey, _token, oidCauHinh, sogiaydiduong, songaynghiphep))
            {
                return Helper.JsonSucess();
            }
        ...
        public string QuanLyChamCong_ChamCongThang(int thang, int nam, string bophanId, string maNhanSu, string idLoaiNhanSu)
        {
            ...
            if (webGroupId.ToUpper() == "53D57298-1933-4E4B-B4C8-98AFED036E21")
                ...
                return _service.QuanLyChamCong_ThongTinChamCongThang_Json(PublicKey, _token, thang, nam, new Guid(bophanId), maNhanSu, loaiNhanSuID);
        }
        ...
        public string ThongKeXetABCTheoThang_Find(int thang, int nam, string bophan, string idLoaiNhanSu, string maNhanSu, string webUserId)
        {
            ...
            if (webGroupId.ToUpper() == "53D57298-1933-4E4B-B4C8-98AFED036E21")
                ...
                return _service.ThongKeXetABCTheoThang_Find_Json(PublicKey, _token, thang, nam, formatBoPhanId, formatLoaiNhanSuId, maNhanSu, new Guid(webUserId));
        }
        ...
        public ActionResult CaNhanKhaiBaoCongTac_KhaiBaoMoi(string noidung, string diadiem, DateTime tungay, DateTime denngay, byte buoi, int GioBatDau, int PhutBatDau, int GioKetThuc, int PhutKetThuc, string webUserId, string nguoiKy, string IDNhanVien)
        {
            if (_service.CaNhanKhaiBaoCongTac_KhaiBaoMoi(PublicKey, _token, noidung, diadiem, tungay, denngay, buoi, GioBatDau, PhutBatDau, GioKetThuc, PhutKetThuc, new Guid(webUserId), new Guid(nguoiKy), IDNhanVien))
            {
                return Helper.JsonSucess();
            }
            return Helper.JsonErorr();
        ...
        {
            return _service.GetYearKyTinhLuong_Json(PublicKey, _token);
        }
        ...
        public string BANGLUONG_DLU(string webUserId, int thang, int nam)
        {
            String json = "";
            json = _service.BANGLUONG_DLU_Json(PublicKey, _token, new Guid(webUserId), thang, nam);
            return json;
        ...
        public string ThongTinNhanSu_SoYeuLyLich_Json(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_SoYeuLyLich_DLU_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ThongTinNhanSu_THONGTINLUONGNHANVIEN(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_THONGTINLUONGNHANVIEN_DLU_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_TRINHDOCHUYENMONNHANVIEN(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_TRINHDOCHUYENMONNHANVIEN_DLU_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_HOPDONGLAODONG(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_HOPDONGLAODONG_DLU_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        }
        ...
        public string ModuleThongTinNhanSu_QuanHeGiaDinh(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuanHeGiaDinh_DLU_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_DienBienLuong(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_DienBienLuong_DLU_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_LichSuBanThan(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_LichSuBanThan_DLU_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_QuaTrinhDaoTao(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuaTrinhDaoTao_DLU_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_QuaTrinhBoiDuong(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuaTrinhBoiDuong_DLU_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_QuaTrinhBoNhiem(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuaTrinhBoNhiem_DLU_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_QuaTrinhDiNuocNgoai(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuaTrinhDiNuocNgoai_DLU_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_QuaTrinhKhenThuong(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuaTrinhKhenThuong_DLU_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_QuaTrinhKyLuat(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuaTrinhKyLuat_DLU_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_QuaTrinhNghienCuuKhoaHoc(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuaTrinhNghienCuuKhoaHoc_DLU_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_QuaTrinhHoatDongXaHoi(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuaTrinhThamGiaHoatDongXaHoi_DLU_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_QuaTrinhHoiThao(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuaTrinhThamGiaHoiThao_DLU_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_QuaTrinhThamGiaLucLuongVuTrang(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuaTrinhThamGiaLucLuongVuTrang_DLU_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_DangVien(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_DangVien_DLU_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_DoanVien(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_DoanVien_DLU_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_CongDoan(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_CongDoan_DLU_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_QuaTrinhCongTac(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuaTrinhCongTac_DLU_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ChamCongNgayNghi_Find(int thang, int nam, string manhansu, string bophanid, string loainhansuid)
        {
            ...
            return _service.ChamCongNgayNghi_Find_Json(PublicKey, _token, thang, nam, manhansu, idBoPhan, idLoaiNhanSu);
        }
        public string QuanLyNghiPhep_Find(int thang, int nam,string trangthai, string manhansu, string bophanid, string loainhansuid,string idwebgroup)
        {
            Guid idBoPhan = Guid.Empty;
            if (!string.IsNullOrEmpty(bophanid))
            {
            ...
            //
            return _service.QuanLyNghiPhep_Find_Json(PublicKey, _token, thang, nam, trangThai, manhansu, idBoPhan, idLoaiNhanSu, idwebgroup);
        }
        ...
        public ActionResult ChamCongNgayNghi_TaoMoi(string nhanVienId, string noiDung, string noiNghiPhep, string tenDonXinNghi, string diaChiLienHe, string idHinhThucNghi, int loaiDonXinNghi, DateTime tuNgay, DateTime denNgay, string webUserId, int isAdmin)
        {
            _service.ChamCongNgayNghi_TaoMoi(PublicKey, _token, new Guid(nhanVienId), noiDung, noiNghiPhep, tenDonXinNghi, diaChiLienHe, new Guid(idHinhThucNghi), loaiDonXinNghi, tuNgay,
               denNgay, new Guid(webUserId), isAdmin);
            return Helper.JsonSucess();
        }
        public ActionResult ChamCongNgayNghi_XuatMauNghiPhep(String oid)
        {
            string result = _service.ChamCongNgayNghi_XuatMauNghiPhep(PublicKey, _token,new Guid(oid));
            //
        ...
        public ActionResult CaNhanKhaiBaoCongTac_KiemTraTuNgayDenNgayCoHopLe(string khaiBaoCongTacOid, DateTime tuNgay, DateTime denNgay, string webUserId, string IDNhanVien)
        {
            ...
            return _service.CaNhanKhaiBaoCongTac_KiemTraTuNgayDenNgayCoHopLe(PublicKey, _token, formatkhaiBaoCongTacOid, tuNgay,
                denNgay, new Guid(webUserId), IDNhanVien).ToJSON();
        }
