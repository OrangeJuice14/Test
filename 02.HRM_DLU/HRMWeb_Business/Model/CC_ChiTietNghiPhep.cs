...
namespace HRMWeb_Business.Model
{
    ...
    public partial class CC_ChiTietNghiPhep : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [EdmScalarPropertyAttribute(EntityKeyProperty=false, IsNullable=true)]
        [DataMemberAttribute()]
        public string SoNgayPhepNamTruoc
        {
            get
            {
        ...
        private string _soNgayPhepNamTruoc;
        partial void On_SoNgayPhepNamTruoc_Changing(string currentValue, ref string newValue, ref bool stopChanging);
        partial void On_SoNgayPhepNamTruoc_Changed(string oldValue, string currentValue);
