...
namespace HRMWeb_Business.Model
{
    ...
    public partial class CC_KhaiBaoCongTac : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_CC_KhaiBaoCongTac_HoSo1", "HoSo")]
        public HoSo HoSo1
        {//test
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<HoSo>("ERPModel.FK_CC_KhaiBaoCongTac_HoSo1", "HoSo").Value;
            }
            set
            {
    			bool stopChanging = false;
    			...
    			if(!stopChanging)
    			{
    				((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<HoSo>("ERPModel.FK_CC_KhaiBaoCongTac_HoSo1", "HoSo").Value = value;
        ...
        public EntityReference<HoSo> HoSo1Reference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<HoSo>("ERPModel.FK_CC_KhaiBaoCongTac_HoSo1", "HoSo");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<HoSo>("ERPModel.FK_CC_KhaiBaoCongTac_HoSo1", "HoSo", value);
                }
            }
        }
