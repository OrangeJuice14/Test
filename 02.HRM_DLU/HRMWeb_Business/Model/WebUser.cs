...
namespace HRMWeb_Business.Model
{
    ...
    public partial class WebUser : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [EdmScalarPropertyAttribute(EntityKeyProperty=false, IsNullable=true)]
        [DataMemberAttribute()]
        public Nullable<System.Guid> GiangVienThinhGiang
        {
            get
            {
            ...
            set
            {
    			Nullable<System.Guid> oldValue =  _giangVienThinhGiang;
    			bool stopChanging = false;
                On_GiangVienThinhGiang_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("GiangVienThinhGiang");
    			if(!stopChanging)
    			{
    				_giangVienThinhGiang = StructuralObject.SetValidValue(value);
    				ReportPropertyChanged("GiangVienThinhGiang");
    				On_GiangVienThinhGiang_Changed(oldValue, _giangVienThinhGiang);//\\
    			}
            }
        }
    	public static String GiangVienThinhGiang_PropertyName { get { return "GiangVienThinhGiang"; } }
        private Nullable<System.Guid> _giangVienThinhGiang;
        partial void On_GiangVienThinhGiang_Changing(Nullable<System.Guid> currentValue, ref Nullable<System.Guid> newValue, ref bool stopChanging);
        partial void On_GiangVienThinhGiang_Changed(Nullable<System.Guid> oldValue, Nullable<System.Guid> currentValue);
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_WebUsers_GiangVienThinhGiang", "GiangVienThinhGiang")]
        public GiangVienThinhGiang GiangVienThinhGiang1
        {//test
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<GiangVienThinhGiang>("ERPModel.FK_WebUsers_GiangVienThinhGiang", "GiangVienThinhGiang").Value;
            }
            set
            {
    			bool stopChanging = false;
    			On_GiangVienThinhGiang1_Changing(ref value, ref stopChanging);//\\//
    			if(!stopChanging)
    			{
    				((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<GiangVienThinhGiang>("ERPModel.FK_WebUsers_GiangVienThinhGiang", "GiangVienThinhGiang").Value = value;
    				On_GiangVienThinhGiang1_Changed(this.GiangVienThinhGiang1);//\\//
    			}
    	    }
        }
    	public static String GiangVienThinhGiang1_ReferencePropertyName { get { return "GiangVienThinhGiang1"; } }
    	partial void On_GiangVienThinhGiang1_Changing(ref GiangVienThinhGiang newValue, ref bool stopChanging);
    	partial void On_GiangVienThinhGiang1_Changed(GiangVienThinhGiang currentValue);
        /// <summary>
        /// No Metadata Documentation available.
        /// </summary>
        [BrowsableAttribute(false)]
        [DataMemberAttribute()]
        public EntityReference<GiangVienThinhGiang> GiangVienThinhGiang1Reference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<GiangVienThinhGiang>("ERPModel.FK_WebUsers_GiangVienThinhGiang", "GiangVienThinhGiang");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<GiangVienThinhGiang>("ERPModel.FK_WebUsers_GiangVienThinhGiang", "GiangVienThinhGiang", value);
                }
            }
        }
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_WebUsers_HoSoThinhGiang", "HoSo")]
        public HoSo HoSo1
        {//test
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<HoSo>("ERPModel.FK_WebUsers_HoSoThinhGiang", "HoSo").Value;
            }
            set
            {
    			bool stopChanging = false;
    			...
    			if(!stopChanging)
    			{
    				((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<HoSo>("ERPModel.FK_WebUsers_HoSoThinhGiang", "HoSo").Value = value;
        ...
        public EntityReference<HoSo> HoSo1Reference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<HoSo>("ERPModel.FK_WebUsers_HoSoThinhGiang", "HoSo");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<HoSo>("ERPModel.FK_WebUsers_HoSoThinhGiang", "HoSo", value);
                }
            }
        }
