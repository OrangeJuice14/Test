...
namespace HRMWeb_Business.Model
{
    ...
    /// </summary>
    [EdmComplexTypeAttribute(NamespaceName="ERPModel", Name="spd_Web1_ChungChi_LUH_Result")]
    [DataContractAttribute(IsReference=true)]
    [Serializable()]
    public partial class spd_Web1_ChungChi_LUH_Result : ComplexObject
    {
        #region Factory Method
    
        /// <summary>
        /// Create a new spd_Web1_ChungChi_LUH_Result object.
        /// </summary>
        /// <param name="xepLoai">Initial value of the XepLoai property.</param>
        public static spd_Web1_ChungChi_LUH_Result Createspd_Web1_ChungChi_LUH_Result(string xepLoai)
        {
            spd_Web1_ChungChi_LUH_Result spd_Web1_ChungChi_LUH_Result = new spd_Web1_ChungChi_LUH_Result();
            spd_Web1_ChungChi_LUH_Result.XepLoai = xepLoai;
            return spd_Web1_ChungChi_LUH_Result;
        }
