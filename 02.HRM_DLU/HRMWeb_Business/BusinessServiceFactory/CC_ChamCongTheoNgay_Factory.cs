    ...
    public class CC_ChamCongTheoNgay_Factory : BaseFactory<Entities, CC_ChamCongTheoNgay>
    {
        ...
        public IQueryable<DTO_QuanLyChamCong_Find> FindForQuanlyChamCong(DateTime date, Guid? boPhanId, int trangThaiChamCong, bool? diHoc, string maNhanSu, Guid webUserId, Guid? idLoaiNhanSu)
        {
            ...
            var result = (from o in this.ObjectSet
                          ...
                          { DaChamCong = o.DaChamCong,
                            ...
                            IDHinhThucNghi = o.CC_HinhThucNghi.Oid,
                            Ngay = o.Ngay,
                            Oid = o.Oid,
        ...
        public IQueryable<DTO_QuanLyChamCong_Find> FindForQuanlyChamChong_ThangVaNam(int thang, int nam, Guid? boPhanId, int trangThaiChamCong, bool? diHoc, string maNhanSu, Guid webUserId, Guid? idLoaiNhanSu)
        {
            ...
            var result = (from o in this.ObjectSet
                          ...
                          select new DTO_QuanLyChamCong_Find() { DaChamCong = o.DaChamCong, HoTen = o.HoSo.HoTen, SoHieuCongChuc = o.HoSo.NhanVien.ThongTinNhanVien.SoHieuCongChuc, IDHinhThucNghi = o.CC_HinhThucNghi.Oid, Ngay = o.Ngay, Oid = o.Oid, TenPhongBan = o.BoPhan.TenBoPhan, TenCa = o.CC_CaChamCong1.TenCa });
            return result;
        }
                          ...
                          select new DTO_QuanLyChamCong_ThongTinChamCongThang
                          {
                              ...
                              ChiTietChamCong = (from o in this.Context.CC_ChamCongTheoNgay
                                                 ...
                                                 select new DTO_QuanLyChamCong_ChamCongNgay()
                                                 {
                                                     ...
                                                     Ngay = o.Ngay
                                                     ,
                                                     MaHinhThucNghi = (o.CC_HinhThucNghi == null ? "+" : o.CC_HinhThucNghi.KyHieu)
                                                     ,
        ...
        public IQueryable<DTO_QuanLyChamCong_ThongTinChamCongThang> QuanLyChamCong_ThongTinChamCongThang_New(int thang, int nam, int loaicanbo)
        {
            DateTime ngayTrongThang = Convert.ToDateTime(thang + "/01/" + nam);
            //
            //Lấy danh sách tất cả nhân viên 
            var dsIdNhanVien = (from o in this.ObjectSet
                                where (o.Ngay.Year == nam && o.Ngay.Month == thang)
                                      && o.HoSo.GCRecord == null && o.HoSo.NhanVien.TinhTrang1.KhongConCongTacTaiTruong == false
                                      && ( (o.HoSo.NhanVien.ThongTinNhanVien.LoaiNhanSu1.TenLoaiNhanSu.Contains("giảng viên") && loaicanbo == 1)
                                           || ( !o.HoSo.NhanVien.ThongTinNhanVien.LoaiNhanSu1.TenLoaiNhanSu.Contains("giảng viên") && loaicanbo == 2)
                                           || loaicanbo == 0
                                         )
                                orderby o.HoSo.Ten
                                select o.IDNhanVien).Distinct();
            ...
            var result = (from idNv in dsIdNhanVien
                          ...
                          select new DTO_QuanLyChamCong_ThongTinChamCongThang
                          {
                              STT = hs.NhanVien.BoPhan1.STT.Value
                              ,
                              TenDonVi = hs.NhanVien.BoPhan1.TenBoPhan
                              ,
                              IDNhanVien = idNv
                              ,
                              HoTen = hs.HoTen
                              ...
                              ChiTietChamCong = (from o in this.Context.CC_ChamCongTheoNgay
                                                 where o.Ngay.Year == nam && o.Ngay.Month == thang
                                                        && o.IDBoPhan == hs.NhanVien.BoPhan && o.IDNhanVien == idNv
                                                 orderby o.Ngay ascending
                                                 select new DTO_QuanLyChamCong_ChamCongNgay()
                                                 {
                                                     CC_ChamCongTheoNgayOid = o.Oid
