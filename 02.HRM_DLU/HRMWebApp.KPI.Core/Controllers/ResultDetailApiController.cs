                                    ...
                                    case (int)AgentObjectTypes.NhanVien:
                                        {
                                            ...
                                            switch (t.TargetGroupDetailType.Id)
                                            {
                                                ...
                                                case 2:
                                                    {
                                                        planDetails = planStaff.PlanKPIDetails.Where(p => p.TargetGroupDetail.Id == t.ParentTargetGroupDetail.Id).ToList();
                                    ...
                                    case (int)AgentObjectTypes.PhongBan:
                                        {
                                            ...
                                            switch (t.TargetGroupDetailType.Id)
                                            {
                                                case 1:
                                                    {
                                                        planDetails = planStaff.PlanKPIDetails.Where(p => p.TargetGroupDetail == null || p.TargetGroupDetail.Id == t.Id).ToList();
                                                    }
                                                    break;
                                                case 2:
                                                    {
                                                        planDetails = planStaff.PlanKPIDetails.Where(p => p.TargetGroupDetail == null || p.TargetGroupDetail.Id == t.ParentTargetGroupDetail.Id).ToList();
                                ...
                                case (int)AgentObjectTypes.GiangVien:
                                    {
                                        ...
                                        List<PlanKPIDetail> planDetails = new List<PlanKPIDetail>();
                                        planDetails = planStaff.PlanKPIDetails.Where(p => p.TargetGroupDetail == null).ToList();
