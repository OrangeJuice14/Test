...
namespace HRMWeb_Business.Model
{
    ...
    /// </summary>
    [EdmComplexTypeAttribute(NamespaceName="ERPModel", Name="spd_Web1_BangThongTinThuNhap_LuongTangThem_Result")]
    [DataContractAttribute(IsReference=true)]
    [Serializable()]
    public partial class spd_Web1_BangThongTinThuNhap_LuongTangThem_Result : ComplexObject
    {
        #region Factory Method
    
        /// <summary>
        /// Create a new spd_Web1_BangThongTinThuNhap_LuongTangThem_Result object.
        /// </summary>
        /// <param name="tieuDe">Initial value of the TieuDe property.</param>
        public static spd_Web1_BangThongTinThuNhap_LuongTangThem_Result Createspd_Web1_BangThongTinThuNhap_LuongTangThem_Result(string tieuDe)
        {
            spd_Web1_BangThongTinThuNhap_LuongTangThem_Result spd_Web1_BangThongTinThuNhap_LuongTangThem_Result = new spd_Web1_BangThongTinThuNhap_LuongTangThem_Result();
            spd_Web1_BangThongTinThuNhap_LuongTangThem_Result.TieuDe = tieuDe;
            return spd_Web1_BangThongTinThuNhap_LuongTangThem_Result;
        }
