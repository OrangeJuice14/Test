...
namespace HRMWeb_Business.Model
{
    ...
    /// </summary>
    [EdmComplexTypeAttribute(NamespaceName="ERPModel", Name="spd_Web1_ChiTietThuNhapCaNhan_LUH_Result")]
    [DataContractAttribute(IsReference=true)]
    [Serializable()]
    public partial class spd_Web1_ChiTietThuNhapCaNhan_LUH_Result : ComplexObject
    {
        #region Factory Method
    
        /// <summary>
        /// Create a new spd_Web1_ChiTietThuNhapCaNhan_LUH_Result object.
        /// </summary>
        ...
        public static spd_Web1_ChiTietThuNhapCaNhan_LUH_Result Createspd_Web1_ChiTietThuNhapCaNhan_LUH_Result(string maNhanSu, string ngachLuong, string bacLuong, decimal heSoLuong, decimal luongCoBan, string xepLoai, decimal thuLaoGiangDay, decimal luongNganSach, decimal phuCap, decimal thuNhapTangThem, decimal thuNhapKhac, decimal ngoaiGio, decimal khenThuong, decimal khauTruLuong, decimal thueTNCN)
        {
            spd_Web1_ChiTietThuNhapCaNhan_LUH_Result spd_Web1_ChiTietThuNhapCaNhan_LUH_Result = new spd_Web1_ChiTietThuNhapCaNhan_LUH_Result();
            spd_Web1_ChiTietThuNhapCaNhan_LUH_Result.MaNhanSu = maNhanSu;
            spd_Web1_ChiTietThuNhapCaNhan_LUH_Result.NgachLuong = ngachLuong;
            spd_Web1_ChiTietThuNhapCaNhan_LUH_Result.BacLuong = bacLuong;
            spd_Web1_ChiTietThuNhapCaNhan_LUH_Result.HeSoLuong = heSoLuong;
            spd_Web1_ChiTietThuNhapCaNhan_LUH_Result.LuongCoBan = luongCoBan;
            spd_Web1_ChiTietThuNhapCaNhan_LUH_Result.XepLoai = xepLoai;
            spd_Web1_ChiTietThuNhapCaNhan_LUH_Result.ThuLaoGiangDay = thuLaoGiangDay;
            spd_Web1_ChiTietThuNhapCaNhan_LUH_Result.LuongNganSach = luongNganSach;
            spd_Web1_ChiTietThuNhapCaNhan_LUH_Result.PhuCap = phuCap;
            spd_Web1_ChiTietThuNhapCaNhan_LUH_Result.ThuNhapTangThem = thuNhapTangThem;
            spd_Web1_ChiTietThuNhapCaNhan_LUH_Result.ThuNhapKhac = thuNhapKhac;
            spd_Web1_ChiTietThuNhapCaNhan_LUH_Result.NgoaiGio = ngoaiGio;
            spd_Web1_ChiTietThuNhapCaNhan_LUH_Result.KhenThuong = khenThuong;
            spd_Web1_ChiTietThuNhapCaNhan_LUH_Result.KhauTruLuong = khauTruLuong;
            spd_Web1_ChiTietThuNhapCaNhan_LUH_Result.ThueTNCN = thueTNCN;
            return spd_Web1_ChiTietThuNhapCaNhan_LUH_Result;
        }
