...
namespace HRMWeb_Service
{
    ...
    public partial class Service1 : IService1
    {
        ...
        public List<DTO_KyTinhLuong> KyTinhLuong_ByYear(String publicKey, String token, int year)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                KyTinhLuong_Factory factory = KyTinhLuong_Factory.New();
                List<DTO_KyTinhLuong> obj = factory.GetKyTinhLuong_GCRecordIsNull_ByYear(year).Map<DTO_KyTinhLuong>().ToList();
                return obj;
            }
            else
            {
        ...
        public String KyTinhLuong_ByYear_Json(String publicKey, String token, int year)
        {//DANG SD
            List<DTO_KyTinhLuong> obj = KyTinhLuong_ByYear(publicKey, token,year);
            String json = JsonConvert.SerializeObject(obj);
            return json; 
        }
