<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ChamCongNgayNghi.aspx.cs" Inherits="HRMChamCong.Views.QuanLyChamCong.ChamCongNgayNghi" %>
            ...
            self.datagrid.jqxGrid(
                {
                    ...
                    columns: [
                        ...
                        {
                            text: 'Diễn giải', datafield: 'DienGiai',  align: 'center',
                        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="ChamCongNgayNghi">
        <%--<div class="block" id="userManage">
            ...
            <div class="trove" data-bind="click:remove">
                <a href="#">
                    <img src="/Images/hoatdong.png">
                    Xóa</a>
            </div>
