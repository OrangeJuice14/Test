<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Manage_HRM.aspx.cs" Inherits="HRMChamCong.Views.BangLuong.Manage_HRM" %>
        ...
        <div data-bind="visible: BangLuongSelected() != undefined">
            <div>
                <p style="padding: 10px 0px 10px 0px;">
                    Mã nhân sự: <b data-bind="text: MaNhanSu"></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Họ và tên: <b data-bind="    text: HoTen"></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Đơn vị: <b data-bind="    text: DonVi"></b>
                </p>
