  ...
  var Editor = function (handler) {
    ...
    this.createLink = function ($editable, linkInfo, options) {
      ...
      if (isTextChanged) {
          ...
          //sang overwrite link
          if (linkUrl.lastIndexOf('.pdf') !== -1) {
              var m = rng.insertNode($('<iframe src="http://docs.google.com/gview?url=' + linkUrl + '&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>')[0]);
          } else
          {
    ...
    this.attachDragAndDropEvent = function (layoutInfo, options) {
      ...
      $document.on('dragenter', function (e) {
        ...
        if (!isCodeview && !collection.length && hasEditorSize) {
            ...
            $editor.removeClass('dragover');// sáng không muốn cho nó hiện hover add image
