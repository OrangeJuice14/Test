    ...
    HRMWebApp.config(['$stateProvider', '$urlRouterProvider','$locationProvider', function ($stateProvider, $urlRouterProvider, $locationProvider,ngSanitize) {
        ...
        ////////////////////***********  CHAM CONG ********************///////////////////////////
            ...
            .state('quanlyvipham', angularAMD.route({
             ...
             .state('dangkybosungcong', angularAMD.route({
                 data: {
                     roles: ['kpi/dangkybosungcong']
                 },
                 resolve: {
                     authorize: ['authorization',
                           function (authorization) {
                 ...
                 url: '/kpi/dangkybosungcong',
                 templateUrl: '/app/views/chamcong/QuanLyChamCong/DangKyBoSungCong.html'
             }))
             .state('quanlybosungcong', angularAMD.route({
                 data: {
                     roles: ['kpi/quanlybosungcong']
                 },
                 resolve: {
                     authorize: ['authorization',
                           function (authorization) {
                 ...
                 url: '/kpi/quanlybosungcong',
                 templateUrl: '/app/views/chamcong/QuanLyChamCong/QuanLyBoSungCong.html'
             }))
             .state('quanlybosungcong_nhacviec', angularAMD.route({
                 data: {
                     roles: ['kpi/quanlybosungcong']
                 },
                 resolve: {
                 ...
                 url: '/kpi/quanlybosungcong_nhacviec',
                 templateUrl: '/app/views/chamcong/QuanLyChamCong/QuanLyBoSungCong.html'
             }))
            // Bang luong
