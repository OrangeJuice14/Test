...
namespace HRMWeb_Service
{
    ...
    public partial class Service1 : IService1
    {
        ...
        public bool CauHinhChamCong_Save(String publicKey, String token,Guid oid, string emailsender, string passsender, string songaynghiphep, string sogdkhoiduyet, string sodkngoaigio)
        {
            if (Helper.TrustTest(publicKey, token))
            {
