...
namespace HRMWeb_Service
{
    ...
    public partial class Service1 : IService1
    {
        ...
        public String GetDanhSachBoPhanTheoCongTy(String publicKey, String token, Guid congTy)
        {//DANG SD
            IEnumerable<DTO_BoPhan> list = BoPhan_Factory.New().GetDanhSachBoPhanTheoCongTy(congTy).Map<DTO_BoPhan>();
            String json = JsonConvert.SerializeObject(list);
            return json;
        }
        ...
        public IEnumerable<DTO_BoPhan> GetList_BoPhan_DuocPhanQuyenChoWebUserId(String publicKey, String token, Guid webUserId, Guid congTy)
        {
            ...
            {
                BoPhan_Factory factory = BoPhan_Factory.New();
                IEnumerable<DTO_BoPhan> list = factory.GetDanhSachBoPhan_DuocPhanQuyenChoWebUserId_GCRecordIsNull(webUserId, congTy).Map<DTO_BoPhan>();
        ...
        public IEnumerable<DTO_BoPhan> GetBoPhan_LayTatCaBoPhan(String publicKey, String token)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                BoPhan_Factory factory = BoPhan_Factory.New();
                IEnumerable<DTO_BoPhan> list = factory.BoPhan_LayTatCaBoPhan().Map<DTO_BoPhan>();
        ...
        public List<DTO_BoPhan> GetList_BoPhan_DuocPhanQuyenChoWebUserId_All(String publicKey, String token, Guid webUserId, Guid groupId, Guid congTy)
        {
            ...
            {
                BoPhan_Factory factory = BoPhan_Factory.New();
                List<DTO_BoPhan> list = factory.GetDanhSachBoPhan_DuocPhanQuyenChoWebUserId_GCRecordIsNull(webUserId, congTy).Map<DTO_BoPhan>().ToList();
                int i = 1;
        ...
        public String GetBoPhan_LayTatCaBoPhan_Json(String publicKey, String token)
        {//DANG SD
            IEnumerable<DTO_BoPhan> list = GetBoPhan_LayTatCaBoPhan(publicKey, token);
            String json = JsonConvert.SerializeObject(list);
            return json;
        }
