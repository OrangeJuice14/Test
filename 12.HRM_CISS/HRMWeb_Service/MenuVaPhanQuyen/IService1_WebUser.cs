...
namespace HRMWeb_Service
{
    public partial interface IService1
    {
        ...
        /////////////////////////////////////////////
        [OperationContract]
        IEnumerable<DTO_WebUser> GetList_WebUserQuanTri(String publicKey, String token,Guid webgroupid, Guid congTy);

        [OperationContract]
        String GetList_WebUserQuanTri_Json(String publicKey, String token, Guid webgroupid, Guid congTy);

        /////////////khac quan tri////////////////////////////////////
        [OperationContract]
        IEnumerable<DTO_WebUser> GetList_WebUserKhacQuanTri(String publicKey, String token, Guid webgroupid, Guid congTy);

        [OperationContract]
        String GetList_WebUserKhacQuanTri_Json(String publicKey, String token, Guid webgroupid, Guid congTy);

        // Save////////////////////////////////////////////
        [OperationContract]
        bool Save_WebUser(String publicKey, String token, DTO_WebUser obj, string currentUserId);

        [OperationContract]
        bool Save_WebUser_Json(String publicKey, String token, string jsonObject, string currentUserId);
        // ////////////////////////////////////////////
        [OperationContract]
