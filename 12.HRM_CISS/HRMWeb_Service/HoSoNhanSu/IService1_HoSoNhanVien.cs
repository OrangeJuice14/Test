...
namespace HRMWeb_Service
{
    public partial interface IService1
    {
        ...
        // ///////////////////////////////////////
        [OperationContract]
        IEnumerable<DTO_HoSoNhanVien> GetList_HoSoNhanVienBy_MaBoPhan(String publicKey, String token, Guid? maBoPhan,Guid company);

        [OperationContract]
        String GetList_HoSoNhanVienBy_MaBoPhan_Json(String publicKey, String token, Guid? maBoPhan, Guid company);
    }
}
