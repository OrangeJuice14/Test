...
namespace HRMWeb_Business.Model
{
    ...
    public partial class WebMenu : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        public string Name_Eng
        {
            ...
            set
            {
    			string oldValue =  _name_Eng;
    			bool stopChanging = false;
                On_Name_Eng_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("Name_Eng");
    			if(!stopChanging)
    			{
    				_name_Eng = StructuralObject.SetValidValue(value, true);
    				ReportPropertyChanged("Name_Eng");
    				On_Name_Eng_Changed(oldValue, _name_Eng);//\\
    			}
            }
        }
    	public static String Name_Eng_PropertyName { get { return "Name_Eng"; } }
        private string _name_Eng;
        partial void On_Name_Eng_Changing(string currentValue, ref string newValue, ref bool stopChanging);
        partial void On_Name_Eng_Changed(string oldValue, string currentValue);
