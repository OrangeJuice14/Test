...
namespace HRMWeb_Business.Model
{
    ...
    public partial class BoPhan : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        /// <param name="iD_SIS">Initial value of the ID_SIS property.</param>
        public static BoPhan CreateBoPhan(System.Guid oid, int iD_SIS)
        {
            BoPhan boPhan = new BoPhan();
            boPhan.Oid = oid;
            boPhan.ID_SIS = iD_SIS;
            return boPhan;
        }
        ...
        public int ID_SIS
        {
            ...
            set
            {
    			int oldValue =  _iD_SIS;
    			bool stopChanging = false;
                On_ID_SIS_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("ID_SIS");
    			if(!stopChanging)
    			{
    				_iD_SIS = StructuralObject.SetValidValue(value);
    				ReportPropertyChanged("ID_SIS");
    				On_ID_SIS_Changed(oldValue, _iD_SIS);//\\
    			}
            }
        }
    	public static String ID_SIS_PropertyName { get { return "ID_SIS"; } }
        private int _iD_SIS;
        partial void On_ID_SIS_Changing(int currentValue, ref int newValue, ref bool stopChanging);
        partial void On_ID_SIS_Changed(int oldValue, int currentValue);
        ...
        public string TenBoPhanEn
        {
            ...
            set
            {
    			string oldValue =  _tenBoPhanEn;
    			bool stopChanging = false;
                On_TenBoPhanEn_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("TenBoPhanEn");
    			if(!stopChanging)
    			{
    				_tenBoPhanEn = StructuralObject.SetValidValue(value, true);
    				ReportPropertyChanged("TenBoPhanEn");
    				On_TenBoPhanEn_Changed(oldValue, _tenBoPhanEn);//\\
    			}
            }
        }
    	public static String TenBoPhanEn_PropertyName { get { return "TenBoPhanEn"; } }
        private string _tenBoPhanEn;
        partial void On_TenBoPhanEn_Changing(string currentValue, ref string newValue, ref bool stopChanging);
        partial void On_TenBoPhanEn_Changed(string oldValue, string currentValue);
