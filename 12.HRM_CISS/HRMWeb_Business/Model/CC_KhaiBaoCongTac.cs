...
namespace HRMWeb_Business.Model
{
    ...
    public partial class CC_KhaiBaoCongTac : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        partial void On_So_Changing(Nullable<int> currentValue, ref Nullable<int> newValue, ref bool stopChanging);
        partial void On_So_Changed(Nullable<int> oldValue, Nullable<int> currentValue);
        ...
        [EdmScalarPropertyAttribute(EntityKeyProperty=false, IsNullable=true)]
        [DataMemberAttribute()]
        public Nullable<System.Guid> WebUserDuyet
        {
            get
            {
                return _webUserDuyet;
            }
            set
            {
    			Nullable<System.Guid> oldValue =  _webUserDuyet;
    			bool stopChanging = false;
                On_WebUserDuyet_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("WebUserDuyet");
    			if(!stopChanging)
    			{
    				_webUserDuyet = StructuralObject.SetValidValue(value);
    				ReportPropertyChanged("WebUserDuyet");
    				On_WebUserDuyet_Changed(oldValue, _webUserDuyet);//\\
    			}
            }
        }
    	public static String WebUserDuyet_PropertyName { get { return "WebUserDuyet"; } }
        private Nullable<System.Guid> _webUserDuyet;
        partial void On_WebUserDuyet_Changing(Nullable<System.Guid> currentValue, ref Nullable<System.Guid> newValue, ref bool stopChanging);
        partial void On_WebUserDuyet_Changed(Nullable<System.Guid> oldValue, Nullable<System.Guid> currentValue);
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_CC_Attachments_CC_KhaiBaoCongTac", "CC_Attachments")]
        public EntityCollection<CC_Attachments> CC_Attachments
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<CC_Attachments>("ERPModel.FK_CC_Attachments_CC_KhaiBaoCongTac", "CC_Attachments");
            }
            set
            {
                if ((value != null))
                {
    				bool stopChanging = false;
    				On_CC_Attachments_Changing(ref value, ref stopChanging);//\\//
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<CC_Attachments>("ERPModel.FK_CC_Attachments_CC_KhaiBaoCongTac", "CC_Attachments", value);
    					On_CC_Attachments_Changed(this.CC_Attachments);//\\//
    				}
    			}
            }
        }
    	public static String CC_Attachments_EntityCollectionPropertyName { get { return "CC_Attachments"; } }
    	partial void On_CC_Attachments_Changing(ref EntityCollection<CC_Attachments> newValue, ref bool stopChanging);
    	partial void On_CC_Attachments_Changed(EntityCollection<CC_Attachments> currentValue);
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_CC_KhaiBaoCongTac_NguoiKy", "HoSo")]
        public HoSo HoSo1
        {//test
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<HoSo>("ERPModel.FK_CC_KhaiBaoCongTac_NguoiKy", "HoSo").Value;
            }
            set
            {
    			bool stopChanging = false;
    			...
    			if(!stopChanging)
    			{
    				((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<HoSo>("ERPModel.FK_CC_KhaiBaoCongTac_NguoiKy", "HoSo").Value = value;
        ...
        public EntityReference<HoSo> HoSo1Reference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<HoSo>("ERPModel.FK_CC_KhaiBaoCongTac_NguoiKy", "HoSo");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<HoSo>("ERPModel.FK_CC_KhaiBaoCongTac_NguoiKy", "HoSo", value);
                }
            }
        }
