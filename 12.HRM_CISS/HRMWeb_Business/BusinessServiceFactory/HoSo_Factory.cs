    ...
    public class HoSo_Factory : BaseFactory<Entities, HoSo>
    {
        ...
        {//su dung cho cham cong only
            var result = from o in this.ObjectSet
                         join x in this.Context.ThongTinNhanViens on o.Oid equals x.Oid
        ...
        public IEnumerable<DTO_HoSoNhanVien> GetListByMaBoPhan_GCRecordIsNull(Guid? maBoPhan,Guid congTy)
        {//
            ...
            try
            {
                var result = from o in this.ObjectSet
                             join x in this.Context.ThongTinNhanViens on o.Oid equals x.Oid
                             where o.GCRecord == null
                                   && (o.NhanVien.BoPhan == maBoPhan || maBoPhan == Guid.Empty)
                                   && o.NhanVien.TinhTrang1.DaNghiViec == false
                                   && o.NhanVien.CongTy == congTy
                             orderby o.HoTen ascending
                             select new DTO_HoSoNhanVien
                             {
                                 MaBoPhan = o.NhanVien.BoPhan1.Oid,
                                 Oid = o.Oid,
                                 Ho = o.Ho,
                                 Ten = o.Ten,
                                 HoTen = o.HoTen,
                                 MaQuanLy = o.MaNhanVien,
        ...
        public IQueryable<HoSo> GetList_HoSoNhanVienCoIDChamCong()
        {
            ...
            var result = from o in this.ObjectSet
                         ...
                         where o.GCRecord == null
                               && o.NhanVien.TinhTrang1.DaNghiViec == false
                               && !string.IsNullOrEmpty(x.IDChamCong)
                         orderby o.HoTen ascending
                         select o;
            return result;
        }
