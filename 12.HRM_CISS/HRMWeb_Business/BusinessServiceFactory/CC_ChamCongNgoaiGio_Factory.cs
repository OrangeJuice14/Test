...
namespace HRMWeb_Business.BusinessServiceFactory
{
    public class CC_ChamCongNgoaiGio_Factory : BaseFactory<Entities, CC_ChamCongNgoaiGio>
    {
        ...
        public IEnumerable<DTO_CC_ChamCongNgoaiGio> ChamCongNgoaiGio_Find(int thang, int nam, Guid idnhanvien)
        {
            var result = from o in this.ObjectSet
                                    where o.Ngay.Value.Month == thang
                                            && o.Ngay.Value.Year == nam
                                     ...
                                     select new DTO_CC_ChamCongNgoaiGio()
                                     {
                                         ...
                                         NgayTao = o.NgayTao,
                                         PhanHoi_TP = o.PhanHoi_TP,
                                         PhanHoi_BGH = o.PhanHoi_BGH,
                                         PhanHoi_Admin = o.PhanHoi_Admin
                                     };

            return result;
        }
        public IQueryable<DTO_CC_ChamCongNgoaiGio> QuanLyChamCongNgoaiGio_Find(int ngay, int thang, int nam, Guid idbophan, int trangthai, Guid userID,Guid congTy)
        {
            ...
            //
            if ((WebGroupConst.HoiDongQuanTriID.Equals(user.WebGroupID.ToString().ToUpper())
               || WebGroupConst.HoiDongQuanTriUyQuyenID.Equals(user.WebGroupID.ToString().ToUpper())))
            {
                result = (from o in this.ObjectSet
                          where o.Ngay.Value.Month == thang
                                  && o.Ngay.Value.Year == nam
                                  && (o.Ngay.Value.Day == ngay || ngay == 0)
                                  && (idbophan == Guid.Empty || o.IDBoPhan == idbophan || o.BoPhan.BoPhanCha == idbophan)
                                  && (danhSachPhongBanPhanQuyen.Any(x => x.Oid == o.IDBoPhan))
                                  && (o.IsTruongPhong == true && cauHinh.HDQTDuyetPhepTruongDonVi == true)
            ...
            else if ((idHieuTruong.Equals(user.WebGroupID.ToString().ToUpper())
               || idHieuTruongUyQuyen.Equals(user.WebGroupID.ToString().ToUpper())))
            {
                result = (from o in this.ObjectSet
                          where o.Ngay.Value.Month == thang
                                  ...
                                  && (danhSachPhongBanPhanQuyen.Any(x => x.Oid == o.IDBoPhan))
                                  && (o.TrangThai_BGH == trangthai || trangthai == 3)
                                  && (o.IsTruongPhong == false || cauHinh.HDQTDuyetPhepTruongDonVi == false)
                                  && o.NgoaiKeHoach.Value
                                  && o.TrangThai_TP == 1
                                  && o.ThongTinNhanVien.NhanVien.CongTy == congTy
                          orderby o.Ngay
            ...
            else if ((idTruongPhong.Equals(user.WebGroupID.ToString().ToUpper())
            ...
            else if (idQuanTriTruong.Equals(user.WebGroupID.ToString().ToUpper()))
            {
                result = (from o in this.ObjectSet
                          where o.Ngay.Value.Month == thang
                                  && o.Ngay.Value.Year == nam
            ...
            else if (idAdmin.Equals(user.WebGroupID.ToString().ToUpper()))
            {
                result = (from o in this.ObjectSet
                          where o.Ngay.Value.Month == thang
                                  && o.Ngay.Value.Year == nam
        ...
        public IQueryable<DTO_CC_ChamCongNgoaiGio> QuanLyChamCongNgoaiGio_Find_NhacViec(int ngay, int thang, int nam, Guid idbophan, int trangthai, Guid userID,Guid congTy, bool tatCaDonChuaDuyet)
        {
            WebUser user = (new WebUser_Factory()).GetByID(userID);
            if (user == null) return null;
            string idQuanTriTruong = WebGroupConst.QuanTriTruongID.ToString().ToUpper();
            ...
            {
                result = (from o in this.ObjectSet
                          where (tatCaDonChuaDuyet || (o.Ngay.Value.Month == thang && o.Ngay.Value.Year == nam && (o.Ngay.Value.Day == ngay || ngay == 0)))
                                  && (idbophan == Guid.Empty || o.IDBoPhan == idbophan || o.BoPhan.BoPhanCha == idbophan)
                                  && (danhSachPhongBanPhanQuyen.Any(x => x.Oid == o.IDBoPhan))
                                  && (o.TrangThai_BGH == 0)
                                  &&  o.NgoaiKeHoach.Value
