...
namespace HRMWeb_Business.BusinessServiceFactory
{
    public class CC_HinhThucNghi_Factory : BaseFactory<Entities, CC_HinhThucNghi>
    {
        ...
        #region Custom
        public IQueryable<CC_HinhThucNghi> GetKyHieu_All()
        {
            var result = from o in this.ObjectSet
                         where o.GCRecord == null
                         orderby o.KyHieu ascending
                         select o;
            return result;
        }
        public IQueryable<CC_HinhThucNghi> ChamCongNgayNghi_GetHinhThucNghiList(Guid congTy)
        {
            var result = from o in this.ObjectSet
                         where o.GCRecord == null
                               && ( o.CongTy == congTy || o.CongTy != null) // Lưu ý
                               && o.HinhThucNghi == true
        ...
        public IQueryable<CC_HinhThucNghi> GetAll_GCRecordIsNull()
        {
            var result = from o in this.ObjectSet
                         where o.GCRecord == null
                         orderby o.Oid.ToString() ascending
                         select o;
            return result;
        }
        ...
        public CC_HinhThucNghi GetByKyHieu(string kyhieu)
        {
            var result = (from o in this.ObjectSet
                          where o.KyHieu.Equals(kyhieu)
                          select o).SingleOrDefault();
            return result;
        }
