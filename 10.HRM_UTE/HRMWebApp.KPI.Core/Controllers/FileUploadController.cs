...
namespace HRMWebApp.KPI.Core.Controllers
{
    public class FileUploadController : Controller
    {
        ...
        public ActionResult SaveActivityDetailFile(IEnumerable<HttpPostedFileBase> files, Guid activityDetailId)
        {
            // The Name of the Upload component is "files"
            SessionManager.DoWork(session =>
            {
                if (files != null)
                {
                    ...
                    foreach (var file in files)
                    {
                        ...
                        pf.ProfessorOtherActivity = new ProfessorOtherActivity() { Id = activityDetailId };
                        pf.CreationTime = DateTime.Now;
                        session.Save(pf);
