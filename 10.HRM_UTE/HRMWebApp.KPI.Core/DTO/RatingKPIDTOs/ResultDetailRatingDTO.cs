...
namespace HRMWebApp.KPI.Core.DTO.RatingKPIDTOs
{
    public class ResultDetailRatingDTO
    {
        public ResultDetailRatingDTO()
        {
            ...
            DoDuLieuDanhGia = new List<DoDuLieuDanhGiaDTO>();
            ScienceResearchesResult = new List<ScienceResearchDataDTO>();
        }
        ...
        public List<ScienceResearchDataDTO> ScienceResearchesResult { get; set; }
        ...
        public double StaffRealDensity { get; set; }
        ...
        public List<DoDuLieuDanhGiaDTO> DoDuLieuDanhGia { get; set; }
        public int IdDanhGiaChiTiet { get; set; }
        public ProfessorCriterionDTO ProfessorCriterion { get; set; }
        public double GiangDayActivityRecord { get; set; }
        public string ResultName { get; set; }
        public string ManageCodeId { get; set; }
        public string ManageCodeName { get; set; }
