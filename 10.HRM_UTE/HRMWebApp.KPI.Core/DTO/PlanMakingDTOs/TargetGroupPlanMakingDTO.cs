...
namespace HRMWebApp.KPI.Core.DTO.PlanMakingDTOs
{
    ...
    public class PlanKPIMakingDetailDTO
    {
        public PlanKPIMakingDetailDTO()
        {
            ...
            PlanDetailSubStaffs = new List<PlanDetailSubStaffDTO>();
          //  PlanKPIDetail = new List<PlanKPIDetailDTO>();
        }
        public Guid Id { get; set; }
        public string Name { get; set; }
        ...
        public double CurrentKPIRecord { get; set; }
        ...
        public ManageCodeDTO ManageCode { get; set; }
        public string ManageId { get; set; }
        public int AgentObjectTypeId { get; set; }
        public bool IsOriginal { get; set; }
        public int TargetGroupDetailOrderNumber { get; set; }
        public CriterionDictionary CriterionDictionary { get; set; }
        public List<PlanDetailSubStaffDTO> PlanDetailSubStaffs { get; set; }
        public bool IsMoved { get; set; }
        public int CapMucTieu { get; set; }
        public Guid TargetGroupDetailId { get; set; }
        public string StudyYear { get; set; }
        public Guid DanhMucMTCLId { get; set; }
        public DanhMucMTCLDTO DanhMucMTCL { get; set; }
        public double NumberOfHour { get; set; }
        public Guid ProfessorCriterionId { get; set; }
       // public List<PlanKPIDetailDTO> PlanKPIDetail { get; set; }
