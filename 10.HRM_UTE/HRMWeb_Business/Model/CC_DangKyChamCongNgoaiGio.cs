...
namespace HRMWeb_Business.Model
{
    ...
    public partial class CC_DangKyChamCongNgoaiGio : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [EdmScalarPropertyAttribute(EntityKeyProperty=false, IsNullable=true)]
        [DataMemberAttribute()]
        public Nullable<byte> DuyetAdmin
        {
            get
            {
                return _duyetAdmin;
            ...
            set
            {
    			Nullable<byte> oldValue =  _duyetAdmin;
    			bool stopChanging = false;
                On_DuyetAdmin_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("DuyetAdmin");
    			if(!stopChanging)
    			{
    				_duyetAdmin = StructuralObject.SetValidValue(value);
    				ReportPropertyChanged("DuyetAdmin");
    				On_DuyetAdmin_Changed(oldValue, _duyetAdmin);//\\
    			}
            }
        }
    	public static String DuyetAdmin_PropertyName { get { return "DuyetAdmin"; } }
        private Nullable<byte> _duyetAdmin;
        partial void On_DuyetAdmin_Changing(Nullable<byte> currentValue, ref Nullable<byte> newValue, ref bool stopChanging);
        partial void On_DuyetAdmin_Changed(Nullable<byte> oldValue, Nullable<byte> currentValue);
