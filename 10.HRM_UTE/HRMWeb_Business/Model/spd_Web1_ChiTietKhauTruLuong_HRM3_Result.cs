...
namespace HRMWeb_Business.Model
{
    ...
    /// </summary>
    [EdmComplexTypeAttribute(NamespaceName="ERPModel", Name="spd_Web1_ChiTietKhauTruLuong_HRM3_Result")]
    [DataContractAttribute(IsReference=true)]
    [Serializable()]
    public partial class spd_Web1_ChiTietKhauTruLuong_HRM3_Result : ComplexObject
    {
        #region Factory Method
    
        /// <summary>
        /// Create a new spd_Web1_ChiTietKhauTruLuong_HRM3_Result object.
        /// </summary>
        /// <param name="soTien">Initial value of the SoTien property.</param>
        public static spd_Web1_ChiTietKhauTruLuong_HRM3_Result Createspd_Web1_ChiTietKhauTruLuong_HRM3_Result(decimal soTien)
        {
            spd_Web1_ChiTietKhauTruLuong_HRM3_Result spd_Web1_ChiTietKhauTruLuong_HRM3_Result = new spd_Web1_ChiTietKhauTruLuong_HRM3_Result();
            spd_Web1_ChiTietKhauTruLuong_HRM3_Result.SoTien = soTien;
            return spd_Web1_ChiTietKhauTruLuong_HRM3_Result;
        }
