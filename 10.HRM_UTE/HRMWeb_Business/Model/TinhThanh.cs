...
namespace HRMWeb_Business.Model
{
    ...
    public partial class TinhThanh : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_DiaChi_TinhThanh", "DiaChi")]
        public EntityCollection<DiaChi> DiaChis
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<DiaChi>("ERPModel.FK_DiaChi_TinhThanh", "DiaChi");
            }
            set
            {
                if ((value != null))
                {
    				...
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<DiaChi>("ERPModel.FK_DiaChi_TinhThanh", "DiaChi", value);
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_Web_UpdateHoSoNhanVien_NoiCap", "Web_UpdateHoSoNhanVien")]
        public EntityCollection<Web_UpdateHoSoNhanVien> Web_UpdateHoSoNhanVien
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<Web_UpdateHoSoNhanVien>("ERPModel.FK_Web_UpdateHoSoNhanVien_NoiCap", "Web_UpdateHoSoNhanVien");
            }
            set
            {
                if ((value != null))
                {
    				...
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<Web_UpdateHoSoNhanVien>("ERPModel.FK_Web_UpdateHoSoNhanVien_NoiCap", "Web_UpdateHoSoNhanVien", value);
