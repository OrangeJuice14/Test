...
namespace HRMWeb_Business.Model
{
    ...
    public partial class TinhTrangHonNhan : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_Web_UpdateHoSoNhanVien_TinhTrangHonNhan", "Web_UpdateHoSoNhanVien")]
        public EntityCollection<Web_UpdateHoSoNhanVien> Web_UpdateHoSoNhanVien
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<Web_UpdateHoSoNhanVien>("ERPModel.FK_Web_UpdateHoSoNhanVien_TinhTrangHonNhan", "Web_UpdateHoSoNhanVien");
            }
            set
            {
                if ((value != null))
                {
    				...
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<Web_UpdateHoSoNhanVien>("ERPModel.FK_Web_UpdateHoSoNhanVien_TinhTrangHonNhan", "Web_UpdateHoSoNhanVien", value);
