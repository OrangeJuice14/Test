...
namespace HRMWeb_Business.Model
{
    ...
    public partial class CC_DangKyKhungGioLamViec : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [EdmScalarPropertyAttribute(EntityKeyProperty=false, IsNullable=true)]
        [DataMemberAttribute()]
        public Nullable<System.Guid> CaChamCongMoi
        {
            get
            {
                return _caChamCongMoi;
            }
            set
            {
    			Nullable<System.Guid> oldValue =  _caChamCongMoi;
    			bool stopChanging = false;
                On_CaChamCongMoi_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("CaChamCongMoi");
    			if(!stopChanging)
    			{
    				_caChamCongMoi = StructuralObject.SetValidValue(value);
    				ReportPropertyChanged("CaChamCongMoi");
    				On_CaChamCongMoi_Changed(oldValue, _caChamCongMoi);//\\
    			}
            }
        }
    	public static String CaChamCongMoi_PropertyName { get { return "CaChamCongMoi"; } }
        private Nullable<System.Guid> _caChamCongMoi;
        partial void On_CaChamCongMoi_Changing(Nullable<System.Guid> currentValue, ref Nullable<System.Guid> newValue, ref bool stopChanging);
        partial void On_CaChamCongMoi_Changed(Nullable<System.Guid> oldValue, Nullable<System.Guid> currentValue);
        ...
        [EdmScalarPropertyAttribute(EntityKeyProperty=false, IsNullable=true)]
        [DataMemberAttribute()]
        public Nullable<bool> ChoPhepDoi
        {
            get
            {
                return _choPhepDoi;
            ...
            set
            {
    			Nullable<bool> oldValue =  _choPhepDoi;
    			bool stopChanging = false;
                On_ChoPhepDoi_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("ChoPhepDoi");
    			if(!stopChanging)
    			{
    				_choPhepDoi = StructuralObject.SetValidValue(value);
    				ReportPropertyChanged("ChoPhepDoi");
    				On_ChoPhepDoi_Changed(oldValue, _choPhepDoi);//\\
    			}
            }
        }
    	public static String ChoPhepDoi_PropertyName { get { return "ChoPhepDoi"; } }
        private Nullable<bool> _choPhepDoi;
        partial void On_ChoPhepDoi_Changing(Nullable<bool> currentValue, ref Nullable<bool> newValue, ref bool stopChanging);
        partial void On_ChoPhepDoi_Changed(Nullable<bool> oldValue, Nullable<bool> currentValue);
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_CC_DangKyKhungGioLamViec_CaChamCongMoi", "CC_CaChamCong")]
        public CC_CaChamCong CC_CaChamCong1
        {//test
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<CC_CaChamCong>("ERPModel.FK_CC_DangKyKhungGioLamViec_CaChamCongMoi", "CC_CaChamCong").Value;
            }
            set
            {
    			bool stopChanging = false;
    			...
    			if(!stopChanging)
    			{
    				((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<CC_CaChamCong>("ERPModel.FK_CC_DangKyKhungGioLamViec_CaChamCongMoi", "CC_CaChamCong").Value = value;
        ...
        public EntityReference<CC_CaChamCong> CC_CaChamCong1Reference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<CC_CaChamCong>("ERPModel.FK_CC_DangKyKhungGioLamViec_CaChamCongMoi", "CC_CaChamCong");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<CC_CaChamCong>("ERPModel.FK_CC_DangKyKhungGioLamViec_CaChamCongMoi", "CC_CaChamCong", value);
                }
            }
        }
