...
namespace HRMWeb_Business.Model
{
    ...
    public partial class KyTinhLuong : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_CC_QuanLyChamCongNhanVien_KyTinhLuong", "CC_QuanLyChamCongNhanVien")]
        public EntityCollection<CC_QuanLyChamCongNhanVien> CC_QuanLyChamCongNhanVien
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<CC_QuanLyChamCongNhanVien>("ERPModel.FK_CC_QuanLyChamCongNhanVien_KyTinhLuong", "CC_QuanLyChamCongNhanVien");
            }
            set
            {
                if ((value != null))
                {
    				bool stopChanging = false;
    				On_CC_QuanLyChamCongNhanVien_Changing(ref value, ref stopChanging);//\\//
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<CC_QuanLyChamCongNhanVien>("ERPModel.FK_CC_QuanLyChamCongNhanVien_KyTinhLuong", "CC_QuanLyChamCongNhanVien", value);
    					On_CC_QuanLyChamCongNhanVien_Changed(this.CC_QuanLyChamCongNhanVien);//\\//
    				}
    			}
            }
        }
    	public static String CC_QuanLyChamCongNhanVien_EntityCollectionPropertyName { get { return "CC_QuanLyChamCongNhanVien"; } }
    	partial void On_CC_QuanLyChamCongNhanVien_Changing(ref EntityCollection<CC_QuanLyChamCongNhanVien> newValue, ref bool stopChanging);
    	partial void On_CC_QuanLyChamCongNhanVien_Changed(EntityCollection<CC_QuanLyChamCongNhanVien> currentValue);
