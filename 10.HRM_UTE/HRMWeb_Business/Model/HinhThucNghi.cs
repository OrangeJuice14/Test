...
namespace HRMWeb_Business.Model
{
    ...
    public partial class HinhThucNghi : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [EdmScalarPropertyAttribute(EntityKeyProperty=false, IsNullable=true)]
        [DataMemberAttribute()]
        public Nullable<byte> LoaiDonXinNghi
        {
            get
            {
                return _loaiDonXinNghi;
            }
            set
            {
    			Nullable<byte> oldValue =  _loaiDonXinNghi;
    			bool stopChanging = false;
                On_LoaiDonXinNghi_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("LoaiDonXinNghi");
    			if(!stopChanging)
    			{
    				_loaiDonXinNghi = StructuralObject.SetValidValue(value);
    				ReportPropertyChanged("LoaiDonXinNghi");
    				On_LoaiDonXinNghi_Changed(oldValue, _loaiDonXinNghi);//\\
    			}
            }
        }
    	public static String LoaiDonXinNghi_PropertyName { get { return "LoaiDonXinNghi"; } }
        private Nullable<byte> _loaiDonXinNghi;
        partial void On_LoaiDonXinNghi_Changing(Nullable<byte> currentValue, ref Nullable<byte> newValue, ref bool stopChanging);
        partial void On_LoaiDonXinNghi_Changed(Nullable<byte> oldValue, Nullable<byte> currentValue);
