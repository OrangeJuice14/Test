...
namespace HRMWeb_Business.BusinessServiceFactory
{
    public class CC_KhaiBaoCongTac_Factory : BaseFactory<Entities, CC_KhaiBaoCongTac>
    {
        ...
        public IQueryable<DTO_QuanLyKhaiBaoCongTac_Find> CaNhanKhaiBaoCongTac_Find(int thang, int nam, Guid idnhanvien)
        {
            ...
            var result = (from o in this.ObjectSet
                          where (o.IDNhanVien == idnhanvien || idnhanvien == Guid.Empty)
                                && o.TuNgay <= ngayCuoiThang
                                && o.DenNgay >= ngayDauThang
                          select new DTO_QuanLyKhaiBaoCongTac_Find() { DenNgay = o.DenNgay, HoTen = o.HoSo.HoTen, BoPhan = o.HoSo.NhanVien.BoPhan1.TenBoPhan, IDNhanVien = o.IDNhanVien, IDWebUser = o.IDWebUser, SoHieuCongChuc = o.HoSo.NhanVien.ThongTinNhanVien.SoHieuCongChuc, NgayTao = o.NgayTao, Oid = o.Oid, NoiDung = o.NoiDung, TrangThai = o.TrangThai, TuNgay = o.TuNgay, Buoi = o.Buoi.ToString(), DiaDiem = o.DiaDiem }
                          );
            return result;
        }
