...
namespace HRMWeb_Business.BusinessServiceFactory
{
    public class HoSo_Factory : BaseFactory<Entities, HoSo>
    {
        ...
        public IEnumerable<DTO_HoSoNhanVien> GetListByMaBoPhan(Guid? maBoPhan)
        {//su dung cho cham cong only
            bool tatCaBoPhan = (maBoPhan == null ? true : false);
            var result = from o in this.ObjectSet
                         where o.GCRecord == null
                         ...
                         select new DTO_HoSoNhanVien()
                         {
                             ...
                             Ten = o.Ten,
                             HoTen = o.HoTen,
                             MaQuanLy = o.NhanVien.ThongTinNhanVien.SoHieuCongChuc
                         };
            return result;
        }
        ...
        public HoSo GetTruongDonViByBoPhan(Guid boPhanId)
        {
            var result = (from o in this.ObjectSet
                          where o.GCRecord == null
                              && o.NhanVien.TinhTrang1.KhongConCongTacTaiTruong == false
                              && o.NhanVien.BoPhan == boPhanId
                              && (o.NhanVien.ThongTinNhanVien.ChucVu1.TenChucVu == "Trưởng Khoa"
                                || o.NhanVien.ThongTinNhanVien.ChucVu1.TenChucVu == "Trưởng Phòng"
                                || o.NhanVien.ThongTinNhanVien.ChucVu1.TenChucVu == "Trưởng trung tâm")
