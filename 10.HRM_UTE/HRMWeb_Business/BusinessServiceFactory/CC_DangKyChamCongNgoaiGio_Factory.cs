...
namespace HRMWeb_Business.BusinessServiceFactory
{
    public class CC_DangKyChamCongNgoaiGio_Factory : BaseFactory<Entities, CC_DangKyChamCongNgoaiGio>
    {
        ...
        public List<DTO_CC_DangKyChamCongNgoaiGio> GetDangKyChamCongNgoaiGioByThangNam(int thang, int nam)
        {
            var result = (from o in this.ObjectSet
                          ...
                          select new DTO_CC_DangKyChamCongNgoaiGio {
                              ...
                              SoPhutDangKy = o.SoPhutDangKy != null ? o.SoPhutDangKy.Value / 60 : 0,
                              SoPhutThucTe = o.SoPhutThucTe != null ? o.SoPhutThucTe.Value / 60 : 0,
                              ThoiGianBatDau = o.TuGio,
                              ThoiGianKetThuc = o.DenGio,
                              Ngay = o.Ngay,
                              LyDo = o.LyDo,
                              Duyet = o.Duyet,
                              DonGia = o.DonGiaNgoaiGio != null ? o.DonGiaNgoaiGio.Value : 0,
                              ThanhTien = o.ThanhTien != null ? o.ThanhTien.Value : 0
                          } ).ToList();
            return result;
        }
        ...
        public IQueryable<DTO_CC_DangKyChamCongNgoaiGio> QuanLyDangKyChamCongNgoaiGio_Find(int? ngay, int thang, int nam, Guid IDBoPhan,byte? trangthai)
        {
            ...
            var result = (from o in this.ObjectSet
                          where ( o.IDBoPhan== IDBoPhan || IDBoPhan == Guid.Empty)
                          && o.Ngay.Value.Month == thang 
                          && o.Ngay.Value.Year == nam
                          && (ngay == 0 || o.Ngay.Value.Day==ngay)
            ...
            return result.OrderBy(x=>x.HoTen);
        }
