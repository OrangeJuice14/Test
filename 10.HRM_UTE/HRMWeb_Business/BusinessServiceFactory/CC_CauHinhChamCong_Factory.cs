...
namespace HRMWeb_Business.BusinessServiceFactory
{
    public class CC_CauHinhChamCong_Factory : BaseFactory<Entities, CC_CauHinhChamCong>
    {
        ...
        #region Custom
        public DTO_CC_CauHinhChamCong GetCauHinhCauCong()
        {
            var result = (from o in this.ObjectSet
                          select new DTO_CC_CauHinhChamCong
                          {
                              ...
                              DonGiaNgoaiGio = o.DonGiaNgoaiGio != null ? o.DonGiaNgoaiGio.Value : 0

                          }).SingleOrDefault();
            //
            return result;
        }
        public CC_CauHinhChamCong GetCauHinhCauCongByOid(Guid oid)
        {
            var result = (from o in this.ObjectSet
                          where o.Oid == oid
