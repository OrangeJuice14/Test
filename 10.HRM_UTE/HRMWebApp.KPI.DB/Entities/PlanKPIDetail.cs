   ...
   public class PlanKPIDetail
    {
       public PlanKPIDetail()
       {
           ...
           SubStaffs = new List<PlanDetailSubStaff>();
        ...
        public virtual IList<DoDuLieuDanhGia> DoDuLieuDanhGia { get; set; }
        public virtual DateTime CreateTime { get; set; }
        public virtual IList<Department> SubDepartments { get; set; }
        //public virtual IList<Staff> SubStaffs { get; set; }
        public virtual IList<PlanDetailSubStaff> SubStaffs { get; set; }
        ...
        public virtual int CapMucTieu { get; set; }
        public virtual DanhMucMTCL DanhMucMTCL { get; set; }
    }
}
