...
define(['app/app', 'app/services/kpi/criterionService', 'app/services/kpi/professorCriterionService', 'app/services/kpi/targetGroupDetailService', 'app/services/kpi/departmentService', 'app/services/kpi/agentObjectService', 'app/controllers/kpi/criterionDictionaryController', ], function (app) {
    ...
    app.controller('criterionController', ['$scope', '$rootScope', '$modal', 'criterionService', 'professorCriterionService', 'targetGroupDetailService', 'departmentService', 'agentObjectService',
            function ($scope, $rootScope, $modal, criterionService, professorCriterionService, targetGroupDetailService, departmentService, agentObjectService) {
                ...
                $scope.obj = {};
                $scope.StudyYear = MANAGER.GUID_EMPTY;
                ...
                agentObjectService.getStudyYear().then(function (result) {
                    $scope.studyyear = result.data;
                    $scope.studyyear.splice(0, 0, { Id: '00000000-0000-0000-0000-000000000000', Name: 'Tất cả' });
                    $scope.StudyYear = $scope.studyyear[0].Id;
                });
                ...
                $scope.Search = function () {
                    ...
                    $scope.dataSource = new kendo.data.DataSource({
                        transport: {
                            read: function (options) {
                                return professorCriterionService.Search($scope.TargetGroupDetailId, $scope.StudyYear).then(function (result) {
                                    options.success(result.data);
                                });
                            }
                        },
    ...
    function ($scope, $modal, $modalInstance, id, targetGroupDetailId, professorCriterionService, targetGroupDetailService, departmentService, agentObjectService) {
        ...
        targetGroupDetailService.GetListbyAgentObject().then(function (result) {
            $scope.targetGroupDetails = result.data;
        });
        ...
        professorCriterionService.getDonViTinhList().then(function (result) {
            $scope.DonViTinhs = result.data;
        });

        professorCriterionService.getDanhGiaChiTietList().then(function (result) {
            $scope.DanhGiaChiTiets = result.data;
        });

        //professorCriterionService.getStudyYear().then(function (result) {
        ...
        $scope.donvicungcap = {
            placeholder: "Chọn đơn vị cung cấp dữ liệu...",
            dataTextField: "Name",
            dataValueField: "Id",
            valuePrimitive: true,
            autoBind: false,
        ...
        //departmentService.getList().then(function (result) {
        //    $scope.donvicungcap = result.data;
        //    $scope.donvicungcap.splice(0, 0, { Id: '00000000-0000-0000-0000-000000000000', Name: 'Tất cả đơn vị' });
        //    $scope.obj.DepartmentIds = $scope.donvicungcap[0].Id;
        //});

        $scope.ChucDanh = {
            placeholder: "Chọn chức danh cung cấp dữ liệu...",
            ...
            dataSource: {
                transport: {
                    read: function (options) {
                        return professorCriterionService.getListChucDanh().then(function (result) {
                            options.success(result.data);
                        });
                    }
                }
        ...
        if ($scope.isNew) {
            ...
            professorCriterionService.getObj(id).then(function (result) {
                ...
                $scope.obj.DonViTinh.Id = result.data.DonViTinhId;
                $scope.obj.DanhGiaChiTiet.Id = result.data.DanhGiaChiTietId;
            });
        }
