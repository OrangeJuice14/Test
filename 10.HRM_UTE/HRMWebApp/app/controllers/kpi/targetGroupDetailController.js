...
define(['app/app', 'app/services/kpi/targetGroupDetailService', 'app/services/kpi/agentObjectService', 'app/services/kpi/studyYearService'], function (app) {
    "use strict";
    ...
    app.controller('targetGroupDetail_DetailController', ['$scope', '$modalInstance', 'id', 'agentObjectId', 'targetGroupDetailService', 'targetGroupService', 'agentObjectService', 'studyYearService',
        function ($scope, $modalInstance, id, agentObjectId, targetGroupDetailService, targetGroupService, agentObjectService, studyYearService) {
            ...
            targetGroupDetailService.getListTargetGroupDetailType().then(function (result) {
                $scope.targetGroupDetailTypes = result.data;
            });
            ...
            //        transport: {
            //            read: function (options) {
            //                return targetGroupDetailService.getListTarget().then(function (result) {
            //                    options.success(result.data);
            //                });
            //            }
            //        }
            ...
            $scope.studyYears = {
                ...
                dataSource: {
                    transport: {
                        read: function (options) {
                            return studyYearService.getList().then(function (result) {
                                options.success(result.data);
                            });
                        }
                    }
            ...
            $scope.save = function () {
                if ($scope.isNew) {
                   ...
                   // $scope.obj.IsCheck = $scope.Chitietnhiemvu;
                    targetGroupDetailService.Save($scope.obj).then(function () {
                        $modalInstance.close();
                    });
                }
