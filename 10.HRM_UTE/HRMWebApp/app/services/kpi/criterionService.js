define(['app/app'], function (app) {
    ...
    app.factory('criterionService', ['$http', '$q', function ($http, $q) {
        ...
        serviceResult.getDensityDictionaryById = function (Id) {
            return $http.get('/Api/criterionApi/GetDensityDictionaryById?Id=' + Id);
        }
        serviceResult.getDensityDictionary = function () {
            return $http.get('/Api/criterionApi/GetDensityDictionary');
        }
        ...
        serviceResult.getListManageCodeDTO = function (staffType) {
            return $http.get('/Api/criterionApi/GetListManageCode?staffType=' + staffType);
        }
