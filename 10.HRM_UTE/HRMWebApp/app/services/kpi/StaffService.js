define(['app/app'], function (app) {
    ...
    app.factory('staffService', ['$http', '$q', function ($http, $q) {
        ...
        serviceResult.getListAll = function () {
        ...
        serviceResult.getSearchOnlyProfessor = function () {
            return $http.get('/Api/staffApi/GetSearchOnlyProfessor');
        };
        ...
        serviceResult.getDirectLeader = function (departmentId, agentObjectId, normalStaffId) {
            return $http.get('/Api/staffApi/GetDirectLeader?departmentId=' + departmentId + '&agentObjectId=' + agentObjectId + '&normalStaffId=' + normalStaffId);
        };
        ...
        serviceResult.getSubjectStaff = function (agentObjectTypeId, planId) {
            return $http.get('/Api/staffApi/GetSubjectStaff?agentObjectTypeId=' + agentObjectTypeId + '&planId=' + planId);
        };
        serviceResult.getStaffInSubPosition = function (agentObjectTypeId, planId) {
            return $http.get('/Api/staffApi/GetStaffInSubPosition?agentObjectTypeId=' + agentObjectTypeId + '&planId=' + planId);
        };
        ...
        serviceResult.getStaffInFaculty = function (typeId, departmentId, planId) {
            return $http.get('/Api/staffApi/GetStaffInFaculty?typeId=' + typeId + '&departmentId=' + departmentId + '&planId=' + planId);
        };
        serviceResult.getListDepartmentLeader = function (planId) {
            return $http.get('/Api/staffApi/GetListDepartmentLeader?planId=' + planId);
        };
        serviceResult.getCheckIsSupervisor = function () {
            return $http.get('/Api/staffApi/GetCheckIsSupervisor');
        };
        serviceResult.getCheckStaffInFaculty = function (id) {
            return $http.get('/Api/staffApi/GetCheckStaffInFaculty?staffId=' + id);
        };
