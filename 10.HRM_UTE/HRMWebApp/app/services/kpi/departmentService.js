define(['app/app'], function (app) {
    ...
    app.factory('departmentService', ['$http', '$q', function ($http, $q) {
        ...
        serviceResult.getDepartment = function (agentObjectTypeId) {
            return $http.get('/Api/departmentApi/GetDepartmentList?agentObjectTypeId=' + agentObjectTypeId);
        };
        serviceResult.getMainDeptWithoutUserDept = function (departmentId) {
            return $http.get('/Api/departmentApi/GetMainDeptWithoutUserDept');
        };
        serviceResult.getDeptPlanOfUser = function () {
            return $http.get('/Api/departmentApi/GetDeptPlanOfUser');
        };
