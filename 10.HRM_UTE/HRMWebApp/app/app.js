define(['angularAMD', 'ui-route', 'ui-validate', 'ui-bootstrap', 'kendo', 'ui-bootstrap-tpls'], function (angularAMD) {
    ...
    HRMWebApp.factory('principal', ['$q', '$http', '$timeout',
    ...
    HRMWebApp.config(['$stateProvider', '$urlRouterProvider', '$locationProvider', function ($stateProvider, $urlRouterProvider, $locationProvider) {
        ...
        ////////////////////***********  CHAM CONG ********************///////////////////////////
            ...
            //Ho so nhan su
             ...
             //Update  Ho so nhan su
             .state('UpdateHoSoNhanSu', angularAMD.route({
                 data: {
                     roles: ['kpi/capnhathoso']
                 },
                 resolve: {
                     authorize: ['authorization',
                       function (authorization) {
                 ...
                 url: '/kpi/capnhathoso',
                 templateUrl: '/app/views/chamcong/HoSoNhanSu/Manage_HoSoNhanVien.html'
             }))
            ...
            //quan ly cham cong cán bộ bình thường
            ...
            //quan ly cham cong công nhật
             .state('quanlychamcong_congnhat', angularAMD.route({
                 data: {
                     roles: ['kpi/quanlychamcong_congnhat']
                 },
                 resolve: {
                     authorize: ['authorization',
                       function (authorization) {
                 ...
                 url: '/kpi/quanlychamcong_congnhat',
                 templateUrl: '/app/views/chamcong/QuanLyChamCong/Manage_CongNhat.html'
             }))

            //quan ly cham cong bả vệ
             .state('quanlychamcong_baove', angularAMD.route({
                 data: {
                     roles: ['kpi/quanlychamcong_baove']
                 },
                 resolve: {
                     authorize: ['authorization',
                       function (authorization) {
                 ...
                 url: '/kpi/quanlychamcong_baove',
                 templateUrl: '/app/views/chamcong/QuanLyChamCong/Manage_BaoVe.html'
             }))
        ...
        .state('thongkekhunggiolamviec', angularAMD.route({
            data: {
                roles: ['kpi/thongkekhunggiolamviec']
            },
            resolve: {
                authorize: ['authorization',
                  function (authorization) {
            ...
            url: '/kpi/thongkekhunggiolamviec',
            templateUrl: '/app/views/chamcong/QuanLyChamCong/ThongKeKhungGioLamViec.html'
        }))
            ...
            .state('dangkynghiphep', angularAMD.route({
                data: {
                    roles: ['kpi/dangkynghiphep']
                },
                resolve: {
                    authorize: ['authorization',
                        function (authorization) {
        ...
        .state('agentTargetManage', {
            ...
            views: {
                ...
                'tytrong@agentTargetManage': angularAMD.route({
                    templateUrl: '/app/views/kpi/agent_TargetManage/tytrong.html',
                    controller: 'agentObject_TytrongController',
                    controllerUrl: 'app/controllers/kpi/agentObjectController'
                }),
            }
        })
        .state('professorActivityManage', {
         ...
         .state('dodulieudanhgia', angularAMD.route({
             url: '/kpi/dodulieugiangday',
             templateUrl: '/app/views/kpi/dodulieudanhgia/manage.html',
             controller: 'dodulieudanhgiaController',
             controllerUrl: 'app/controllers/kpi/dodulieudanhgiaController'
         }))
        .state('diemthuongdiemtru', angularAMD.route({
            url: '/kpi/diemthuongdiemtru',
            templateUrl: '/app/views/kpi/diemthuongdiemtru/manage.html',
            controller: 'diemthuongdiemtruController',
            controllerUrl: 'app/controllers/kpi/diemthuongdiemtruController'
        }))
        .state('planKPI', angularAMD.route({
            ...
            views: {
                ...
                'planManageDetail@planKPI': angularAMD.route({
                    templateUrl: '/app/views/kpi/planKPIDetail/planManageDetail.html',
                    controller: 'planKPIController',
                    controllerUrl: 'app/controllers/kpi/planKPIController'
                }),
                //'departmentRating@planKPI': angularAMD.route({
                //    templateUrl: '/app/views/kpi/planKPI/detail.html',
                //    controller: 'planKPIController',
                //    controllerUrl: 'app/controllers/kpi/planKPIController'
                //}),
                'departmentPlan@planKPI': angularAMD.route({
        ...
        .state('userPlanKPI', {
            ...
            views: {
                ...
                'planManageDetail@userPlanKPI': angularAMD.route({
                    templateUrl: '/app/views/kpi/planKPIDetail/planManageDetail.html',
                    controller: 'planStaffDetailController',
                    controllerUrl: 'app/controllers/kpi/planStaffDetailController'
                }),
                'departmentRating@userPlanKPI': angularAMD.route({
                    templateUrl: '/app/views/kpi/planKPI/departmentRating.html',
                    controller: 'planStaffDetailController',
                    controllerUrl: 'app/controllers/kpi/planStaffDetailController'
                }),
                'departmentPlan@userPlanKPI': angularAMD.route({
                    templateUrl: '/app/views/kpi/planKPI/departmentPlan.html',
                    controller: 'planStaffDetailController',
                    controllerUrl: 'app/controllers/kpi/planStaffDetailController'
                })
        ...
        .state('professorPlankpidetail', angularAMD.route({
            ...
            url: '/kpi/professorPlankpidetail/:planId/:agentObjectId/:normalStaffId/:departmentId/:isSupervisor',
        ...
        .state('schoolManagePlankpidetail', angularAMD.route({
            ...
            url: '/kpi/schoolManagePlankpidetail/:planId/:agentObjectId/:normalStaffId/:departmentId/:isSupervisor',
        ...
        .state('facultyManagePlankpidetail', angularAMD.route({
            ...
            url: '/kpi/facultyManagePlankpidetail/:planId/:agentObjectId/:normalStaffId/:departmentId/:isSupervisor/:isConfig',
        ...
        .state('subFacultyManagePlankpidetail', angularAMD.route({
            ...
            url: '/kpi/subFacultyManagePlankpidetail/:planId/:agentObjectId/:normalStaffId/:departmentId/:isSupervisor/:isConfig',
        ...
        .state('principalPlankpidetail', angularAMD.route({
            ...
            url: '/kpi/principalPlankpidetail/:planId/:agentObjectId/:normalStaffId/:departmentId/:isSupervisor/:isConfig',
        ...
        .state('vicePrincipalPlankpidetail', angularAMD.route({
            ...
            url: '/kpi/vicePrincipalPlankpidetail/:planId/:agentObjectId/:normalStaffId/:departmentId/:isSupervisor/:isConfig',
       ...
       .state('subDepartmentPlankpiDetail', angularAMD.route({
           ...
           url: '/kpi/subDepartmentPlankpiDetail/:planId/:agentObjectId/:normalStaffId/:departmentId/:isSupervisor/:isConfig',
        ...
        .state('subjectManagePlankpidetail', angularAMD.route({
            ...
            url: '/kpi/subjectManagePlankpidetail/:planId/:agentObjectId/:normalStaffId/:departmentId/:isSupervisor',
        ...
        .state('subSubjectManagePlankpidetail', angularAMD.route({
         ...
         .state('departmentManagePlankpidetail', angularAMD.route({
             ...
             url: '/kpi/departmentManagePlankpidetail/:planId/:agentObjectId/:normalStaffId/:departmentId/:isSupervisor/:isConfig',
        ...
        .state('plankpidetail', angularAMD.route({
            ...
            url: '/kpi/plankpidetail/:planId/:agentObjectId/:normalStaffId/:departmentId/:isSupervisor/:isConfig',
        ...
        .state('professorRatingKPI', angularAMD.route({
            ...
            url: '/kpi/professorRatingKPI/:planId/:agentObjectId/:planStaffId/:supervisorId/:departmentId/:isAdminRating/:isRate',
        ...
        .state('ratingKPI', angularAMD.route({
            ...
            url: '/kpi/ratingKPI/:planId/:agentObjectId/:planStaffId/:supervisorId/:departmentId/:isAdminRating/:isRate',
        ...
        .state('departmentRatingKPI', angularAMD.route({
            ...
            url: '/kpi/departmentRatingKPI/:planId/:agentObjectId/:planStaffId/:supervisorId/:departmentId/:isAdminRating/:isRate',
         ...
         .state('subDepartmentRatingKPI', angularAMD.route({
             ...
             url: '/kpi/subDepartmentRatingKPI/:planId/:agentObjectId/:planStaffId/:supervisorId/:departmentId/:isAdminRating/:isRate',
        ...
        .state('subjectRatingKPI', angularAMD.route({
            ...
            url: '/kpi/subjectRatingKPI/:planId/:agentObjectId/:planStaffId/:supervisorId/:departmentId/:isAdminRating/:isRate',
        ...
        .state('subSubjectRatingKPI', angularAMD.route({
            ...
            url: '/kpi/subSubjectRatingKPI/:planId/:agentObjectId/:planStaffId/:supervisorId/:departmentId/:isAdminRating/:isRate',
        ...
        .state('facultyRatingKPI', angularAMD.route({
            ...
            url: '/kpi/facultyRatingKPI/:planId/:agentObjectId/:planStaffId/:supervisorId/:departmentId/:isAdminRating/:isRate',
        ...
        .state('subFacultyRatingKPI', angularAMD.route({
            ...
            url: '/kpi/subFacultyRatingKPI/:planId/:agentObjectId/:planStaffId/:supervisorId/:departmentId/:isAdminRating/:isRate',
        ...
        .state('vicePrincipalRatingKPI', angularAMD.route({
            ...
            url: '/kpi/vicePrincipalRatingKPI/:planId/:agentObjectId/:planStaffId/:supervisorId/:departmentId/:isAdminRating/:isRate',
            ...
            .state('principalRatingKPI', angularAMD.route({
                ...
                url: '/kpi/principalRatingKPI/:planId/:agentObjectId/:planStaffId/:supervisorId/:departmentId/:isAdminRating/:isRate',
                templateUrl: '/app/views/kpi/ratingKPI/principalManage.html',
                controller: 'ratingKPIController',
                controllerUrl: 'app/controllers/kpi/ratingKPIController'
            }))

            .state('danhmuccongviec', {
                url: '/kpi/KPIdanhmuccongviec',
                views: {
                    '': { templateUrl: '/app/views/kpi/staffRole/danhmuccongviec.html' },

                    'danhmucCha@danhmuccongviec': angularAMD.route({
                        templateUrl: '/app/views/kpi/staffRole/danhmucCha.html',
                        controller: 'manageCodeController',
                        controllerUrl: 'app/controllers/kpi/manageCodeController'
                    }),
                    'danhmucCon@danhmuccongviec': angularAMD.route({
                        templateUrl: '/app/views/kpi/staffRole/danhmucCon.html',
                        controller: 'danhmucMTCLController',
                        controllerUrl: 'app/controllers/kpi/danhmucMTCLController'
                    }),
                }
            })
        ...
        .state('dodulieunhanvien', angularAMD.route({
            url: '/kpi/StaffData',
            templateUrl: '/app/views/kpi/dodulieunhanvien/manage.html',
            controller: 'dodulieunhanvienController',
            controllerUrl: 'app/controllers/kpi/dodulieunhanvienController'
        }))
        ...
        .state('viewUserPlan', angularAMD.route({
            url: '/kpi/viewUserPlan',
            templateUrl: '/app/views/kpi/report/totalPlanKPIDetail.html',
            controller: 'totalPlanKPIDetailController',
            controllerUrl: 'app/controllers/kpi/totalPlanKPIDetailController'
        }))

        //************************KPI Report************************//
        .state('reportDepartmentStaffResult', angularAMD.route({
            url: '/kpi/report',
            templateUrl: '/app/views/kpi/report/manage.html',
            controller: 'reportController',
            controllerUrl: 'app/controllers/kpi/reportController'
        }))
    }]);
