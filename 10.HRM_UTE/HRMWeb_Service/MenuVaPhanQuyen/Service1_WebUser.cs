...
namespace HRMWeb_Service
{
    ...
    public partial class Service1 : IService1
    {
            ...
            if (Helper.TrustTest(publicKey, token))
            {
                ...
                foreach (var obj in objList)
                {
                    if (obj != null)
                    {
                        ...
                        objFromDB.ThongTinNhanVien = null;
        ...
        private static void GetSetChild_WithBoPhanList(WebUser webUser)
        {
            ...
            //lay bo phan ma user duoc xu ly cham cong
            {
                if (webUser!=null && webUser.HoSo != null)
                {
                    webUser.MaNhanSu = webUser.HoSo.MaQuanLy;
                    webUser.HoVaTen = webUser.HoSo.HoTen;
                    webUser.Email = webUser.HoSo.Email;
            ...
            if (Helper.TrustTest(publicKey, token))
            {
                if (obj != null)
                {
                    ...
                    if (objFromDB == null)
                    {
                        ...
                        newDBObject.PassWord = obj.Password;
                        objForSave = newDBObject;
                    }
                    else
                    {
                        //cap nhat
                        objFromDB.CopyIncludedPropertiesFrom(obj, "UserName", "Password", "HoatDong", "WebGroupID", "DepartmentId", "AgentObjectTypeId");//.CopyPropertiesFrom(obj);
