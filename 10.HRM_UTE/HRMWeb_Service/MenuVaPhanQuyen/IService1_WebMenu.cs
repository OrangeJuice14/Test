...
namespace HRMWeb_Service
{
    public partial interface IService1
    {
        ...
        //// ////////////////////////////////////////////
        [OperationContract]
        IEnumerable<DTO_WebMenu> WebMenu_GetListBy_WebUserId(String publicKey, String token, Guid webUserId);

        [OperationContract]
        String WebMenu_GetListBy_WebUserId_Json(String publicKey, String token, Guid webUserId);
        ...
        /// ////////////////////////////////////////////////////
        [OperationContract]
        IEnumerable<DTO_WebMenu> WebMenu_GetListTop2LevelDeepBy_WebUserId(String publicKey, String token, Guid webUserId);

        [OperationContract]
        String WebMenu_GetListTop2LevelDeepBy_WebUserId_Json(String publicKey, String token, Guid webUserId);
        /// ////////////////////////////////////////////////////
        [OperationContract]
        IEnumerable<DTO_WebMenu> WebMenu_GetChildMenuListBy_WebUserId_AndMenuId(String publicKey, String token,
            Guid webUserId, Guid menuId);
