...
namespace HRMWeb_Service
{
    ...
    public partial class Service1 : IService1
    {
        ...
        public bool NgayNghiTrongNam_Save(String publicKey, String token, String TenNgayNghi, DateTime NgayNghi, bool NghiBu, int Nam)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                ...
                //Nếu check là nghỉ bù thì lưu vào ngày nghỉ bù
                if (NghiBu)
                    obj.NgayNghiBu = NgayNghi;
                //Ngược lại lưu vào ngày nghỉ bình thường
                else
