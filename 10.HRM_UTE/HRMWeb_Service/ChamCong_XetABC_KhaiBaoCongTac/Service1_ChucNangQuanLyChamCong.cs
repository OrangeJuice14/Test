...
namespace HRMWeb_Service
{
    ...
    public partial class Service1 : IService1
    {
        ...
        */
        ...
        /// <returns></returns>
        public IEnumerable<DTO_QuanLyChamCong_Find> QuanLyChamCong_Find(String publicKey, String token, int ngay, int thang, int nam, Guid? boPhanId, int trangThaiChamCong, Boolean? diHoc, String maNhanSu, Guid webUserId, Guid? idLoaiNhanSu, int loaicanbo)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                CC_ChamCongTheoNgay_Factory factory = CC_ChamCongTheoNgay_Factory.New();
                ...
                {
                    DateTime date = new DateTime(nam, thang, ngay);
                    list = factory.FindForQuanlyChamCong_New(date, boPhanId,trangThaiChamCong, diHoc, maNhanSu, webUserId, idLoaiNhanSu,loaicanbo);
                }
                else
                {
                    list = factory.FindForQuanlyChamChong_ThangVaNam_New(thang, nam, boPhanId, trangThaiChamCong, diHoc, maNhanSu, webUserId, idLoaiNhanSu, loaicanbo);
                }
                return list;
            }
            else
        ...
        /// <param name="maNhanSu"></param>
        /// <returns></returns>
        public String QuanLyChamCong_Find_Json(String publicKey, String token, int ngay, int thang, int nam, Guid? boPhanId, int trangThaiChamCong, Boolean? diHoc, String maNhanSu, Guid webUserId, Guid? idLoaiNhanSu, int loaicanbo)
        {//DANG SD
            IEnumerable<DTO_QuanLyChamCong_Find> list = QuanLyChamCong_Find(publicKey, token, ngay, thang, nam, boPhanId, trangThaiChamCong, diHoc, maNhanSu, webUserId, idLoaiNhanSu, loaicanbo);
            String json = JsonConvert.SerializeObject(list);
            return json;
        }
        public bool QuanLyChamCong_CheckChot(String publicKey, String token, Guid boPhanID, int thang, int nam,int loaicanbo)
        {//DANG SD
            if (Helper.TrustTest(publicKey, token))
            {
                //kiem tra da tao chua
                var factory = CC_ChiTietChamCongNhanVien_Factory.New();
                bool daTonTai = factory.CheckChot(thang, nam, boPhanID, loaicanbo);
                return daTonTai;
            }
            else
            {
        ...
        public bool QuanLyChamCong_CheckKhoa(String publicKey, String token, Guid boPhanID, int thang, int nam,int loaicanbo)
        {//DANG SD
            if (Helper.TrustTest(publicKey, token))
            {
                //kiem tra da tao chua
                var factory = CC_ChamCongTheoNgay_Factory.New();
                bool daTonTai = factory.QuanLyChamCong_CheckKhoa(boPhanID,thang, nam, loaicanbo);
                return daTonTai;
            }
            else
            {
        ...
        */
        ...
        public IEnumerable<DTO_QuanLyChamCong_BieuDoVaoRa> QuanLyChamCong_BieuDoVaoRa(String publicKey, String token,
           int ngay, int thang, int nam, Guid boPhanId,int loaicanbo)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                ...
                list = factory.QuanLyChamCong_BieuDoVaoRa(ngay, thang, nam, boPhanId, loaicanbo);
        ...
        public String QuanLyChamCong_BieuDoVaoRa_Json(String publicKey, String token,
           int ngay, int thang, int nam, Guid boPhanId,int loaicanbo)
        {//DANG SD
            IEnumerable<DTO_QuanLyChamCong_BieuDoVaoRa> list = QuanLyChamCong_BieuDoVaoRa(publicKey, token, ngay, thang, nam, boPhanId, loaicanbo);
            String json = JsonConvert.SerializeObject(list);
            return json;
   ...
   int ngay, int thang, int nam, Guid nhanVienID,int loaicanbo)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                ...
                list = factory.QuanLyChamCong_BieuDoVaoRa_Cua1NhanVien(ngay, thang, nam, nhanVienID, loaicanbo);
        ...
        public String QuanLyChamCong_BieuDoVaoRa_Cua1NhanVien_Json(String publicKey, String token,
           int ngay, int thang, int nam, Guid nhanVienID,int loaicanbo)
        {//DANG SD
            IEnumerable<DTO_QuanLyChamCong_BieuDoVaoRa> list = QuanLyChamCong_BieuDoVaoRa_Cua1NhanVien(publicKey, token, ngay, thang, nam, nhanVienID, loaicanbo);
            String json = JsonConvert.SerializeObject(list);
            return json;
        ...
        public IEnumerable<DTO_QuanLyChamCong_ThongTinChamCongThang> QuanLyChamCong_ThongTinChamCongThang(String publicKey, String token, int thang, int nam, Guid boPhanId, String maNhanSu, Guid idLoaiNhanSu,int loaicanbo)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                CC_ChamCongTheoNgay_Factory factory = CC_ChamCongTheoNgay_Factory.New();
                ...
                //
                list = factory.QuanLyChamCong_ThongTinChamCongThang(thang, nam, boPhanId, maNhanSu, idLoaiNhanSu, loaicanbo);
                //
                return list;
            }
            else
        ...
        public String QuanLyChamCong_ThongTinChamCongThang_Json(String publicKey, String token, int thang, int nam, Guid boPhanId, String maNhanSu, Guid idLoaiNhanSu,int loaicanbo)
        {
            IEnumerable<DTO_QuanLyChamCong_ThongTinChamCongThang> list = QuanLyChamCong_ThongTinChamCongThang(publicKey, token, thang, nam, boPhanId, maNhanSu, idLoaiNhanSu, loaicanbo);
            String json = JsonConvert.SerializeObject(list);
            return json;
        }
        ...
        public IEnumerable<DTO_QuanLyChamCong_ThongTinChamCongThang> QuanLyChamCong_ThongTinChamCongThang_Cua1NhanVien(String publicKey, String token, int thang, int nam, Guid nhanVienID, int loaicanbo)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                ...
                list = factory.QuanLyChamCong_ThongTinChamCongThang_Cua1NhanVien(thang, nam, nhanVienID, loaicanbo);
                //
                return list;
            }
            else
        ...
        public String QuanLyChamCong_ThongTinChamCongThang_Cua1NhanVien_Json(String publicKey, String token, int thang, int nam, Guid nhanVienID,int loaicanbo)
        {
            //
            IEnumerable<DTO_QuanLyChamCong_ThongTinChamCongThang> list = QuanLyChamCong_ThongTinChamCongThang_Cua1NhanVien(publicKey, token, thang, nam, nhanVienID, loaicanbo);
            //
            String json = JsonConvert.SerializeObject(list);
            return json;
