...
namespace HRMWeb_Service
{
    ...
    public partial class Service1 : IService1
    {
        ...
        public bool CauHinhChamCong_Save(String publicKey, String token,Guid oid, string songaynghiphep,string dongiangoaigio)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                    ...
                    TimeSpan.FromSeconds(360)))
                {
                    ...
                    try
                    {
                        ...
                        cauHinh.DonGiaNgoaiGio = Convert.ToDecimal(dongiangoaigio);
                        //
