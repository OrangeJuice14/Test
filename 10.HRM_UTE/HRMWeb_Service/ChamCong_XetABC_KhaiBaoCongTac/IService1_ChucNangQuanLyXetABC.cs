...
namespace HRMWeb_Service
{
   ...
   //Guid? idLoaiNhanSu, bool? diHoc, string ngayNghiFormat);
        ...
        [OperationContract]
        bool QuanLyXetABC_KhoaVaMoKhoaList(String publicKey, String token, int thang, int nam, Guid idBoPhan,
            bool khoa);
        [OperationContract]
        bool QuanLyXetABC_KhoaVaMoKhoaList_Json(String publicKey, String token, int thang, int nam, Guid idBoPhan, bool khoa);
