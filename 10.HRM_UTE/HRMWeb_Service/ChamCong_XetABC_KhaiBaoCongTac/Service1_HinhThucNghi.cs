...
namespace HRMWeb_Service
{
    ...
    {
        public IEnumerable<DTO_HinhThucNghi> GetList_HinhThucNghiByLoaiNghi(String publicKey, String token, int loaihinhthucnghi)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                HinhThucNghi_Factory factory = HinhThucNghi_Factory.New();
                IEnumerable<DTO_HinhThucNghi> list = factory.GetHinhThucNghiByLoaiNghi(loaihinhthucnghi).Map<DTO_HinhThucNghi>();
                return list;
            }
            else
            {
        ...
        public IEnumerable<DTO_HinhThucNghi> GetList_HinhThucNghiForUpdate(String publicKey, String token, int loai)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                HinhThucNghi_Factory factory = HinhThucNghi_Factory.New();
                IEnumerable<DTO_HinhThucNghi> list = factory.GetListForUpdate(loai).Map<DTO_HinhThucNghi>();
                return list;
            }
            else
            {
        ...
        public String GetList_HinhThucNghiByLoaiNghi_Json(String publicKey, String token, int loaidonxinnghi)
        {//DANG SD
            IEnumerable<DTO_HinhThucNghi> list = GetList_HinhThucNghiByLoaiNghi(publicKey, token, loaidonxinnghi);
        ...
        public String GetList_HinhThucNghiForUpdate_Json(String publicKey, String token,int loai)
        {//DANG SD
            IEnumerable<DTO_HinhThucNghi> list = GetList_HinhThucNghiForUpdate(publicKey, token,loai);
            String json = JsonConvert.SerializeObject(list);
            return json;
        }
