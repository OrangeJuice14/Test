                ...
                try
                {
                    obj.ChiTietThuNhapCaNhan =
                        factory.Context.spd_Report_Luong_ChiTietTongThuNhapTungNhanVien(kyTinhLuong, idNhanVien)
                            ...
                            .SingleOrDefault();
                    if (obj.ChiTietThuNhapCaNhan != null)
                    {
                        obj.ChiTietThuNhapCaNhan.TongHeSoLuongNhaNuoc = obj.ChiTietThuNhapCaNhan.HeSoLuong + obj.ChiTietThuNhapCaNhan.HSPCChucVu + obj.ChiTietThuNhapCaNhan.HSPCUuDai + obj.ChiTietThuNhapCaNhan.HSPCDocHai + obj.ChiTietThuNhapCaNhan.HSPCVuotKhung + obj.ChiTietThuNhapCaNhan.HSPCKhac + obj.ChiTietThuNhapCaNhan.HSPCThamNien;
                    }
                }
                catch (Exception ex)
                {
