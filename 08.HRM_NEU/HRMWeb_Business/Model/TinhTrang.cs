...
namespace HRMWeb_Business.Model
{
    ...
    public partial class TinhTrang : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        public string MaQuanLy_UIS
        {
            ...
            set
            {
    			string oldValue =  _maQuanLy_UIS;
    			bool stopChanging = false;
                On_MaQuanLy_UIS_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("MaQuanLy_UIS");
    			if(!stopChanging)
    			{
    				_maQuanLy_UIS = StructuralObject.SetValidValue(value, true);
    				ReportPropertyChanged("MaQuanLy_UIS");
    				On_MaQuanLy_UIS_Changed(oldValue, _maQuanLy_UIS);//\\
    			}
            }
        }
    	public static String MaQuanLy_UIS_PropertyName { get { return "MaQuanLy_UIS"; } }
        private string _maQuanLy_UIS;
        partial void On_MaQuanLy_UIS_Changing(string currentValue, ref string newValue, ref bool stopChanging);
        partial void On_MaQuanLy_UIS_Changed(string oldValue, string currentValue);
