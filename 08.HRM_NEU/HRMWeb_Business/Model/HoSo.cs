...
namespace HRMWeb_Business.Model
{
    ...
    public partial class HoSo : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        public string OidBK
        {
            ...
            set
            {
    			string oldValue =  _oidBK;
    			bool stopChanging = false;
                On_OidBK_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("OidBK");
    			if(!stopChanging)
    			{
    				_oidBK = StructuralObject.SetValidValue(value, true);
    				ReportPropertyChanged("OidBK");
    				On_OidBK_Changed(oldValue, _oidBK);//\\
    			}
            }
        }
    	public static String OidBK_PropertyName { get { return "OidBK"; } }
        private string _oidBK;
        partial void On_OidBK_Changing(string currentValue, ref string newValue, ref bool stopChanging);
        partial void On_OidBK_Changed(string oldValue, string currentValue);
