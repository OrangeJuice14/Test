...
namespace HRMWeb_Business.Model
{
    ...
    public partial class ChucDanh : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [EdmScalarPropertyAttribute(EntityKeyProperty=false, IsNullable=true)]
        [DataMemberAttribute()]
        public string TenChucDanh_Eng
        {
            get
            {
                return _tenChucDanh_Eng;
            }
            set
            {
    			string oldValue =  _tenChucDanh_Eng;
    			bool stopChanging = false;
                On_TenChucDanh_Eng_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("TenChucDanh_Eng");
    			if(!stopChanging)
    			{
    				_tenChucDanh_Eng = StructuralObject.SetValidValue(value, true);
    				ReportPropertyChanged("TenChucDanh_Eng");
    				On_TenChucDanh_Eng_Changed(oldValue, _tenChucDanh_Eng);//\\
    			}
            }
        }
    	public static String TenChucDanh_Eng_PropertyName { get { return "TenChucDanh_Eng"; } }
        private string _tenChucDanh_Eng;
        partial void On_TenChucDanh_Eng_Changing(string currentValue, ref string newValue, ref bool stopChanging);
        partial void On_TenChucDanh_Eng_Changed(string oldValue, string currentValue);
