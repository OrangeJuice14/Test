...
namespace HRMWeb_Business.Model.MapObjectCreator
{
    ...
    public partial class Mdl_ChucVu
    {
    	...
    	[DataMember]
        public Nullable<decimal> PhuCapDienThoaiNR { get; set; }
    	[DataMember]
        public Nullable<decimal> PhuCapDieuHanhCV { get; set; }
    	[DataMember]
        public Nullable<decimal> HSPCTrachNhiem { get; set; }
    	[DataMember]
        public Nullable<decimal> HSPCTrachNhiem_QNU { get; set; }
    	[DataMember]
        public string TenChucVu_Eng { get; set; }
    	[DataMember]
        public Nullable<bool> ChucVuDoan { get; set; }
    	[DataMember]
        public Nullable<bool> ChucVuDang { get; set; }
    	[DataMember]
        public Nullable<bool> ChucVuDoanThe { get; set; }
    	[DataMember]
