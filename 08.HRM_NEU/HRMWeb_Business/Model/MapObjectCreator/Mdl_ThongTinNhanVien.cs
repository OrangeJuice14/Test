...
namespace HRMWeb_Business.Model.MapObjectCreator
{
    ...
    public partial class Mdl_ThongTinNhanVien
    {
    	...
    	[DataMember]
        public Nullable<bool> KhoaHoSo_NCKH { get; set; }
    	[DataMember]
        public Nullable<System.Guid> LinhVucNghienCuu { get; set; }
    	[DataMember]
        public Nullable<System.Guid> LinhVucNghienCuu_Eng { get; set; }
    	[DataMember]
        public string LinhVucNghienCuuChuyenSau { get; set; }
    	...
    	//[DataMember]
        //public virtual Mdl_SucKhoe SucKhoe { get; set; }
    	//[DataMember]
        //public virtual Mdl_NhomMau NhomMau1 { get; set; }
    }
}
