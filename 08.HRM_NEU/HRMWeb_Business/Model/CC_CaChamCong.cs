...
namespace HRMWeb_Business.Model
{
    ...
    public partial class CC_CaChamCong : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        public Nullable<bool> LamThu7
        {
            ...
            set
            {
    			Nullable<bool> oldValue =  _lamThu7;
    			bool stopChanging = false;
                On_LamThu7_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("LamThu7");
    			if(!stopChanging)
    			{
    				_lamThu7 = StructuralObject.SetValidValue(value);
    				ReportPropertyChanged("LamThu7");
    				On_LamThu7_Changed(oldValue, _lamThu7);//\\
    			}
            }
        }
    	public static String LamThu7_PropertyName { get { return "LamThu7"; } }
        private Nullable<bool> _lamThu7;
        partial void On_LamThu7_Changing(Nullable<bool> currentValue, ref Nullable<bool> newValue, ref bool stopChanging);
        partial void On_LamThu7_Changed(Nullable<bool> oldValue, Nullable<bool> currentValue);
