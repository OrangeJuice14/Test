...
namespace HRMWeb_Business.Model
{
    ...
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="ERPModel", Name="ThanhPhanXuatThan")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class ThanhPhanXuatThan : ERP_Core.BaseEntityObject//EntityObject
    {
    	static ThanhPhanXuatThan()
    	{
        ...
        public static ThanhPhanXuatThan CreateThanhPhanXuatThan(System.Guid oid)
        {
            ThanhPhanXuatThan thanhPhanXuatThan = new ThanhPhanXuatThan();
            thanhPhanXuatThan.Oid = oid;
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_NhanVien_ThanhPhanXuatThan", "NhanVien")]
        public EntityCollection<NhanVien> NhanViens
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<NhanVien>("ERPModel.FK_NhanVien_ThanhPhanXuatThan", "NhanVien");
            }
            set
            {
                if ((value != null))
                {
    				...
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<NhanVien>("ERPModel.FK_NhanVien_ThanhPhanXuatThan", "NhanVien", value);
