...
namespace HRMWeb_Business.Model
{
    ...
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="ERPModel", Name="UuTienGiaDinh")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class UuTienGiaDinh : ERP_Core.BaseEntityObject//EntityObject
    {
    	static UuTienGiaDinh()
    	{
        ...
        /// <summary>
        /// Create a new UuTienGiaDinh object.
        /// </summary>
        /// <param name="oid">Initial value of the Oid property.</param>
        public static UuTienGiaDinh CreateUuTienGiaDinh(System.Guid oid)
        {
            UuTienGiaDinh uuTienGiaDinh = new UuTienGiaDinh();
            uuTienGiaDinh.Oid = oid;
            return uuTienGiaDinh;
        }
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_NhanVien_UuTienGiaDinh", "NhanVien")]
        public EntityCollection<NhanVien> NhanViens
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<NhanVien>("ERPModel.FK_NhanVien_UuTienGiaDinh", "NhanVien");
            }
            set
            {
                if ((value != null))
                {
    				...
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<NhanVien>("ERPModel.FK_NhanVien_UuTienGiaDinh", "NhanVien", value);
