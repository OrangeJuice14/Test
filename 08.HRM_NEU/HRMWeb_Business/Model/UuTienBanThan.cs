...
namespace HRMWeb_Business.Model
{
    ...
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="ERPModel", Name="UuTienBanThan")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class UuTienBanThan : ERP_Core.BaseEntityObject//EntityObject
    {
    	static UuTienBanThan()
    	{
        ...
        /// <summary>
        /// Create a new UuTienBanThan object.
        /// </summary>
        /// <param name="oid">Initial value of the Oid property.</param>
        public static UuTienBanThan CreateUuTienBanThan(System.Guid oid)
        {
            UuTienBanThan uuTienBanThan = new UuTienBanThan();
            uuTienBanThan.Oid = oid;
            return uuTienBanThan;
        }
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_NhanVien_UuTienBanThan", "NhanVien")]
        public EntityCollection<NhanVien> NhanViens
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<NhanVien>("ERPModel.FK_NhanVien_UuTienBanThan", "NhanVien");
            }
            set
            {
                if ((value != null))
                {
    				...
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<NhanVien>("ERPModel.FK_NhanVien_UuTienBanThan", "NhanVien", value);
