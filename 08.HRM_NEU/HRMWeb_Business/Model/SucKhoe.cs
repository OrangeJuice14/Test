...
namespace HRMWeb_Business.Model
{
    ...
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="ERPModel", Name="SucKhoe")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class SucKhoe : ERP_Core.BaseEntityObject//EntityObject
    {
    	static SucKhoe()
    	{
        ...
        /// <summary>
        /// Create a new SucKhoe object.
        /// </summary>
        /// <param name="oid">Initial value of the Oid property.</param>
        public static SucKhoe CreateSucKhoe(System.Guid oid)
        {
        ...
        public string TenSucKhoe
        {
            ...
            set
            {
    			string oldValue =  _tenSucKhoe;
    			bool stopChanging = false;
                On_TenSucKhoe_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("TenSucKhoe");
    			if(!stopChanging)
    			{
    				_tenSucKhoe = StructuralObject.SetValidValue(value, true);
    				ReportPropertyChanged("TenSucKhoe");
    				On_TenSucKhoe_Changed(oldValue, _tenSucKhoe);//\\
    			}
            }
        }
    	public static String TenSucKhoe_PropertyName { get { return "TenSucKhoe"; } }
        private string _tenSucKhoe;
        partial void On_TenSucKhoe_Changing(string currentValue, ref string newValue, ref bool stopChanging);
        partial void On_TenSucKhoe_Changed(string oldValue, string currentValue);
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_ThongTinNhanVien_TinhTrangSucKhoe", "ThongTinNhanVien")]
        public EntityCollection<ThongTinNhanVien> ThongTinNhanViens
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<ThongTinNhanVien>("ERPModel.FK_ThongTinNhanVien_TinhTrangSucKhoe", "ThongTinNhanVien");
            }
            set
            {
                if ((value != null))
                {
    				...
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<ThongTinNhanVien>("ERPModel.FK_ThongTinNhanVien_TinhTrangSucKhoe", "ThongTinNhanVien", value);
