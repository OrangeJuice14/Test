...
namespace HRMWeb_Business.BusinessServiceFactory
{
    public class CC_ChamCongTheoNgay_Factory : BaseFactory<Entities, CC_ChamCongTheoNgay>
    {
        ...
        public IQueryable<DTO_QuanLyChamCong_BieuDoVaoRa> QuanLyChamCong_ThongKeGioLam(int ngay, int thang, int nam, Guid boPhanId)
        {
            var result = (from o in this.Context.CC_ChamCongTheoNgay
                          where (o.Ngay.Year == nam && o.Ngay.Month == thang && o.Ngay.Day == ngay)
                                && (boPhanId == Guid.Empty || o.IDBoPhan == boPhanId)
                                && o.HoSo.GCRecord == null && o.HoSo.NhanVien.TinhTrang1.KhongConCongTacTaiTruong == false
                          orderby o.BoPhan.TenBoPhan, o.HoSo.Ten
                          select new DTO_QuanLyChamCong_BieuDoVaoRa() {
                              ThoiGianBatDauNghiGiuaCa = o.CC_CaChamCong1.ThoiGianBatDauNghiGiuaCa,
                              ThoiGianKetThucNghiGiuaCa = o.CC_CaChamCong1.ThoiGianKetThucNghiGiuaCa,
                              TenDonVi = o.HoSo.NhanVien.BoPhan1.TenBoPhan, 
                              SoHieuCongChuc = o.HoSo.NhanVien.ThongTinNhanVien.SoHieuCongChuc, 
                              HoTen = o.HoSo.HoTen, IDNhanVien = o.IDNhanVien, 
                              Ngay = o.Ngay, 
                              GioVao = o.GioVaoSang, 
                              GioRa = o.GioRaChieu });
            return result;
        ...
        public IQueryable<DTO_QuanLyChamCong_ThongTinChamCongThang> QuanLyChamCong_ThongTinChamCongThang(int thang, int nam, Guid boPhanId, string maNhanSu, Guid? idLoaiNhanSu)
        {
            ...
            var result = (from idNv in dsIdNhanVien
                          ...
                          select new DTO_QuanLyChamCong_ThongTinChamCongThang
                          {
                              ...
                              ,
                              LaNhanVienGiangDay = (hs.NhanVien.ThongTinNhanVien.LoaiNhanSu1 != null ? (hs.NhanVien.ThongTinNhanVien.LoaiNhanSu1.TenLoaiNhanSu.ToLower().Contains("giảng")) : false)
                              ,
