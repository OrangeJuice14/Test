...
namespace HRMWeb_Service
{
   ...
   int ngay, int thang, int nam, Guid nhanVienID)
        ...
        public IEnumerable<DTO_QuanLyChamCong_BieuDoVaoRa> QuanLyChamCong_ThongKeGioLam(String publicKey, String token, int ngay, int thang, int nam, Guid boPhanId)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                ...
                list = factory.QuanLyChamCong_ThongKeGioLam(ngay, thang, nam, boPhanId);
                ...
                if (thongTinChamCongThang.ChiTietChamCong != null)
                {
                    ...
                    foreach (var obj in thongTinChamCongThang.ChiTietChamCong)
                    {
                            ...
                            )
                        {
                            if (idHinhThucNghiMoi != Guid.Empty)
                            {
                                objFromDbForSave.IDHinhThucNghiOld = objFromDbForSave.IDHinhThucNghi;
                                objFromDbForSave.IDHinhThucNghi = idHinhThucNghiMoi;
                                objFromDbForSave.NguoiDungChinhSua = true;
                                objFromDbForSave.IDWebUsers_ChinhSua = new Guid(idWebUsers);
                            }
                            else
                            {
                                objFromDbForSave.IDHinhThucNghiOld = objFromDbForSave.IDHinhThucNghi;
        ...
        public bool QuanLyChamCong_ThongTinChamCongThang_SaveList_Json(String publicKey, String token, string jsonObjectList, string idWebUsers)
        {//DANG SD
            //chuyen jsonObject thanh object
            ...
            return QuanLyChamCong_ThongTinChamCongThang_SaveList(publicKey, token, objList, idWebUsers);
        }
