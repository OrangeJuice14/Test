...
namespace HRMWeb_Service
{
    ...
    public partial class Service1 : IService1
    {
        ...
        private static void FormatNgayNghi(ChiTietChamCongNhanVien chiTietChamCongNhanVien)
        {
            chiTietChamCongNhanVien.NgayNghiFormat = "<div  class='jqx-grid-cell-wrap'>";
            chiTietChamCongNhanVien.NgayNghiFormat += (chiTietChamCongNhanVien.NghiRo != null && chiTietChamCongNhanVien.NghiRo > 0) ? "- Nghỉ trừ lương : " + chiTietChamCongNhanVien.NghiRo.ToString() + "<br>" : "";
            chiTietChamCongNhanVien.NgayNghiFormat += (chiTietChamCongNhanVien.NghiThaiSan != null && chiTietChamCongNhanVien.NghiThaiSan > 0) ? "- Nghỉ BHXH : " + chiTietChamCongNhanVien.NghiThaiSan.ToString() + "<br>" : "";
            chiTietChamCongNhanVien.NgayNghiFormat += (chiTietChamCongNhanVien.NghiCoPhep != null && chiTietChamCongNhanVien.NghiCoPhep > 0) ? "- Nghỉ hưởng lương : " + chiTietChamCongNhanVien.NghiCoPhep.ToString() + "<br>" : "";
            chiTietChamCongNhanVien.NgayNghiFormat += (chiTietChamCongNhanVien.NghiDiHocCoLuong != null && chiTietChamCongNhanVien.NghiDiHocCoLuong > 0) ? "- Nghỉ đi học có lương : " + chiTietChamCongNhanVien.NghiDiHocCoLuong.ToString() + "<br>" : "";
            chiTietChamCongNhanVien.NgayNghiFormat += (chiTietChamCongNhanVien.NghiDiHocKhongLuong != null && chiTietChamCongNhanVien.NghiDiHocKhongLuong > 0) ? "- Nghỉ đi học không lương : " + chiTietChamCongNhanVien.NghiDiHocKhongLuong.ToString() + "<br>" : "";
            chiTietChamCongNhanVien.NgayNghiFormat += (chiTietChamCongNhanVien.NghiOm != null && chiTietChamCongNhanVien.NghiOm > 0) ? "- Nghỉ ốm : " + chiTietChamCongNhanVien.NghiOm.ToString() : "";
            chiTietChamCongNhanVien.NgayNghiFormat += "</div>";
        }
            ...
            if (Helper.TrustTest(publicKey, token))
            {
                ...
                if (tmpList != null)
                {
                    ...
                    foreach (var cc in tmpList)
                    {
                        ...
                        item.DanhGiaTruocDieuChinh = cc.DanhGiaTruocDieuChinh;
