...
namespace HRMWeb_Service
{
    ...
    Guid idNhanVien, Guid kyTinhLuong)
        ...
        public spd_Web1_BangLuong_LuongNganSach_Result BangLuong_LuongNganSach(String publicKey, String token, Guid idNhanVien, int nam, int thang)
        {

            if (Helper.TrustTest(publicKey, token))
            {
                var factory = WebUser_Factory.New();
                spd_Web1_BangLuong_LuongNganSach_Result obj = new spd_Web1_BangLuong_LuongNganSach_Result();
                try
                {
        ...
        {//DANG SD
            spd_Web1_BangLuong_LuongNganSach_Result obj = BangLuong_LuongNganSach(publicKey, token, idNhanVien, nam, thang);
            String json = JsonConvert.SerializeObject(obj);
            return json;
        }
