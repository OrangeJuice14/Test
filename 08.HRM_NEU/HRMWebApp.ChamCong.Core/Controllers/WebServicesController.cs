...
namespace HRMWebApp.ChamCong.Core.Controllers
{
    public class WebServicesController : Controller
    {
        ...
        public ActionResult ThongKeGioLam_Find(int ngay, int thang, int nam, string boPhanId)
        {
            Guid boPhanGuid = Guid.Empty;
            if (boPhanId != "" && boPhanId != null)
            {
            ...
            return _service.QuanLyChamCong_ThongKeGioLam(PublicKey, _token, ngay, thang, nam, boPhanGuid).ToJSON();
        }
        ...
        public ActionResult GetDanhMucUpDateHoSoNhanVienAll()
        {
            ...
            //Sức khỏe
            result["SucKhoe"] = _service.SucKhoe_GetListSucKhoeALL(PublicKey, _token);

            //Thành phần xuất thân
            result["ThanhPhanXuatThan"] = _service.ThanhPhanXuatThan_GetListThanhPhanXuatThanALL(PublicKey, _token);

            //Ưu tiên bản thân
            result["UuTienBanThan"] = _service.UuTienBanThan_GetListUuTienBanThanALL(PublicKey, _token);

            //Ưu tiên gia đình
            result["UuTienGiaDinh"] = _service.UuTienGiaDinh_GetListUuTienGiaDinhALL(PublicKey, _token);

            //Tình trạng hôn nhân
            result["TinhTrangHonNhan"] = _service.HoSoNhanVien_GetListTinhTrangHonNhanALL(PublicKey, _token);

            //Dân tộc
            result["DanToc"] = _service.DanToc_GetListDanTocALL(PublicKey, _token);
            ...
            //Nhóm máu
            result["NhomMau"] = _service.NhomMauALL(PublicKey, _token);

            return Json(result);
        }
        public ActionResult GetTinhThanhAll()
        {
            Dictionary<string, string> result = new Dictionary<string, string>();
        ...
        public ActionResult GetQuanHuyenByTinhThanhId(Guid tinhThanh)
        {
            Dictionary<string, string> result = new Dictionary<string, string>();

            //Quận huyện
            result["QuanHuyen"] = _service.QuanHuyen_GetListQuanHuyenByTinhThanhId(PublicKey, _token, tinhThanh);

            return Json(result);
        }
        public ActionResult GetXaPhuongByQuanHuyenId(Guid quanHuyen)
        {
            Dictionary<string, string> result = new Dictionary<string, string>();

            //Xa phường
            result["XaPhuong"] = _service.XaPhuong_GetListXaPhuongByQuanHuyen(PublicKey, _token, quanHuyen);
        ...
        public ActionResult HoSoNhanVien_CapNhat(Guid? oid, Guid? tonGiao, int? chieuCao, int? canNang, Guid? tinhTrangHonNhan, string cMND, DateTime? ngayCap, Guid? noiCap, string dienThoaiDiDong,
            string tengoikhac, bool gioitinh, DateTime? ngaysinh, Guid? noisinhquocgia,Guid? noisinhtinhthanh,Guid? noisinhquanhuyen, Guid? noisinhxaphuong,
            string noisinhsonha, Guid? quequanquocgia, Guid? quequantinhthanh,Guid? quequanquanhuyen, Guid? quequanxaphuong, string quequansonha, Guid? dantoc,
            Guid? tinhtrangsuckhoe, Guid? nhommau, string donvituyendung, DateTime? ngaytuyendung, string congviectuyendung, Guid? diachithuongtruquocgia,
            Guid? diachithuongtrutinhthanh, Guid? diachithuongtruquanhuyen, Guid? diachithuongtruxaphuong,string diachithuongtrusonha, Guid? noiOHienNayQuocGia, Guid? noiOHienNayTinhThanh,
            ...
            Guid? uuTienBanThan)
        {
            return _service.HoSoNhanVien_CapNhat(PublicKey, _token, tengoikhac, gioitinh, ngaysinh, noisinhquocgia, noisinhtinhthanh, noisinhquanhuyen,
                noisinhxaphuong, noisinhsonha, quequanquocgia, quequantinhthanh, quequanquanhuyen, quequanxaphuong, quequansonha, dantoc, tinhtrangsuckhoe,
                nhommau, donvituyendung, ngaytuyendung, congviectuyendung, diachithuongtruquocgia, diachithuongtrutinhthanh, diachithuongtruquanhuyen, diachithuongtruxaphuong, diachithuongtrusonha,
                noiOHienNayQuocGia, noiOHienNayTinhThanh, noiOHienNayQuanHuyen, noiOHienNayXaPhuong, noiOHienNaySoNha,quocTich, thanhPhanXuatThan, uuTienGiaDinh,
                uuTienBanThan,oid, tonGiao, chieuCao, canNang, tinhTrangHonNhan, cMND, ngayCap, noiCap, dienThoaiDiDong).ToJSON();
        }
        ...
        {
            return _service.QuanHeGiaDinh_ThemMoi(PublicKey, _token, oid, thongTinNhanVien, hoTenNguoiThan, ngaySinhFull, namSinh, noiSinh, quocTich, cMND, soHoChieu, quanHe, loaiGiamTruGiaCanh, phuThuoc, lienHeKhanCap, dienThoaiDiDong, gioiTinh, queQuan, ngheNghiepHienTai, noiLamViec, tinhTrang, noiCuTru, nuocCuTru).ToJSON();
        }
        public ActionResult QuanHeGiaDinh_CapNhat(Guid oid, Guid thongTinNhanVien, string hoTenNguoiThan, DateTime? ngaySinhFull, int? namSinh, string noiSinh, Guid? quocTich, string cMND, string soHoChieu, Guid? quanHe, Guid? loaiGiamTruGiaCanh, bool? phuThuoc, bool? lienHeKhanCap, string dienThoaiDiDong, byte? gioiTinh, Guid? queQuan, string ngheNghiepHienTai, string noiLamViec, byte? tinhTrang, string noiCuTru, Guid? nuocCuTru)
        {
            return _service.QuanHeGiaDinh_CapNhat(PublicKey, _token, oid, thongTinNhanVien, hoTenNguoiThan, ngaySinhFull, namSinh, noiSinh, quocTich, cMND, soHoChieu, quanHe, loaiGiamTruGiaCanh, phuThuoc, lienHeKhanCap, dienThoaiDiDong, gioiTinh, queQuan, ngheNghiepHienTai, noiLamViec, tinhTrang, noiCuTru, nuocCuTru).ToJSON();
        }
        public ActionResult QuanHeGiaDinh_Xoa(Guid oid)
        {
            return _service.QuanHeGiaDinh_Xoa(PublicKey, _token, oid).ToJSON();
        }
