...
define(['app/app',
    ...
    function (app) {
        ...
        app.controller('StaffQuanLyDonViController', ['$scope', '$rootScope', '$modal', 'QuanLyDonViService',
                ...
                $scope.GridUserData = new kendo.data.DataSource({
                    ...
                    transport: {
                        read: function (options) {
                            return QuanLyDonViService.GetListUserQuanLyDonVi().then(function (result) {
        ...
        app.controller('QuanLyDonViDetailsController', ['$scope', '$rootScope', '$modal', '$modalInstance', 'QuanLyDonViService', 'UserId', 'Name', 'UserGroupDanhGiaRoleService','ABC_UserDanhGiaService',
            function ($scope, $rootScope, $modal, $modalInstance, QuanLyDonViService, UserId, Name, UserGroupDanhGiaRoleService, ABC_UserDanhGiaService) {
                $scope.Name = angular.copy(Name);
                $scope.UserId = angular.copy(UserId);
                $scope.LoaddingTree = true;
                ABC_UserDanhGiaService.GetUserNow(UserId).then(res => {
                ...
                QuanLyDonViService.GetListBoPhan().then(res => {
                    if (res != null && res.data != null) {
                        QuanLyDonViService.GetListQuanLyDonViByUserId($scope.UserId).then(resDVQL => {
                ...
                //QuanLyDonViService.GetListTreeBoPhan(UserId).then(res => {
                //    if (res != null && res.data != null) {
                ...
                $scope.Save = function () {
                    $scope.LoaddingTree = true;
                    QuanLyDonViService.Save($scope.ListDonViSelected, $scope.UserId).then(res => {
                        if (res == "") {
