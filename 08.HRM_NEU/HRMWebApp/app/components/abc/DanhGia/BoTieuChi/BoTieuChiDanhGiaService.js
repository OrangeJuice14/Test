define(['app/app'], function (app) {
    ...
    app.factory('BoTieuChiDanhGiaService', ['$http', '$q', function ($http, $q) {
        ...
        serviceResult.GetBoTieuChiTuDanhGiaByUserId = function (userId, groupDanhGiaId,kyDanhGiaId) {
            return $http.get('/Api/ABC_BoTieuChiApi/GetBoTieuChiTuDanhGiaByUserId?userId=' + userId + '&groupDanhGiaId=' + groupDanhGiaId + '&kyDanhGiaId=' + kyDanhGiaId);
        }
