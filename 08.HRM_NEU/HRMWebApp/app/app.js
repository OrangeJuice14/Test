define(['angularAMD', 'ui-route', 'ui-validate', 'ui-bootstrap', 'kendo', 'ui-bootstrap-tpls', 'ckeditor', 'angular-sanitize', 'helper'], function (angularAMD) {
    "use strict";
    ...
    HRMWebApp.config(['$stateProvider', '$urlRouterProvider', '$locationProvider', function ($stateProvider, $urlRouterProvider, $locationProvider) {
        ...
        $stateProvider.state('site', {
            ...
            .state('thongkegiolam', angularAMD.route({
                data: {
                    roles: ['kpi/thongkegiolam']
                },
                resolve: {
                    authorize: ['authorization',
                        function (authorization) {
                ...
                url: '/kpi/thongkegiolam',
                templateUrl: '/app/views/chamcong/QuanLyChamCong/ThongKeGioLam.html'
            }))
            ...
            .state('phanconggiangday', angularAMD.route({
                url: '/kpi/phanconggiangday',
                templateUrl: '/app/components/PhanCongGiangDay/PhanCongGiangDay.html',
                controller: 'PhanCongGiangDayController',
                controllerUrl: 'app/components/PhanCongGiangDay/PhanCongGiangDayController'
            }))
            ////////////////////*********** ABC ********************////////////////////////////////
            ...
            .state('pms1', angularAMD.route({
                url: '/kpi/pms1',
                templateUrl: '/app/components/PMS/ThoiKhoaBieu.html',
                controller: 'ThoiKhoaBieuController',
                controllerUrl: 'app/components/PMS/ThoiKhoaBieuController'
            }))
            .state('pms2', angularAMD.route({
                url: '/kpi/pms2',
                templateUrl: '/app/components/PMS/HoatDongKhacDuyet.html',
                controller: 'HoatDongKhacDuyetController',
                controllerUrl: 'app/components/PMS/HoatDongKhacDuyetController'
            }))

            .state('chatluongcao', angularAMD.route({
                url: '/kpi/chatluongcao',
                controller: 'ChatLuongCaoController',
                controllerUrl: 'app/controllers/kpi/DaoTaoController'
            }))

            .state('saudaihoc', angularAMD.route({
                url: '/kpi/saudaihoc',
                controller: 'SauDaiHocController',
                controllerUrl: 'app/controllers/kpi/DaoTaoController'
            }))

            .state('chinhquy', angularAMD.route({
                url: '/kpi/chinhquy',
                controller: 'ChinhQuyController',
                controllerUrl: 'app/controllers/kpi/DaoTaoController'
            }))

            .state('tuxa', angularAMD.route({
                url: '/kpi/tuxa',
                controller: 'TuXaController',
                controllerUrl: 'app/controllers/kpi/DaoTaoController'
            }))
            .state('vuahocvualam', angularAMD.route({
                url: '/kpi/vuahocvualam',
                controller: 'VuaHocVuaLamController',
                controllerUrl: 'app/controllers/kpi/DaoTaoController'
            }))
            //--------------------Quản lý đánh giá--------------------------------------------------
            ...
            .state('BoTieuChi', angularAMD.route({
                url: '/kpi/BoTieuChi',
                templateUrl: '/app/components/abc/QuanLyDanhGia/BoTieuChi/index.html',
                controller: 'BoTieuChiController',
                controllerUrl: 'app/components/abc/QuanLyDanhGia/BoTieuChi/BoTieuChiController'
            }))
            .state('TieuChi', angularAMD.route({
                url: '/kpi/TieuChi/:BoTieuChiId',
                templateUrl: '/app/components/abc/QuanLyDanhGia/TieuChi/index.html',
            ...
            .state('ABC_UserGroupDanhGiaRole', angularAMD.route({
                ...
                templateUrl: '/app/components/abc/QuanLyDanhGia/UserGroupDanhGiaRole/manager.html',
            ...
            //--------------------Đánh giá--------------------------------------------------
            .state('KyDanhGia', angularAMD.route({
                url: '/kpi/ABC_KyDanhGia',
                templateUrl: '/app/components/abc/DanhGia/KyDanhGia/index.html',
            ...
            .state('TuDanhGia', angularAMD.route({
                ...
                templateUrl: '/app/components/abc/DanhGia/TuDanhGia/index.html',
                controller: 'TuDanhGiaController',
                controllerUrl: 'app/components/abc/DanhGia/TuDanhGia/TuDanhGiaController'
            }))
            .state('KyDanhGiaDongNghiep', angularAMD.route({
                url: '/kpi/KyDanhGiaDongNghiep',
                templateUrl: '/app/components/abc/DanhGia/DanhGiaDongNghiep/KyDanhGiaDongNghiep.html',
                controller: 'KyDanhGiaDongNghiepController',
                controllerUrl: 'app/components/abc/DanhGia/DanhGiaDongNghiep/KyDanhGiaDongNghiepController'
            }))
            .state('DanhGiaDongNghiep', angularAMD.route({
                url: '/kpi/DanhGiaDongNghiep/:KyDanhGiaId/:BoTieuChiId/:GroupDanhGiaId/:ABC_UserId',
    ...
    HRMWebApp.run(['$rootScope', '$state', '$stateParams', '$modal', '$rootElement', 'authorization', 'principal',
        function ($rootScope, $state, $stateParams, $modal, $rootElement, authorization, principal) {
            $rootScope.$on('$stateChangeStart', function (event, toState, toStateParams) {
                ...
                if ($rootScope.session && $rootScope.session.UserName != null && $rootScope.session.UserName != "") {
                    $.ajax({
                        type: 'GET',
                        url: '/Authentication/GetESurveyClassId?userName=' + $rootScope.session.UserName,
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        async: false,
                        success: function (result) {
                            if (result && result.length > 0) {
                                $modal.open({
                                    ...
                                    backdrop: 'static',
                                    keyboard: false,
                                    templateUrl: '/app/components/ESurvey/ESurvey.html',
                                    controller: 'ESurveyController',
                                    resolve: {
                                        classSurvey: function () {
                                            return result;
                                        }
                                    }
                                });
    ...
    HRMWebApp.controller('ESurveyController', ['$scope', '$rootScope', '$modalInstance', 'classSurvey',
        function ($scope, $rootScope, $modalInstance, classSurvey) {
            $scope.classSurvey = classSurvey;
            ...
            document.addEventListener('visibilitychange', function () {
                if (document.visibilityState == "hidden") {
                    ...
                    $.ajax({
                        ...
                        async: false,
                        success: function (result) {
                            $scope.classSurvey = result;
                            if ($scope.classSurvey.length == 0) {
                                //nếu không còn phiếu khảo sát nào thì tắt modal
                                setTimeout(function () {
                                    $modalInstance.close();
                                }, 500);
                            }
