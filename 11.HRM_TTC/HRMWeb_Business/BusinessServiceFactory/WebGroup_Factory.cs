...
namespace HRMWeb_Business.BusinessServiceFactory
{
    public class WebGroup_Factory : BaseFactory<Entities, WebGroup>
    {
        ...
        public IQueryable<WebMenu> GetRoledWebMenuList_ByWebGroupID(Guid oid)
        {
            var result = (from o in this.Context.WebMenu_Role
                          join x in this.Context.WebMenus on o.WebMenuID equals x.Oid
                          where o.WebGroupID == oid
                          select x);
            return result;
        }
        #endregion
