...
namespace HRMWeb_Business.BusinessServiceFactory
{
    public class WebMenu_Role_Factory : BaseFactory<Entities, WebMenu_Role>
    {
        ...
        public IQueryable<WebMenu_Role> GetAll_ByWebGroupId(Guid webGroupId)
        {
            var result = (from o in this.ObjectSet where o.WebGroupID == webGroupId
                          select o);
            return result;
        }

        public WebMenu_Role GetListByWebMenuId_WebGroupId(Guid webMenuId, Guid webGroupId)
        {
            var result = (from o in this.ObjectSet where o.WebMenuID == webMenuId && o.WebGroupID == webGroupId
