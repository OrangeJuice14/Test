...
namespace HRMWeb_Business.Model
{
    ...
    /// </summary>
    [EdmComplexTypeAttribute(NamespaceName="ERPModel", Name="spd_Web_VanBang_Result")]
    [DataContractAttribute(IsReference=true)]
    [Serializable()]
    public partial class spd_Web_VanBang_Result : ComplexObject
    {
        #region Factory Method
    
        /// <summary>
        /// Create a new spd_Web_VanBang_Result object.
        /// </summary>
        /// <param name="xepLoai">Initial value of the XepLoai property.</param>
        public static spd_Web_VanBang_Result Createspd_Web_VanBang_Result(string xepLoai)
        {
            spd_Web_VanBang_Result spd_Web_VanBang_Result = new spd_Web_VanBang_Result();
            spd_Web_VanBang_Result.XepLoai = xepLoai;
            return spd_Web_VanBang_Result;
        }
