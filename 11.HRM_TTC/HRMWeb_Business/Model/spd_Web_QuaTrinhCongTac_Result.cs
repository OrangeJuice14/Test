...
namespace HRMWeb_Business.Model
{
    ...
    /// </summary>
    [EdmComplexTypeAttribute(NamespaceName="ERPModel", Name="spd_Web_QuaTrinhCongTac_Result")]
    [DataContractAttribute(IsReference=true)]
    [Serializable()]
    public partial class spd_Web_QuaTrinhCongTac_Result : ComplexObject
    {
    #region Primitive Properties
        ...
        partial void On_NgayQuyetDinh_Changing(string currentValue, ref string newValue, ref bool stopChanging);
        partial void On_NgayQuyetDinh_Changed(string oldValue, string currentValue);
