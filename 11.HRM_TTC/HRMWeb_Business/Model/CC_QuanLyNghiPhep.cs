...
namespace HRMWeb_Business.Model
{
    ...
    public partial class CC_QuanLyNghiPhep : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_CC_QuanLyNghiPhep_NienDoTaiChinh", "NienDoTaiChinh")]
        public NienDoTaiChinh NienDoTaiChinh1
        {//test
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<NienDoTaiChinh>("ERPModel.FK_CC_QuanLyNghiPhep_NienDoTaiChinh", "NienDoTaiChinh").Value;
            }
            set
            {
    			bool stopChanging = false;
    			...
    			if(!stopChanging)
    			{
    				((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<NienDoTaiChinh>("ERPModel.FK_CC_QuanLyNghiPhep_NienDoTaiChinh", "NienDoTaiChinh").Value = value;
        ...
        public EntityReference<NienDoTaiChinh> NienDoTaiChinh1Reference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<NienDoTaiChinh>("ERPModel.FK_CC_QuanLyNghiPhep_NienDoTaiChinh", "NienDoTaiChinh");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<NienDoTaiChinh>("ERPModel.FK_CC_QuanLyNghiPhep_NienDoTaiChinh", "NienDoTaiChinh", value);
                }
            }
        }
