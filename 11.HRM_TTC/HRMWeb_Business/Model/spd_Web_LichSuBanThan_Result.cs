...
namespace HRMWeb_Business.Model
{
    ...
    /// </summary>
    [EdmComplexTypeAttribute(NamespaceName="ERPModel", Name="spd_Web_LichSuBanThan_Result")]
    [DataContractAttribute(IsReference=true)]
    [Serializable()]
    public partial class spd_Web_LichSuBanThan_Result : ComplexObject
    {
    #region Primitive Properties
        ...
        partial void On_CongTy_Changing(string currentValue, ref string newValue, ref bool stopChanging);
        partial void On_CongTy_Changed(string oldValue, string currentValue);
