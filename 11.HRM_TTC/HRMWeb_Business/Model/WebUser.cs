...
namespace HRMWeb_Business.Model
{
    ...
    public partial class WebUser : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_WebUserLogin_WebUsers", "WebUserLogin")]
        public EntityCollection<WebUserLogin> WebUserLogins
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<WebUserLogin>("ERPModel.FK_WebUserLogin_WebUsers", "WebUserLogin");
            }
            set
            {
                if ((value != null))
                {
    				bool stopChanging = false;
    				On_WebUserLogins_Changing(ref value, ref stopChanging);//\\//
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<WebUserLogin>("ERPModel.FK_WebUserLogin_WebUsers", "WebUserLogin", value);
    					On_WebUserLogins_Changed(this.WebUserLogins);//\\//
    				}
    			}
            }
        }
    	public static String WebUserLogins_EntityCollectionPropertyName { get { return "WebUserLogins"; } }
    	partial void On_WebUserLogins_Changing(ref EntityCollection<WebUserLogin> newValue, ref bool stopChanging);
    	partial void On_WebUserLogins_Changed(EntityCollection<WebUserLogin> currentValue);
