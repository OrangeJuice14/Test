...
namespace HRMWeb_Business.Model
{
    ...
    public partial class CC_CaChamCong : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [EdmScalarPropertyAttribute(EntityKeyProperty=false, IsNullable=true)]
        [DataMemberAttribute()]
        public Nullable<decimal> TongSoGioLamSang
        {
            get
            {
                return _tongSoGioLamSang;
            }
            set
            {
    			Nullable<decimal> oldValue =  _tongSoGioLamSang;
    			bool stopChanging = false;
                On_TongSoGioLamSang_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("TongSoGioLamSang");
    			if(!stopChanging)
    			{
    				_tongSoGioLamSang = StructuralObject.SetValidValue(value);
    				ReportPropertyChanged("TongSoGioLamSang");
    				On_TongSoGioLamSang_Changed(oldValue, _tongSoGioLamSang);//\\
    			}
            }
        }
    	public static String TongSoGioLamSang_PropertyName { get { return "TongSoGioLamSang"; } }
        private Nullable<decimal> _tongSoGioLamSang;
        partial void On_TongSoGioLamSang_Changing(Nullable<decimal> currentValue, ref Nullable<decimal> newValue, ref bool stopChanging);
        partial void On_TongSoGioLamSang_Changed(Nullable<decimal> oldValue, Nullable<decimal> currentValue);
        ...
        [EdmScalarPropertyAttribute(EntityKeyProperty=false, IsNullable=true)]
        [DataMemberAttribute()]
        public Nullable<decimal> TongSoGioLamChieu
        {
            get
            {
                return _tongSoGioLamChieu;
            }
            set
            {
    			Nullable<decimal> oldValue =  _tongSoGioLamChieu;
    			bool stopChanging = false;
                On_TongSoGioLamChieu_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("TongSoGioLamChieu");
    			if(!stopChanging)
    			{
    				_tongSoGioLamChieu = StructuralObject.SetValidValue(value);
    				ReportPropertyChanged("TongSoGioLamChieu");
    				On_TongSoGioLamChieu_Changed(oldValue, _tongSoGioLamChieu);//\\
    			}
            }
        }
    	public static String TongSoGioLamChieu_PropertyName { get { return "TongSoGioLamChieu"; } }
        private Nullable<decimal> _tongSoGioLamChieu;
        partial void On_TongSoGioLamChieu_Changing(Nullable<decimal> currentValue, ref Nullable<decimal> newValue, ref bool stopChanging);
        partial void On_TongSoGioLamChieu_Changed(Nullable<decimal> oldValue, Nullable<decimal> currentValue);
        ...
        [EdmScalarPropertyAttribute(EntityKeyProperty=false, IsNullable=true)]
        [DataMemberAttribute()]
        public string ThoiGianBDNghiGiuaCa
        {
            get
            {
                return _thoiGianBDNghiGiuaCa;
            }
            set
            {
    			string oldValue =  _thoiGianBDNghiGiuaCa;
    			bool stopChanging = false;
                On_ThoiGianBDNghiGiuaCa_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("ThoiGianBDNghiGiuaCa");
    			if(!stopChanging)
    			{
    				_thoiGianBDNghiGiuaCa = StructuralObject.SetValidValue(value, true);
    				ReportPropertyChanged("ThoiGianBDNghiGiuaCa");
    				On_ThoiGianBDNghiGiuaCa_Changed(oldValue, _thoiGianBDNghiGiuaCa);//\\
    			}
            }
        }
    	public static String ThoiGianBDNghiGiuaCa_PropertyName { get { return "ThoiGianBDNghiGiuaCa"; } }
        private string _thoiGianBDNghiGiuaCa;
        partial void On_ThoiGianBDNghiGiuaCa_Changing(string currentValue, ref string newValue, ref bool stopChanging);
        partial void On_ThoiGianBDNghiGiuaCa_Changed(string oldValue, string currentValue);
        ...
        [EdmScalarPropertyAttribute(EntityKeyProperty=false, IsNullable=true)]
        [DataMemberAttribute()]
        public string ThoiGianKTNghiGiuaCa
        {
            get
            {
                return _thoiGianKTNghiGiuaCa;
            }
            set
            {
    			string oldValue =  _thoiGianKTNghiGiuaCa;
    			bool stopChanging = false;
                On_ThoiGianKTNghiGiuaCa_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("ThoiGianKTNghiGiuaCa");
    			if(!stopChanging)
    			{
    				_thoiGianKTNghiGiuaCa = StructuralObject.SetValidValue(value, true);
    				ReportPropertyChanged("ThoiGianKTNghiGiuaCa");
    				On_ThoiGianKTNghiGiuaCa_Changed(oldValue, _thoiGianKTNghiGiuaCa);//\\
    			}
            }
        }
    	public static String ThoiGianKTNghiGiuaCa_PropertyName { get { return "ThoiGianKTNghiGiuaCa"; } }
        private string _thoiGianKTNghiGiuaCa;
        partial void On_ThoiGianKTNghiGiuaCa_Changing(string currentValue, ref string newValue, ref bool stopChanging);
        partial void On_ThoiGianKTNghiGiuaCa_Changed(string oldValue, string currentValue);
