...
namespace HRMWeb_Business.Model
{
    ...
    public partial class TinhTrang : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [EdmScalarPropertyAttribute(EntityKeyProperty=false, IsNullable=true)]
        [DataMemberAttribute()]
        public Nullable<bool> DaNghiViec
        {
            get
            {
                return _daNghiViec;
            ...
            set
            {
    			Nullable<bool> oldValue =  _daNghiViec;
    			bool stopChanging = false;
                On_DaNghiViec_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("DaNghiViec");
    			if(!stopChanging)
    			{
    				_daNghiViec = StructuralObject.SetValidValue(value);
    				ReportPropertyChanged("DaNghiViec");
    				On_DaNghiViec_Changed(oldValue, _daNghiViec);//\\
    			}
            }
        }
    	public static String DaNghiViec_PropertyName { get { return "DaNghiViec"; } }
        private Nullable<bool> _daNghiViec;
        partial void On_DaNghiViec_Changing(Nullable<bool> currentValue, ref Nullable<bool> newValue, ref bool stopChanging);
        partial void On_DaNghiViec_Changed(Nullable<bool> oldValue, Nullable<bool> currentValue);
