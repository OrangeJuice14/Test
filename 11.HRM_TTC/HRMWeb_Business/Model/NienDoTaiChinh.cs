...
namespace HRMWeb_Business.Model
{
    ...
    public partial class NienDoTaiChinh : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_CC_QuanLyNghiPhep_NienDoTaiChinh", "CC_QuanLyNghiPhep")]
        public EntityCollection<CC_QuanLyNghiPhep> CC_QuanLyNghiPhep
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<CC_QuanLyNghiPhep>("ERPModel.FK_CC_QuanLyNghiPhep_NienDoTaiChinh", "CC_QuanLyNghiPhep");
            }
            set
            {
                if ((value != null))
                {
    				...
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<CC_QuanLyNghiPhep>("ERPModel.FK_CC_QuanLyNghiPhep_NienDoTaiChinh", "CC_QuanLyNghiPhep", value);
