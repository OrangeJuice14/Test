...
namespace HRMWeb_Service
{
    ...
    {
        [OperationContract]
        IEnumerable<DTO_WebGroup> WebGroup_GetList(String publicKey, String token, Guid congTy);

        [OperationContract]
        String WebGroup_GetList_Json(String publicKey, String token, Guid congTy);
        // ////////////////////////////////////////////
        [OperationContract]
