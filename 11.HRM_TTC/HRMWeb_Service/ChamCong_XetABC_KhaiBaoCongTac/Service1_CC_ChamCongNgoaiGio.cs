...
namespace HRMWeb_Service
{
    ...
    public partial class Service1 : IService1
    {
        ...
        public IEnumerable<DTO_CC_ChamCongNgoaiGio> DangKyChamCongNgoaiGio_Find(String publicKey, String token, DateTime tuNgay, DateTime denNgay, Guid idNhanVien)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                CC_ChamCongNgoaiGio_Factory factory = CC_ChamCongNgoaiGio_Factory.New();
                IEnumerable<DTO_CC_ChamCongNgoaiGio> objList = factory.ChamCongNgoaiGio_Find(tuNgay, denNgay, idNhanVien);
                return objList;
            }
            else
            {
        ...
        public IEnumerable<DTO_CC_ChamCongNgoaiGio> QuanLyChamCongNgoaiGio_Find(String publicKey, String token, DateTime tuNgay, DateTime denNgay, Guid IDBoPhan, int trangthai, Guid userID, Guid congTy)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                CC_ChamCongNgoaiGio_Factory factory = CC_ChamCongNgoaiGio_Factory.New();
                var tmpList = factory.QuanLyChamCongNgoaiGio_Find(tuNgay, denNgay, IDBoPhan, trangthai, userID, congTy).ToList();
        ...
        public IEnumerable<DTO_CC_ChamCongNgoaiGio> QuanLyChamCongNgoaiGio_Find_NhacViec(String publicKey, String token, DateTime tuNgay, DateTime denNgay, Guid IDBoPhan, int trangthai, Guid userID, Guid congTy, bool tatCaDonChuaDuyet)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                CC_ChamCongNgoaiGio_Factory factory = CC_ChamCongNgoaiGio_Factory.New();
                var tmpList = factory.QuanLyChamCongNgoaiGio_Find_NhacViec(tuNgay, denNgay, IDBoPhan, trangthai, userID, congTy, tatCaDonChuaDuyet).ToList();
                IEnumerable<DTO_CC_ChamCongNgoaiGio> objList = tmpList.Map<DTO_CC_ChamCongNgoaiGio>();
                return objList;
            }
            else
        ...
        public String DangKyChamCongNgoaiGio_Find_Json(String publicKey, String token, DateTime tuNgay, DateTime denNgay, Guid idNhanVien)
        {//DANG SD
            IEnumerable<DTO_CC_ChamCongNgoaiGio> list = DangKyChamCongNgoaiGio_Find(publicKey, token, tuNgay, denNgay, idNhanVien);
            String json = JsonConvert.SerializeObject(list);
            return json;
        }
        public String QuanLyChamCongNgoaiGio_Find_Json(String publicKey, String token, DateTime tuNgay, DateTime denNgay, Guid IDBoPhan, int trangthai, Guid userID, Guid congTy)
        {//DANG SD
            IEnumerable<DTO_CC_ChamCongNgoaiGio> list = QuanLyChamCongNgoaiGio_Find(publicKey, token, tuNgay, denNgay, IDBoPhan, trangthai, userID, congTy);
            String json = JsonConvert.SerializeObject(list);
            return json;
        }
