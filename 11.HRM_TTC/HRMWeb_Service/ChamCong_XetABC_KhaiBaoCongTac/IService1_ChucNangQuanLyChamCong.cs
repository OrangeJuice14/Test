...
namespace HRMWeb_Service
{
    public partial interface IService1
    {
        ...
        IEnumerable<DTO_QuanLyChamCong_Find> QuanLyChamCong_Find(String publicKey, String token,
           int ngay, int thang, int nam, Guid? boPhanId, int trangThaiChamCong, Boolean? diHoc, String maNhanSu, Guid webUserId, Guid? idLoaiNhanSu, Guid congTy);
        ...
        String QuanLyChamCong_Find_Json(String publicKey, String token, int ngay, int thang, int nam, Guid? boPhanId,
            int trangThaiChamCong, Boolean? diHoc, String maNhanSu, Guid webUserId, Guid? idLoaiNhanSu, Guid congTy);
        ...
        */
        ...
        IEnumerable<DTO_QuanLyChamCong_ThongTinChamCongThang> QuanLyChamCong_ThongTinChamCongThang(String publicKey, String token,
            int thang, int nam, Guid boPhanId, String maNhanSu, Guid idLoaiNhanSu, Guid userId, Guid congTy);
        ...
        [OperationContract]
        IEnumerable<DTO_QuanLyChamCong_ThongTinChamCongThang> QuanLyChamCong_ThongTinChamCongThang_Cua1NhanVien(String publicKey, String token, int thang, int nam, Guid nhanVienID, Guid congTy);

        [OperationContract]
        String QuanLyChamCong_ThongTinChamCongThang_Cua1NhanVien_Json(String publicKey, String token,int thang, int nam, Guid nhanVienID, Guid congTy);
