define(['app/app'], function (app) {
    ...
    app.factory('departmentService', ['$http', '$q', function ($http, $q) {
        ...
        serviceResult.getAdminDepartmentListHierarchy = function (id, congTyId) {
            return $http.get('/Api/departmentApi/GetAdminDepartmentListHierarchy?adminId=' + id + '&congTyId=' + congTyId);
        };
