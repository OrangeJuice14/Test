define(['app/app'], function (app) {
    ...
    app.factory('ABC_CriterionService', ['$http', '$q', function ($http, $q) {
        var serviceResult = {};
        serviceResult.getListByRatingType = function (ratingType) {
            return $http.get('/Api/ABC_CriterionApi/GetListByRatingType?ratingType=' + ratingType);
        }
        serviceResult.getListRatingLevel = function () {
            return $http.get('/Api/ABC_CriterionApi/GetListRatingLevel');
        }
        serviceResult.getRatingLevel = function (id, criterionId) {
            return $http.get('Api/ABC_CriterionApi/GetRatingLevel?id=' + id + '&criterionId=' + criterionId);
        }
        serviceResult.getTempRatingLevelById = function (id) {
            return $http.get('Api/ABC_CriterionApi/GetTempRatingLevelById?id=' + id);
        }
        serviceResult.clearTempRatingLevel = function () {
            return $http.get('/Api/ABC_CriterionApi/GetTempRatingLevel');
        }
        serviceResult.getRatingTypesByCriterionId = function (id) {
            return $http.get('/Api/ABC_CriterionApi/GetRatingTypesByCriterionId?id=' + id);
        }
        serviceResult.getListByRatingTypeHierarchy = function (ratingType) {
            return $http.get('/Api/ABC_CriterionApi/GetListByRatingTypeHierarchy?ratingType=' + ratingType);
        }
        serviceResult.SaveRatingLevel = function (Obj) {
            var deferred = $q.defer();
            $http({
                method: 'Put',
                url: '/Api/ABC_CriterionApi/PutRatingLevel',
                data: Obj
        ...
        serviceResult.SaveRatingLevelOfNewCriterion = function (Obj) {
            var deferred = $q.defer();
            $http({
                method: 'Put',
                url: '/Api/ABC_CriterionApi/PutRatingLevelOfNewCriterion',
                data: Obj
            }).success(function (result) {
                deferred.resolve(result);
            });
        ...
        serviceResult.SaveTempRatingLevel = function (Obj) {
            var deferred = $q.defer();
            $http({
                method: 'Put',
                url: '/Api/ABC_CriterionApi/PutTempRatingLevel',
                data: Obj
            }).success(function (result) {
                deferred.resolve(result);
            });
        ...
        serviceResult.SaveNewCriterion = function (Obj) {
            var deferred = $q.defer();
            $http({
                method: 'Put',
                url: '/Api/ABC_CriterionApi/PutNewCriterion',
                data: Obj
            }).success(function (result) {
                deferred.resolve(result);
            });
