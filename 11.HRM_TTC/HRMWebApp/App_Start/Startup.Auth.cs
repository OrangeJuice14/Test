...
namespace HRMWebApp
{
    public partial class Startup
    {
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            {
                ClientId = ConfigurationManager.AppSettings["Authentication:Microsoft:ApplicationId"],
                ClientSecret = ConfigurationManager.AppSettings["Authentication:Microsoft:Password"]
            };
