...
namespace HRMWebApp.ChamCong.Core.Controllers
{
    public class WebServicesController : Controller
    {
        ...
        {
            _service.ChangePassword_WebUser_URM(PublicKey, _token, new Guid(webUserId), passWord);
            return Helper.JsonSucess();
        }
        ...
        public ActionResult QuanLyGuiEmail_FindMailTemplateType()
        {
            return _service.QuanLyGuiEmail_FindMailTemplateType(PublicKey, _token).ToJSON();
        }
        public ActionResult QuanLyGuiEmail_FindMailTemplate(string congTy, Guid loaiGuiMail)
        {
            Guid idCongTy = _congTy;
            if (!string.IsNullOrEmpty(congTy))
            {
            ...
            return _service.QuanLyGuiEmail_FindMailTemplate(PublicKey, _token, idCongTy, loaiGuiMail).ToJSON();
        }
        public ActionResult QuanLyGuiEmail_UpdateMailTemplate(string tieuDeEmail, string noiDungEmail, Guid loaiGuiMail, string congTy)
        {
            Guid idCongTy = _congTy;
            if (!string.IsNullOrEmpty(congTy))
            {
            ...
            if (_service.QuanLyGuiEmail_UpdateMailTemplate(PublicKey, _token, tieuDeEmail, noiDungEmail, loaiGuiMail, idCongTy))
            {
                return Helper.JsonSucess();
            }
            return Helper.JsonErorr();
        ...
        public ActionResult CauHinhChamCong_Save(string oid, string emailsender, string passsender, string host, int? port, string songaynghiphep, string sogdkhoiduyet, string sodkngoaigio, DateTime? ngayXoaPhepCu, decimal? soNgayPhepTangThem, decimal? thoiGianTangSoNgayPhep, bool? truongDonViKhongDuyet, Guid congTy)
        {
            ...
            //
            if (_service.CauHinhChamCong_Save(PublicKey, _token, oidCauHinh, emailsender, passsender, host, port, songaynghiphep, sogdkhoiduyet, sodkngoaigio, ngayXoaPhepCu, soNgayPhepTangThem, thoiGianTangSoNgayPhep, truongDonViKhongDuyet, congTy))
            {
                return Helper.JsonSucess();
            }
            return Helper.JsonErorr();
        ...
        public ActionResult QuanLyNghiPhepNam_Remove(Guid nienDoTaiChinh, string congTy, Guid chiTietPhepOid)
        {
            Guid idCongTy = _congTy;
            if (!string.IsNullOrEmpty(congTy))
            {
            ...
            if (_service.QuanLyNghiPhepNam_Remove(PublicKey, _token, nienDoTaiChinh, idCongTy, chiTietPhepOid))
            {
                return Helper.JsonSucess();
            }
            //
        ...
        public ActionResult QuanLyKhaiBaoCongTac_ThayDoiTrangThaiList(List<QuanLyCongTac> list, int trangthai, string userId)
        {
            //var js = new JavaScriptSerializer();
            var jsonObject = list.ToJSON().Content;
        ...
        public ActionResult ChamCongNgayNghi_Find_ById(Guid chamCongNgayNghiId)
        {
            return _service.ChamCongNgayNghi_Find_ById(PublicKey, _token, chamCongNgayNghiId).ToJSON();
        }
        ...
        public ActionResult QuanLyNghiPhepNam_Save(string Oid, string TongSoNgayPhep, string SoNgayPhepCongThem, string SoNgayPhepNamTruoc, string SoNgayTamUngHienTai)
        {
            ...
            //
            if (_service.QuanLyNghiPhepNam_SaveList(PublicKey, _token, idChiTietNghiPhep, TongSoNgayPhep, SoNgayPhepCongThem, SoNgayPhepNamTruoc, SoNgayTamUngHienTai))
                return Helper.JsonSucess();
            else
                return Helper.JsonErorr();
        }
        ...
        public string DangKyChamCongNgoaiGio_Find(DateTime tuNgay, DateTime denNgay, string idNhanVien)
        {
            Guid nhanVienID = Guid.Empty;
            if (!string.IsNullOrEmpty(idNhanVien))
            {
            ...
            //
            return _service.DangKyChamCongNgoaiGio_Find_Json(PublicKey, _token, tuNgay, denNgay, nhanVienID);
        }
        ...
        public string QuanLyChamCongNgoaiGio_Find(DateTime tuNgay, DateTime denNgay, string IDBoPhan, int trangthai, string idwebuser, string congTy)
        {
            Guid idCongTy = _congTy;
            if (!string.IsNullOrEmpty(congTy))
            {
            ...
            return _service.QuanLyChamCongNgoaiGio_Find_Json(PublicKey, _token, tuNgay, denNgay, boPhanID, trangthai, userID, idCongTy);
        }
        public ActionResult QuanLyChamCongNgoaiGio_Find_NhacViec(DateTime tuNgay, DateTime denNgay, string IDBoPhan, int trangthai, string idwebuser, string congTy, bool tatCaDonChuaDuyet)
        {
            Guid idCongTy = _congTy;
            if (!string.IsNullOrEmpty(congTy))
            {
            ...
            return _service.QuanLyChamCongNgoaiGio_Find_NhacViec(PublicKey, _token, tuNgay, denNgay, boPhanID, trangthai, userID, idCongTy, tatCaDonChuaDuyet).ToJSON();
        }
