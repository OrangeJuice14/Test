...
namespace HRMWeb_Service
{
    ...
    public partial class Service1 : IService1
    {
        ...
        public bool CapNhatChamCongDonVi(String publicKey, String token, Guid kyChamCong)
        {//DANG SD
            if (Helper.TrustTest(publicKey, token))
            {
                ...
                try
                {
                    factory.Context.spd_WebChamCong_CapNhatBoPhanChamCongTheoNgay(kyChamCong);
