...
namespace HRMWeb_Service
{
    ...
    public partial class Service1 : IService1
    {
        ...
        */
        ...
        /*
        public IEnumerable<DTO_ThongKeXetABCTheoNam> ThongKeXetABCTheoNam_Find_PhanTrang(String publicKey, String token,
            int nam, Guid? boPhanId, string maNhanSu, int trang, int soMauTinMoiTrang, Guid webUserId)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                ...
                IEnumerable<DTO_ThongKeXetABCTheoNam> list = factory.ThongKeXetABCTheoNam_CoPhanTrang(nam, boPhanId, maNhanSu, trang, soMauTinMoiTrang, webUserId).ToList();
                return list;
        ...
        public String ThongKeXetABCTheoNam_Find_PhanTrang_Json(String publicKey, String token, int nam, Guid? boPhanId, string maNhanSu, int trang, int soMauTinMoiTrang, Guid webUserId)
        {
            ...
            IEnumerable<DTO_ThongKeXetABCTheoNam> list = ThongKeXetABCTheoNam_Find_PhanTrang(publicKey, token, nam, boPhanId, maNhanSu, trang, soMauTinMoiTrang, webUserId);
            int count = ThongKeXetABCTheoNam_FindCount(publicKey, token, nam, boPhanId, maNhanSu, webUserId);
