...
namespace HRMWeb_Service
{
    ...
    public partial class Service1 : IService1
    {
        ...
        public DTO_CC_ChamCongNgayNghi ChamCongNgayNghi_TaoMoi(String publicKey, String token, Guid nhanVienID, String noiDung, Guid idHinhThucNghi, DateTime tuNgay, DateTime denNgay, Guid webUserId)
        {//DANG SD
            if (Helper.TrustTest(publicKey, token))
            {
        ...
        public bool ChamCongNgayNghi_AcceptList(String publicKey, String token, List<DTO_ChamCongNgayNghi_Find> objList)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required,
        ...
        public bool ChamCongNgayNghi_CancelList(String publicKey, String token, List<DTO_ChamCongNgayNghi_Find> objList)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required,
        ...
        public bool ChamCongNgayNghi_AcceptList_Json(String publicKey, String token, string jsonObjectList)
        {//DANG SD
            //chuyen jsonObject thanh object
            List<DTO_ChamCongNgayNghi_Find> objList = JsonConvert.DeserializeObject<List<DTO_ChamCongNgayNghi_Find>>(jsonObjectList);
            return ChamCongNgayNghi_AcceptList(publicKey, token, objList);
        }
        public bool ChamCongNgayNghi_CancelList_Json(String publicKey, String token, string jsonObjectList)
        {//DANG SD
            //chuyen jsonObject thanh object
            List<DTO_ChamCongNgayNghi_Find> objList = JsonConvert.DeserializeObject<List<DTO_ChamCongNgayNghi_Find>>(jsonObjectList);
            return ChamCongNgayNghi_CancelList(publicKey, token, objList);
        }
