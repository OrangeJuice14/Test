...
namespace HRMWeb_Service
{
    ...
    {
        [OperationContract]
        IEnumerable<DTO_QuanLyKhaiBaoCongTac_Find> QuanLyKhaiBaoCongTac_Find(String publicKey, String token, int thang,
            int nam, Guid? boPhanId, int? trangThai, string maNhanSu, Guid webUserId);

        [OperationContract]
        String QuanLyKhaiBaoCongTac_Find_Json(String publicKey, String token, int thang, int nam, Guid? boPhanId,
            int? trangThai, string maNhanSu, Guid webUserId);

        [OperationContract]
        bool QuanLyKhaiBaoCongTac_ThayDoiTrangThaiList(String publicKey, String token,
            List<DTO_QuanLyKhaiBaoCongTac_Find> objList, int trangThai);
