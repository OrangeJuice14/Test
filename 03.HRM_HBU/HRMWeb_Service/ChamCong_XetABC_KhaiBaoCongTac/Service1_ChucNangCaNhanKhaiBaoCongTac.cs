...
namespace HRMWeb_Service
{
    ...
    public partial class Service1 : IService1
    {
        ...
        public bool CaNhanKhaiBaoCongTac_KiemTraTuNgayDenNgayCoHopLe(String publicKey, String token, Guid? khaiBaoCongTacOid, DateTime tuNgay, DateTime denNgay, int buoi, Guid webUserId)
        {//DANG SD
            tuNgay = tuNgay.Date;
                ...
                var trungHoacGiaoNgayKhaiBaoCongTac = (from o in factory.Context.CC_KhaiBaoCongTac
                                                       where o.IDNhanVien == webUser.ThongTinNhanVien
                                                          && (isNew || o.Oid != khaiBaoCongTacOid)
                                                           ...
                                                           && ((buoi == 0 || o.Buoi == 0) ? true : o.Buoi == buoi) //kiểm tra có trùng buổi hay không
        ...
        public DTO_CC_KhaiBaoCongTac CaNhanKhaiBaoCongTac_KhaiBaoMoi(String publicKey, String token, String noiDung, DateTime tuNgay, DateTime denNgay, Guid webUserId,byte buoi)
        {//DANG SD
            if (Helper.TrustTest(publicKey, token))
            {
                WebUser_Factory webUser_Factory = WebUser_Factory.New();
