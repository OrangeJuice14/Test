...
namespace HRMWeb_Service
{
    public partial interface IService1
    {
        ...
        //[OperationContract]
        //IEnumerable<DTO_ChiTietChamCongNhanVien> QuanLyXetABC_Find_PhanTrang(String publicKey, String token, int thang,
        //    int nam, Guid boPhanId, Guid? idLoaiNhanSu, Boolean? diHoc, int trang, int soMauTinMoiTrang);
        //[OperationContract]
        //String QuanLyXetABC_Find_PhanTrang_Json(String publicKey, String token, int thang,
        //    int nam, Guid boPhanId, Guid? idLoaiNhanSu, Boolean? diHoc, int trang, int soMauTinMoiTrang);
