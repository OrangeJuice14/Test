    ...
    public class CC_KhaiBaoCongTac_Factory : BaseFactory<Entities, CC_KhaiBaoCongTac>
    {
        ...
        public IQueryable<DTO_QuanLyKhaiBaoCongTac_Find> QuanLyKhaiBaoCongTac_Find(int thang, int nam, Guid? boPhanId, int? trangThai, string maNhanSu, Guid webUserId)
        {
            ...
            var result = (from o in this.ObjectSet
                          ...
                          && (webGroupId == new Guid("00000000-0000-0000-0000-000000000002") ? o.HoSo.WebUsers.FirstOrDefault().Oid != webUserId : true)
                          select new DTO_QuanLyKhaiBaoCongTac_Find() { DenNgay = o.DenNgay, HoTen = o.HoSo.HoTen, IDNhanVien = o.IDNhanVien, IDWebUser = o.IDWebUser, MaNhanSu = o.HoSo.MaQuanLy, NgayTao = o.NgayTao, Oid = o.Oid, NoiDung = o.NoiDung, TrangThai = o.TrangThai, TuNgay = o.TuNgay,Buoi=o.Buoi.ToString() });
            return result;
