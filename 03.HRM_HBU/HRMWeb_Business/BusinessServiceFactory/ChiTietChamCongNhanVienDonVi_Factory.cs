...
{
    public class ChiTietChamCongNhanVienDonVi_Factory : BaseFactory<Entities, CC_ChiTietChamCongNhanVien_DonVi>
    {
        //static readonly Log4netCustom.ILog TracingLog_ = Log4netCustom.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        public static ERP_Core.BaseEntityObject CreateStandAloneObject()
        {
            return ChiTietChamCongNhanVienDonVi_Factory.New().CreateAloneObject();
        }
        public static ChiTietChamCongNhanVienDonVi_Factory New()
        {
            return new ChiTietChamCongNhanVienDonVi_Factory();
        }
        public ChiTietChamCongNhanVienDonVi_Factory()
        ...
        public IQueryable<CC_ChiTietChamCongNhanVien_DonVi> GetAll_GCRecordIsNull()
        {
        ...
        public IQueryable<CC_ChiTietChamCongNhanVien_DonVi> GetListByIdList(List<Guid> idList)
        {
            var result = from o in this.ObjectSet
        ...
        public CC_ChiTietChamCongNhanVien_DonVi GetChiTietChamCongNhanVienByNhanVien(Guid quanLyChamCong, Guid nhanVien, Guid boPhanId)
        {
            var result = (from o in this.ObjectSet
                         where o.ThongTinNhanVien == nhanVien
                               && o.BoPhan == boPhanId
                               && o.QuanLyChamCongNhanVien == quanLyChamCong
                         select o).SingleOrDefault();
            return result;
        }
        public IQueryable<CC_ChiTietChamCongNhanVien_DonVi> GetByHoSoNhanVienID(Guid hoSoNhanVienId)
        {
            var result = (from o in this.ObjectSet
        ...
        public IQueryable<CC_ChiTietChamCongNhanVien_DonVi> GetByBoPhanId(Guid boPhanId)
        {
            var result = (from o in this.ObjectSet
        ...
        public CC_ChiTietChamCongNhanVien_DonVi GetById(Guid id)
        {
            var result = (from o in this.ObjectSet
                          where o.Oid == id
                          select o).SingleOrDefault();
        ...
        /// <returns></returns>
        public IQueryable<CC_ChiTietChamCongNhanVien_DonVi> QuanLyXetABC_Find(int thang, int nam, Guid boPhanId, Guid? idLoaiNhanSu, bool? diHoc)
        {
            var result = (from o in this.ObjectSet
                          where o.BoPhan == boPhanId
                                && (o.QuanLyChamCongNhanVien1.KyTinhLuong1.TuNgay.Value.Month == thang
                                ...
                                && (o.ThongTinNhanVien1.NhanVien.TinhTrang1.KhongConCongTacTaiTruong ?? false) == false
                          orderby o.ThongTinNhanVien1.NhanVien.HoSo.Ten ascending
                          select o);
            return result;
        }
        public IQueryable<CC_ChiTietChamCongNhanVien_DonVi> QuanLyXetABCFind_CoPhanTrang(int thang, int nam, Guid boPhanId, Guid? idLoaiNhanSu, bool? diHoc, int trang, int soMauTinMoiTrang)
        {
            int soMauTinBoQua = (trang - 1) * soMauTinMoiTrang;
