...
namespace HRMWeb_Business.Model
{
    ...
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="ERPModel", Name="HocHam")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class HocHam : ERP_Core.BaseEntityObject//EntityObject
    {
    	static HocHam()
    	{
        ...
        public static HocHam CreateHocHam(System.Guid oid)
        {
        ...
        public string TenHocHam
        {
            ...
            set
            {
    			string oldValue =  _tenHocHam;
    			bool stopChanging = false;
                On_TenHocHam_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("TenHocHam");
    			if(!stopChanging)
    			{
    				_tenHocHam = StructuralObject.SetValidValue(value, true);
    				ReportPropertyChanged("TenHocHam");
    				On_TenHocHam_Changed(oldValue, _tenHocHam);//\\
    			}
            }
        }
    	public static String TenHocHam_PropertyName { get { return "TenHocHam"; } }
        private string _tenHocHam;
        partial void On_TenHocHam_Changing(string currentValue, ref string newValue, ref bool stopChanging);
        partial void On_TenHocHam_Changed(string oldValue, string currentValue);
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_ThongTinTinhLuong_HocHam", "ThongTinTinhLuong")]
        public EntityCollection<ThongTinTinhLuong> ThongTinTinhLuongs
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<ThongTinTinhLuong>("ERPModel.FK_ThongTinTinhLuong_HocHam", "ThongTinTinhLuong");
            }
            set
            {
                if ((value != null))
                {
    				...
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<ThongTinTinhLuong>("ERPModel.FK_ThongTinTinhLuong_HocHam", "ThongTinTinhLuong", value);
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_NhanVienTrinhDo_HocHam", "NhanVienTrinhDo")]
        public EntityCollection<NhanVienTrinhDo> NhanVienTrinhDoes
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<NhanVienTrinhDo>("ERPModel.FK_NhanVienTrinhDo_HocHam", "NhanVienTrinhDo");
            }
            set
            {
                if ((value != null))
                {
    				...
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<NhanVienTrinhDo>("ERPModel.FK_NhanVienTrinhDo_HocHam", "NhanVienTrinhDo", value);
