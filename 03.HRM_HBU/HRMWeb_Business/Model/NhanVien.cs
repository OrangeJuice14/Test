...
namespace HRMWeb_Business.Model
{
    ...
    public partial class NhanVien : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_HopDong_NhanVien", "HopDong")]
        public EntityCollection<HopDong> HopDongs
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<HopDong>("ERPModel.FK_HopDong_NhanVien", "HopDong");
            }
            set
            {
                if ((value != null))
                {
    				...
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<HopDong>("ERPModel.FK_HopDong_NhanVien", "HopDong", value);
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_NhanVien_HopDongHienTai", "HopDong")]
        public HopDong HopDong
        {//test
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<HopDong>("ERPModel.FK_NhanVien_HopDongHienTai", "HopDong").Value;
            }
            set
            {
    			bool stopChanging = false;
    			On_HopDong_Changing(ref value, ref stopChanging);//\\//
    			if(!stopChanging)
    			{
    				((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<HopDong>("ERPModel.FK_NhanVien_HopDongHienTai", "HopDong").Value = value;
    				On_HopDong_Changed(this.HopDong);//\\//
    			}
    	    }
        }
    	public static String HopDong_ReferencePropertyName { get { return "HopDong"; } }
    	partial void On_HopDong_Changing(ref HopDong newValue, ref bool stopChanging);
    	partial void On_HopDong_Changed(HopDong currentValue);
        /// <summary>
        /// No Metadata Documentation available.
        /// </summary>
        [BrowsableAttribute(false)]
        ...
        public EntityReference<HopDong> HopDongReference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<HopDong>("ERPModel.FK_NhanVien_HopDongHienTai", "HopDong");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<HopDong>("ERPModel.FK_NhanVien_HopDongHienTai", "HopDong", value);
                }
            }
        }
