...
namespace HRMWeb_Business.Model
{
    ...
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="ERPModel", Name="TrinhDoTinHoc")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class TrinhDoTinHoc : ERP_Core.BaseEntityObject//EntityObject
    {
    	static TrinhDoTinHoc()
    	{
        ...
        public static TrinhDoTinHoc CreateTrinhDoTinHoc(System.Guid oid)
        {
            TrinhDoTinHoc trinhDoTinHoc = new TrinhDoTinHoc();
            trinhDoTinHoc.Oid = oid;
        ...
        public string TenTrinhDoTinHoc
        {
            ...
            set
            {
    			string oldValue =  _tenTrinhDoTinHoc;
    			bool stopChanging = false;
                On_TenTrinhDoTinHoc_Changing(oldValue, ref value, ref stopChanging);
    			...
    			if(!stopChanging)
    			{
    				...
    				On_TenTrinhDoTinHoc_Changed(oldValue, _tenTrinhDoTinHoc);//\\
    			}
            }
        }
    	public static String TenTrinhDoTinHoc_PropertyName { get { return "TenTrinhDoTinHoc"; } }
        private string _tenTrinhDoTinHoc;
        partial void On_TenTrinhDoTinHoc_Changing(string currentValue, ref string newValue, ref bool stopChanging);
        partial void On_TenTrinhDoTinHoc_Changed(string oldValue, string currentValue);
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_NhanVienTrinhDo_TrinhDoTinHoc", "NhanVienTrinhDo")]
        public EntityCollection<NhanVienTrinhDo> NhanVienTrinhDoes
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<NhanVienTrinhDo>("ERPModel.FK_NhanVienTrinhDo_TrinhDoTinHoc", "NhanVienTrinhDo");
            }
            set
            {
                if ((value != null))
                {
    				...
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<NhanVienTrinhDo>("ERPModel.FK_NhanVienTrinhDo_TrinhDoTinHoc", "NhanVienTrinhDo", value);
