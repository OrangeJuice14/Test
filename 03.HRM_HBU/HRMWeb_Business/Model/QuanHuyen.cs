...
namespace HRMWeb_Business.Model
{
    ...
    public partial class QuanHuyen : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_DiaChi_QuanHuyen", "DiaChi")]
        public EntityCollection<DiaChi> DiaChis
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<DiaChi>("ERPModel.FK_DiaChi_QuanHuyen", "DiaChi");
            }
            set
            {
                if ((value != null))
                {
    				...
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<DiaChi>("ERPModel.FK_DiaChi_QuanHuyen", "DiaChi", value);
