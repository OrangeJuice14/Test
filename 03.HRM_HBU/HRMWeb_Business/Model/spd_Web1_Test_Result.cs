...
namespace HRMWeb_Business.Model
{
    ...
    /// </summary>
    [EdmComplexTypeAttribute(NamespaceName="ERPModel", Name="spd_Web1_Test_Result")]
    [DataContractAttribute(IsReference=true)]
    [Serializable()]
    public partial class spd_Web1_Test_Result : ComplexObject
    {
        #region Factory Method
    
        /// <summary>
        /// Create a new spd_Web1_Test_Result object.
        /// </summary>
        /// <param name="oid">Initial value of the Oid property.</param>
        public static spd_Web1_Test_Result Createspd_Web1_Test_Result(System.Guid oid)
        {
            spd_Web1_Test_Result spd_Web1_Test_Result = new spd_Web1_Test_Result();
            spd_Web1_Test_Result.Oid = oid;
            return spd_Web1_Test_Result;
        }
