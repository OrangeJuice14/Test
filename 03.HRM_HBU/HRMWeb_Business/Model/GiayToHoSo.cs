...
namespace HRMWeb_Business.Model
{
    ...
    public partial class GiayToHoSo : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_QuyetDinhCaNhan_GiayToHoSo", "QuyetDinhCaNhan")]
        public EntityCollection<QuyetDinhCaNhan> QuyetDinhCaNhans
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<QuyetDinhCaNhan>("ERPModel.FK_QuyetDinhCaNhan_GiayToHoSo", "QuyetDinhCaNhan");
            }
            set
            {
                if ((value != null))
                {
    				...
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<QuyetDinhCaNhan>("ERPModel.FK_QuyetDinhCaNhan_GiayToHoSo", "QuyetDinhCaNhan", value);
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_HopDong_GiayToHoSo", "HopDong")]
        public EntityCollection<HopDong> HopDongs
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<HopDong>("ERPModel.FK_HopDong_GiayToHoSo", "HopDong");
            }
            set
            {
                if ((value != null))
                {
    				...
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<HopDong>("ERPModel.FK_HopDong_GiayToHoSo", "HopDong", value);
