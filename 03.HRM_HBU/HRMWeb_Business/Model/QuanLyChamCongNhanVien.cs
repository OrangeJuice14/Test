...
namespace HRMWeb_Business.Model
{
    ...
    public partial class QuanLyChamCongNhanVien : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_QuanLyChamCongNhanVien_CC_KyChamCong", "CC_KyChamCong")]
        public CC_KyChamCong CC_KyChamCong
        {//test
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<CC_KyChamCong>("ERPModel.FK_QuanLyChamCongNhanVien_CC_KyChamCong", "CC_KyChamCong").Value;
            }
            set
            {
    			bool stopChanging = false;
    			...
    			if(!stopChanging)
    			{
    				((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<CC_KyChamCong>("ERPModel.FK_QuanLyChamCongNhanVien_CC_KyChamCong", "CC_KyChamCong").Value = value;
        ...
        public EntityReference<CC_KyChamCong> CC_KyChamCongReference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<CC_KyChamCong>("ERPModel.FK_QuanLyChamCongNhanVien_CC_KyChamCong", "CC_KyChamCong");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<CC_KyChamCong>("ERPModel.FK_QuanLyChamCongNhanVien_CC_KyChamCong", "CC_KyChamCong", value);
                }
            }
        }
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_ChiTietChamCongNhanVien_DonVi_QuanLyChamCongNhanVien", "CC_ChiTietChamCongNhanVien_DonVi")]
        public EntityCollection<CC_ChiTietChamCongNhanVien_DonVi> CC_ChiTietChamCongNhanVien_DonVi
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<CC_ChiTietChamCongNhanVien_DonVi>("ERPModel.FK_ChiTietChamCongNhanVien_DonVi_QuanLyChamCongNhanVien", "CC_ChiTietChamCongNhanVien_DonVi");
            }
            set
            {
                if ((value != null))
                {
    				...
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<CC_ChiTietChamCongNhanVien_DonVi>("ERPModel.FK_ChiTietChamCongNhanVien_DonVi_QuanLyChamCongNhanVien", "CC_ChiTietChamCongNhanVien_DonVi", value);
