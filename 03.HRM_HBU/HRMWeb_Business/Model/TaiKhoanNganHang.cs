...
namespace HRMWeb_Business.Model
{
    ...
    public partial class TaiKhoanNganHang : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_TaiKhoanNganHang_NganHang", "NganHang")]
        public NganHang NganHang1
        {//test
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<NganHang>("ERPModel.FK_TaiKhoanNganHang_NganHang", "NganHang").Value;
            }
            set
            {
    			bool stopChanging = false;
    			...
    			if(!stopChanging)
    			{
    				((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<NganHang>("ERPModel.FK_TaiKhoanNganHang_NganHang", "NganHang").Value = value;
        ...
        public EntityReference<NganHang> NganHang1Reference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<NganHang>("ERPModel.FK_TaiKhoanNganHang_NganHang", "NganHang");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<NganHang>("ERPModel.FK_TaiKhoanNganHang_NganHang", "NganHang", value);
                }
            }
        }
