<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GiayXacNhanCanBoVienChucTruong.aspx.cs" Inherits="HRMChamCong.Views.ThongTinNhanSu.GiayXacNhanCanBoVienChucTruong" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $.ajax({
                type: 'POST',
                url: '/Services/ChamCongService.asmx/ModuleThongTinNhanSu_GiayXacNhanCanBoVienChucTruong',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
                success: function (result) {
                    var data = $.parseJSON(result.d);
                    ko.applyBindings(data, $("#CanBo")[0]);
                }
            });
        })
...
<body>
    <div style="margin: 0 auto;" id="CanBo">
        <div class="header">
        ...
        <div class="content">
            <h2 style="text-align: center; font-weight: bold;">GIẤY XÁC NHẬN CÁN BỘ VIÊN CHỨC TRƯỜNG</h2>
            <div style="float: left; width: 100%; padding: 5px 0px 5px 0px">
                <div style="float: left; width: 60%;">
                    <span style="width: 140px; float: left">Họ và tên:</span>
