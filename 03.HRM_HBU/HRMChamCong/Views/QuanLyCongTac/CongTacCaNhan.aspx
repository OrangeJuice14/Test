...
{ Id: 2, Name: "Buổi chiều" }
        ...
        ViewModel.prototype = {
            ...
            validateFromDateToDate: function (khaiBaoCongTacOid, tuNgay, denNgay, buoi, webUserId) {
                var check;
                $.ajax({
                    type: 'POST',
            ...
            save: function () {
                var self = this;
                if (!self.validateFromDateToDate(null, $('#jqxFromDate').jqxDateTimeInput('getDate'), $('#jqxToDate').jqxDateTimeInput('getDate'), self.buoiSelected(), '<%#HttpContext.Current.Session[HRMChamCong.Helper.SessionKey.UserId.ToString()]%>')) {
        ...
        $(function () {
            ...
            $("#popupWindow").jqxWindow({
                width: 450, theme: "darkBlue", height: 400, resizable: true, isModal: false, autoOpen: false, cancelButton: $("#Cancel")
            });
        });
    </script>
    <style type="text/css">
            ...
            <div style="overflow: hidden;">
                <table>
                    <tr>
                        ...
                        <td align="left">
                            <textarea id="txtContent" style="width: 300px; height: 180px;"></textarea></td>
                    </tr>
                    <tr>
