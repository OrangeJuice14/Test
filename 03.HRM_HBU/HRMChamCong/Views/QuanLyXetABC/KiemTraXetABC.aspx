    ...
    <script type="text/javascript">
        ...
        function ViewModel(datagrid) {
            var daXetAbc = [
               ...
               { Id: false, Name: "Chưa chốt" },
               { Id: true, Name: "Đã chốt" }
            ];
            var self = this;
            self.returnData = [];
            ...
            $.ajax({
                type: 'POST',
                url: '/Services/ChamCongService.asmx/KiemTraPhongBanChot_Find',
                async: false,
                contentType: "application/json; charset=utf-8",
                data: ko.toJSON({
                    thang: self.month(),
            ...
            self.datagrid.jqxGrid(
                {
                    ...
                    columns: [
                        ...
                        { text: 'Đơn vị', datafield: 'TenBoPhan', width: 610, align: 'center' },
