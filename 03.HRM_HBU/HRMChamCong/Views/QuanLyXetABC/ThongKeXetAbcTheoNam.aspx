...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        ViewModel.prototype = {
            ...
            //        }
            //    });
            //    var str = '<table width="680" border="1" cellspacing="0" cellpadding="0">';
            ...
            //    str += '<th style="padding:5px;width: 45px">Loại C</th>';
            //    str += '<th style="padding:5px;width: 45px">Loại D</th>';
            //    str += '<th style="padding:5px;width: 45px">Không xét</th>';
            //    str += '</tr>';
            ...
            //        str += '<td style="text-align:center;padding:5px;">' + item.TenPhongBan + '</td>';
            //        str += '<td style="text-align:center;padding:5px;">' + item.LoaiA + '</td>';
            //        str += '<td style="text-align:center;padding:5px;">' + item.LoaiB + '</td>';
            //        str += '<td style="text-align:center;padding:5px;">' + item.LoaiC + '</td>';
            //        str += '<td style="text-align:center;padding:5px;">' + item.LoaiD + '</td>';
            //        str += '<td style="text-align:center;padding:5px;">' + item.LoaiKhongXet + '</td>';
            //        str += '</tr>';
            //    };
            //    str += '</table>';
            ...
            //        '<div style="text-align:center;font-weight:bold;font-size:16px;width:680px;padding:10px 0px 0px 0px">DANH SÁCH THỐNG KÊ XÉT ABC THEO NĂM­ ' + this.year() + '</div>' +
            ...
            print: function () {
                ...
                var self = this;
                var str = '<table border="1" width="900" cellspacing="0" cellpadding="0">';
                str += '<tr style="font-size:13px;">';
                ...
                pageContent =
                    ...
                    '<div style="width:900px; text-align:center;"><img src="/Images/logo_UIH.png" width="150"><img src="/Images/name_school.png" width="400" ><br/></div>' +  
                    '<div style="text-align:center;font-weight:bold;font-size:16px;width:900px;padding:10px 0px 0px 0px">DANH SÁCH THỐNG KÊ XÉT ABC THEO NĂM­ ' + this.year() + '</div>' +
