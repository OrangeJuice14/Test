<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="SuaGiangVienThinhGiang.aspx.cs" Inherits="HRMChamCong.Views.QuanLyThinhGiang.SuaGiangVienThinhGiang" %>
...
<asp:content id="Content1" contentplaceholderid="head" runat="server">
    <script>
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    for (var i in dataList) {
                        ...
                        if (obj != null) {
                            var data = obj;
                            //Lưu vết kiểm tra mã quản lý
                            OidThinhGiang = data.Oid;
                            //
                            self.Oid(data.Oid);
                            self.MaQuanLy = ko.observable(data.MaQuanLy);
                            self.Ho = ko.observable(data.Ho);
                            self.Ten = ko.observable(data.Ten);
                            self.GioiTinh = ko.observable(data.GioiTinh);
                            self.NgaySinh = ko.observable(data.NgaySinh);
                            self.CMND = ko.observable(data.CMND);
                            self.NgayCap = ko.observable(data.NgayCap);
                            self.NoiCap = ko.observable(data.NoiCap);
                            self.NgayVaoCoQuan = ko.observable(data.NgayVaoCoQuan);
                            self.DonViCongTac = ko.observable(data.DonViCongTac);
                            self.HopDongHienTai = ko.observable(data.HopDongHienTai);
                            self.Email = ko.observable(data.Email);
                            self.DienThoaiDiDong = ko.observable(data.DienThoaiDiDong);
                            self.DienThoaiNhaRieng = ko.observable(data.DienThoaiNhaRieng);
                            self.TinhTrang = ko.observable(data.TinhTrang);
                            //
                            self.BoPhan = ko.observable(data.BoPhan);
                            self.QuocGia = ko.observable(data.QuocGia);
                            self.TonGiao = ko.observable(data.TonGiao);
                            self.DanToc = ko.observable(data.DanToc);
                            self.TinhTrangHonNhan = ko.observable(data.TinhTrangHonNhan);
                            //Nơi sinh
                            self.QuocGia_NoiSinh = ko.observable(data.QuocGia_NoiSinh);
                            self.TinhThanh_NoiSinh = ko.observable(data.TinhThanh_NoiSinh);
                            self.QuanHuyen_NoiSinh = ko.observable(data.QuanHuyen_NoiSinh);
                            self.XaPhuong_NoiSinh = ko.observable(data.XaPhuong_NoiSinh);
                            self.SoNha_NoiSinh = ko.observable(data.SoNha_NoiSinh);
                            self.Oid_NoiSinh = ko.observable(data.Oid_NoiSinh);
                            //Địa chỉ thường trú
                            self.QuocGia_DCTT = ko.observable(data.QuocGia_DCTT);
                            self.TinhThanh_DCTT = ko.observable(data.TinhThanh_DCTT);
                            self.QuanHuyen_DCTT = ko.observable(data.QuanHuyen_DCTT);
                            self.XaPhuong_DCTT = ko.observable(data.XaPhuong_DCTT);
                            self.SoNha_DCTT = ko.observable(data.SoNha_DCTT);
                            self.Oid_DCTT = ko.observable(data.Oid_DCTT);
                            //Nơi ở hiện nay
                            self.QuocGia_NOHN = ko.observable(data.QuocGia_NOHN);
                            self.TinhThanh_NOHN = ko.observable(data.TinhThanh_NOHN);
                            self.QuanHuyen_NOHN = ko.observable(data.QuanHuyen_NOHN);
                            self.XaPhuong_NOHN = ko.observable(data.XaPhuong_NOHN);
                            self.SoNha_NOHN = ko.observable(data.SoNha_NOHN);
                            self.Oid_NOHN = ko.observable(data.Oid_NOHN);
                        }
                    }
                    //
                }
                ...
                success: function (result) {
                    ...
                    for (var i in dataList) {
                        ...
                        if (obj != null) {
                            var data = obj;
                            //
                            self.Oid = ko.observable(obj.Oid);
                            self.Oid_NVTD = ko.observable(obj.Oid_NVTD);
                            self.TrinhDoVanHoa = ko.observable(obj.TrinhDoVanHoa);
                            self.TrinhDoTinHoc = ko.observable(obj.TrinhDoTinHoc);
                            self.HocHam = ko.observable(obj.HocHam);
                            self.TrinhDoChuyenMon = ko.observable(obj.TrinhDoChuyenMon);
                            self.TruongDaoTao = ko.observable(obj.TruongDaoTao);
                            self.ChuyenNganhDaoTao = ko.observable(obj.ChuyenNganhDaoTao);
                            self.HinhThucDaoTao = ko.observable(obj.HinhThucDaoTao);
                            self.NamTotNghiep = ko.observable(obj.NamTotNghiep);
                            self.NgoaiNgu = ko.observable(obj.NgoaiNgu);
                            self.TrinhDoNgoaiNgu = ko.observable(obj.TrinhDoNgoaiNgu);
                        }
                    }
                }
            });
                ...
                success: function (result) {
                    ...
                    for (var i in dataList) {
                        ...
                        if (obj != null) {
                            ...
                            //
                            self.Oid = ko.observable(obj.Oid);
                            self.Oid_NVTTL = ko.observable(obj.Oid_NVTTL);
                            self.Oid_TKNH = ko.observable(obj.Oid_TKNH);
                            self.MaSoThue = ko.observable(obj.MaSoThue);
                            self.CoQuanThue = ko.observable(obj.CoQuanThue);
                            self.SoTaiKhoan = ko.observable(obj.SoTaiKhoan);
                            self.NganHang = ko.observable(obj.NganHang);
                        }
                    }
                }
            });
        ...
        $(document).ready(function () {
            ...
            ko.applyBindings(menuTab, $('#jqxTabs_MenuList_SuaGiangVienThinhGiang')[0]);
            $('#jqxTabs_MenuList_SuaGiangVienThinhGiang').jqxTabs({ width: '100%', theme: 'darkBlue', scrollStep: 500 });
            ...
            $('#jqxTabs_MenuList_SuaGiangVienThinhGiang').on('selected', function (event) {
                var pageIndex = event.args.item;
                var contentDiv = $("#jqxTabs_MenuList_SuaGiangVienThinhGiang .jqx-tabs-content-element")[pageIndex];
                if (contentDiv.id == '')
                    return;
...
<asp:content id="Content2" contentplaceholderid="ContentPlaceHolder1" runat="server">  
     <div id='jqxTabs_MenuList_SuaGiangVienThinhGiang' >
        <ul >
             <!-- ko foreach:menuList -->
