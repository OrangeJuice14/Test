...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function viewModel() {
            ...
            self.kyChamCong = ko.observableArray();
            self.kyChamCongSelected = ko.observable();
            $.ajax({
                type: 'POST',
            ...
            $.ajax({
                type: 'POST',
                url: '/Services/ChamCongService.asmx/KyChamCong_GetAll',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
                success: function (result) {
        ...
        viewModel.prototype = {
            ...
            saveUpdate: function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/Services/ChamCongService.asmx/CapNhatChamCongDonVi',
                    contentType: "application/json; charset=utf-8",
                    data: ko.toJSON({
                        kyChamCong: self.kyChamCongSelected()
                    }),
                    dataType: "json",
                    async: false,
                    success: function (result) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="chamcongnhanh">
        ...
        <div class="formGroup">
            ...
            <select style="width: 150px" data-bind="options: kyChamCong, optionsText: 'TenKyChamCong', optionsValue: 'Oid', value: kyChamCongSelected"></select>
        </div>
        <div class="formGroup">
