...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function viewModel(item) {
            ...
            self.ngayIn = ko.observable();
            self.ngayIn("TP. HCM, ngày " + (new Date().getDate()).toString() + " tháng " + (new Date().getMonth() + 1).toString() + " năm " + (new Date().getFullYear()).toString());
            $.ajax({
                type: 'POST',
    ...
    function Print() {
        ...
        document.getElementById('hinhthucnghi').style.display = "none";
        window.print();
        document.getElementById('print').style.display = "inline";
        document.getElementById('hinhthucnghi').style.display = "inline";
...
<body>
    <div id="chamcong_detail" style="width: 1282px;">
        ...
        <table border="0" style="font-family: Arial, Tahoma; font-size: 11pt; padding: 5px;">
            <tr>
                <td data-bind="attr: { colspan: $root.spanlength }, text: TenPhongBan" style="font-weight: bold; font-size: 14pt;"></td>
            </tr>
            <tr style="height: 30px;">
                <th style="width: 25px;" rowspan="2">STT</th>
                <th style="width: 110px;" rowspan="2">Mã quản lý</th>
            ...
            <tbody data-bind="foreach: items">
                <tr>
                    ...
                    <td style="width: 100px;text-align:center; white-space: nowrap; padding: 5px;" data-bind="text: MaNhanSu"></td>
         ...
         <div style="text-align:center;padding-top:20px;"><input type="button" id="print" value="In Bảng chấm công" onclick="Print()" /></div>
        <div style="width: 100%;" align="left" id="hinhthucnghi">
        ...
        <table style="border: 0px; width: 100%; font-size: 11pt;">
            <tbody>
                <tr>
                    ...
                    <td style="border: 0px; height: 10px"></td>
                    <td style="border: 0px; text-align:center" data-bind="text: ngayIn "></td>
                </tr>
                <tr>
