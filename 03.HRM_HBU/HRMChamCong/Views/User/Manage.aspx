<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="HRMChamCong.Views.User.Manage" %>
    ...
    <script type="text/javascript">
        function ViewModel_Detail() {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    var id1 = "05A1BF24-BD1C-455F-96F6-7C4237F4659E";
                    id1 = id1.toLowerCase();
                    var id2 = "0A3AAE02-EF4B-4799-8726-B80B0F42DB51";
                    id2 = id2.toLowerCase();
                    self.accountList.remove(function (obj) { return obj.ID == id1 });
                    self.accountList.remove(function (obj) { return  obj.ID == id2 });
                }
            });
        ...
        function ViewModel(datagrid) {
            ...
            self.source =
            {
                ...
                url: "/Services/ChamCongService.asmx/GetList_QuanLyUserKhacQuanTri",
                ...
                columns: [
                    {
                        text: 'STT', columntype: 'number', width: 35, editable: false, cellsrenderer: function (row, column, value) {
                            ...
                            return "<div style='text-align:center;margin-top:12px;'>" + (value + 1) + "</div>";
                        }
                    },
                    { text: 'Mã nhân sự', datafield: 'MaNhanSu', width: 100, align: 'center' },
                    {
                        ...
                        cellsrenderer: function (row, columnfield, cellvalue, defaulthtml, columnproperties) {
                            ...
                            return "<div style='padding-left:5px;margin-top:12px;'><a href='/Views/User/Detail.aspx?Id=" + item.Oid + "' style=''>" + cellvalue + "</a></div>";
                        }
                    },
        ...
        ViewModel.prototype = {
            createNew: function () {
                $.get('/Views/User/AddNew.aspx', function (data) {
