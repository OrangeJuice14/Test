...
namespace HRMWeb_Business.Model
{
    ...
    /// </summary>
    [EdmComplexTypeAttribute(NamespaceName="ERPModel", Name="spd_Web1_HopDong_BUH_Result")]
    [DataContractAttribute(IsReference=true)]
    [Serializable()]
    public partial class spd_Web1_HopDong_BUH_Result : ComplexObject
    {
        #region Factory Method
    
        /// <summary>
        /// Create a new spd_Web1_HopDong_BUH_Result object.
        /// </summary>
        /// <param name="mucLuongDuocHuong">Initial value of the MucLuongDuocHuong property.</param>
        public static spd_Web1_HopDong_BUH_Result Createspd_Web1_HopDong_BUH_Result(string mucLuongDuocHuong)
        {
            spd_Web1_HopDong_BUH_Result spd_Web1_HopDong_BUH_Result = new spd_Web1_HopDong_BUH_Result();
            spd_Web1_HopDong_BUH_Result.MucLuongDuocHuong = mucLuongDuocHuong;
            return spd_Web1_HopDong_BUH_Result;
        }
