...
namespace HRMWeb_Business.Model.MapObjectCreator
{
    ...
    public partial class Mdl_CC_ChamCongTheoNgay
    {
    	...
    	public Mdl_CC_ChamCongTheoNgay()
        {
            ...
            this.CC_QuanLyViPham_New = new HashSet<Mdl_CC_QuanLyViPham_New>();
        }*/
    	...
    	[DataMember]
        public Nullable<bool> NguoiDungChinhSua { get; set; }
    	[DataMember]
        public Nullable<System.Guid> IDWebUsers_ChinhSua { get; set; }
    	[DataMember]
    	...
    	//[DataMember]
        //public virtual ICollection<Mdl_CC_QuanLyViPham_New> CC_QuanLyViPham_New { get; set; }
    }
}
