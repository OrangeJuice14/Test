...
namespace HRMWeb_Service
{
    ...
    Guid idNhanVien, Guid kyTinhLuong)
        ...
        public DTO_BangLuongBUH_LuongNganSach BangLuong_BUH_LuongNganSach(String publicKey, String token, Guid idNhanVien, int nam, int thang)
        {
        ...
        public DTO_BangLuongBUH_LuongTamUng BangLuong_BUH_LuongTamUng(String publicKey, String token, Guid idNhanVien, int nam, int thang)
        {
        ...
        public String BangLuong_BUH_LuongNganSach_Json(String publicKey, String token, Guid idNhanVien, int nam, int thang)
        {//DANG SD
            DTO_BangLuongBUH_LuongNganSach obj = BangLuong_BUH_LuongNganSach(publicKey, token, idNhanVien, nam, thang);
            String json = JsonConvert.SerializeObject(obj);
            return json;
        }
        public String BangLuong_BUH_LuongTamUng_Json(String publicKey, String token, Guid idNhanVien, int nam, int thang)
        {//DANG SD
            DTO_BangLuongBUH_LuongTamUng obj = BangLuong_BUH_LuongTamUng(publicKey, token, idNhanVien, nam, thang);
            String json = JsonConvert.SerializeObject(obj);
            return json;
        }
        #endregion
    ...
    Guid idNhanVien, Guid kyTinhLuong, byte? loaiLuong)
        ...
        public DTO_ModuleThongTinNhanSu_SoYeuLyLich ModuleThongTinNhanSu_SoYeuLyLich_BUH(String publicKey, String token, Guid idNhanVien)
        {
            if (Helper.TrustTest(publicKey, token))
            {

                DTO_ModuleThongTinNhanSu_SoYeuLyLich obj = WebUser_Factory.New().Context.spd_Web1_SoYeuLyLich_BUH(idNhanVien).SingleOrDefault().Map<DTO_ModuleThongTinNhanSu_SoYeuLyLich>();
                return obj;
            }
            else
            {
        ...
        public String ModuleThongTinNhanSu_SoYeuLyLich_BUH_Json(String publicKey, String token, Guid idNhanVien)
        {//DANG SD
            DTO_ModuleThongTinNhanSu_SoYeuLyLich obj = ModuleThongTinNhanSu_SoYeuLyLich_BUH(publicKey, token, idNhanVien);
            String json = JsonConvert.SerializeObject(obj);
            return json;
        }
        ...
        public DTO_ModuleThongTinNhanSu_THONGTINLUONGNHANVIEN ModuleThongTinNhanSu_THONGTINLUONGNHANVIEN_BUH(String publicKey, String token, Guid idNhanVien)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                var factory = WebUser_Factory.New();
                ...
                try
                {
                    obj.DanhSach_NguoiPhuThuoc = factory.Context.spd_Web1_NguoiPhuThuoc_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_NguoiPhuThuoc>();
                }
                catch (Exception) { }
                try
                {
                    obj.DanhSach_TaiKhoanNganHang = factory.Context.spd_Web1_TaiKhoanNganHang_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_TaiKhoanNganHang>();
                }
                catch (Exception) { }
                try
                {
                    obj.ThongTinLuong = factory.Context.spd_Web1_ThongTinLuong_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_ThongTinLuong>().SingleOrDefault();
                }
                catch (Exception) { }
                return obj;
            }
        ...
        public String ModuleThongTinNhanSu_THONGTINLUONGNHANVIEN_BUH_Json(String publicKey, String token, Guid idNhanVien)
        {//DANG SD
            DTO_ModuleThongTinNhanSu_THONGTINLUONGNHANVIEN obj = ModuleThongTinNhanSu_THONGTINLUONGNHANVIEN_BUH(publicKey, token, idNhanVien);
            String json = JsonConvert.SerializeObject(obj);
            return json;
        }
        #endregion
        ...
        public DTO_ModuleThongTinNhanSu_TRINHDOCHUYENMONNHANVIEN ModuleThongTinNhanSu_TRINHDOCHUYENMONNHANVIEN_BUH(String publicKey, String token, Guid idNhanVien)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                var factory = WebUser_Factory.New();
                ...
                try
                {
                    obj.DanhSach_VanBang = factory.Context.spd_Web1_VanBang_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_VanBang>();
                }
                catch (Exception) { }

                try
                {
                    obj.DanhSach_ChungChi = factory.Context.spd_Web1_ChungChi_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_ChungChi>();
                }
                catch (Exception) { }
                ...
                {
                    obj.DanhSach_NgoaiNgu =
                        factory.Context.spd_Web1_NgoaiNgu_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_NgoaiNgu>();
                }
                catch (Exception) { }
                try
                {
                    obj.TrinhDoChuyenMon = factory.Context.spd_Web1_TrinhDoChuyenMon_BUH(idNhanVien)
                            .Map<DTO_ModuleThongTinNhanSu_TrinhDoChuyenMon>()
                            .SingleOrDefault();
                }
                catch (Exception) { }
        ...
        public String ModuleThongTinNhanSu_TRINHDOCHUYENMONNHANVIEN_BUH_Json(String publicKey, String token, Guid idNhanVien)
        {//DANG SD
            DTO_ModuleThongTinNhanSu_TRINHDOCHUYENMONNHANVIEN obj = ModuleThongTinNhanSu_TRINHDOCHUYENMONNHANVIEN_BUH(publicKey, token, idNhanVien);
            String json = JsonConvert.SerializeObject(obj);
            return json;
        }
        #endregion
        ...
        public DTO_ModuleThongTinNhanSu_HOPDONGLAODONG ModuleThongTinNhanSu_HOPDONGLAODONG_BUH(String publicKey, String token, Guid idNhanVien)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                var factory = WebUser_Factory.New();
                ...
                {
                    obj.HopDong =
                        factory.Context.spd_Web1_HopDong_BUH(idNhanVien)
                            .Map<DTO_ModuleThongTinNhanSu_HopDong>()
                            .SingleOrDefault();
                }
                catch (Exception) { }
                ...
                {
                    obj.DanhSach_HopDongDaKy =
                        factory.Context.spd_Web1_HopDongDaKy_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_HopDongDaKy>();
                }
                catch (Exception) { }
                return obj;
            }
        ...
        public String ModuleThongTinNhanSu_HOPDONGLAODONG_BUH_Json(String publicKey, String token, Guid idNhanVien)
        {//DANG SD
            DTO_ModuleThongTinNhanSu_HOPDONGLAODONG obj = ModuleThongTinNhanSu_HOPDONGLAODONG_BUH(publicKey, token, idNhanVien);
            String json = JsonConvert.SerializeObject(obj);
            return json;
        }
        ...
        public IEnumerable<DTO_ModuleThongTinNhanSu_QuanHeGiaDinh> ModuleThongTinNhanSu_QuanHeGiaDinh_BUH(String publicKey, String token, Guid idNhanVien)
        {
            if (Helper.TrustTest(publicKey, token))
            {

                IEnumerable<DTO_ModuleThongTinNhanSu_QuanHeGiaDinh> objList = WebUser_Factory.New().Context.spd_Web1_QuanHeGiaDinh_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_QuanHeGiaDinh>();
                return objList;
            }
            else
            {
        ...
        public String ModuleThongTinNhanSu_QuanHeGiaDinh_BUH_Json(String publicKey, String token, Guid idNhanVien)
        {//DANG SD
            IEnumerable<DTO_ModuleThongTinNhanSu_QuanHeGiaDinh> objList = ModuleThongTinNhanSu_QuanHeGiaDinh_BUH(publicKey, token, idNhanVien);
            String json = JsonConvert.SerializeObject(objList);
            return json;
        }
        ...
        public IEnumerable<DTO_ModuleThongTinNhanSu_DienBienLuong> ModuleThongTinNhanSu_DienBienLuong_BUH(String publicKey, String token, Guid idNhanVien)
        {
            if (Helper.TrustTest(publicKey, token))
            {

                IEnumerable<DTO_ModuleThongTinNhanSu_DienBienLuong> objList = WebUser_Factory.New().Context.spd_Web1_DienBienLuong_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_DienBienLuong>();
                return objList;
            }
            else
            {
        ...
        public String ModuleThongTinNhanSu_DienBienLuong_BUH_Json(String publicKey, String token, Guid idNhanVien)
        {//DANG SD
            IEnumerable<DTO_ModuleThongTinNhanSu_DienBienLuong> objList = ModuleThongTinNhanSu_DienBienLuong_BUH(publicKey, token, idNhanVien);
            String json = JsonConvert.SerializeObject(objList);
            return json;
        }
        #endregion
        ...
        public IEnumerable<DTO_ModuleThongTinNhanSu_LichSuBanThan> ModuleThongTinNhanSu_LichSuBanThan_BUH(String publicKey, String token, Guid idNhanVien)
        {
            if (Helper.TrustTest(publicKey, token))
            {

                IEnumerable<DTO_ModuleThongTinNhanSu_LichSuBanThan> objList = WebUser_Factory.New().Context.spd_Web1_LichSuBanThan_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_LichSuBanThan>();
                return objList;
            }
            else
            {
        ...
        public String ModuleThongTinNhanSu_LichSuBanThan_BUH_Json(String publicKey, String token, Guid idNhanVien)
        {//DANG SD
            IEnumerable<DTO_ModuleThongTinNhanSu_LichSuBanThan> objList = ModuleThongTinNhanSu_LichSuBanThan_BUH(publicKey, token, idNhanVien);
            String json = JsonConvert.SerializeObject(objList);
            return json;
        }
        #endregion
        ...
        public IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhCongTac> ModuleThongTinNhanSu_QuaTrinhCongTac_BUH(String publicKey, String token, Guid idNhanVien)
        {
            if (Helper.TrustTest(publicKey, token))
            {

                IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhCongTac> objList = WebUser_Factory.New().Context.spd_Web1_QuaTrinhCongTac_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_QuaTrinhCongTac>();
                return objList;
            }
            else
            {
        ...
        public String ModuleThongTinNhanSu_QuaTrinhCongTac_BUH_Json(String publicKey, String token, Guid idNhanVien)
        {//DANG SD
            IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhCongTac> objList = ModuleThongTinNhanSu_QuaTrinhCongTac_BUH(publicKey, token, idNhanVien);
            String json = JsonConvert.SerializeObject(objList);
            return json;
        }
        ...
        public IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhDaoTao> ModuleThongTinNhanSu_QuaTrinhDaoTao_BUH(String publicKey, String token, Guid idNhanVien)
        {
            if (Helper.TrustTest(publicKey, token))
            {

                IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhDaoTao> objList = WebUser_Factory.New().Context.spd_Web1_QuaTrinhDaoTao_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_QuaTrinhDaoTao>();
                return objList;
            }
            else
            {
        ...
        public String ModuleThongTinNhanSu_QuaTrinhDaoTao_BUH_Json(String publicKey, String token, Guid idNhanVien)
        {//DANG SD
            IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhDaoTao> objList = ModuleThongTinNhanSu_QuaTrinhDaoTao_BUH(publicKey, token, idNhanVien);
            String json = JsonConvert.SerializeObject(objList);
            return json;
        }
        #endregion
        ...
        public IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhBoiDuong> ModuleThongTinNhanSu_QuaTrinhBoiDuong_BUH(String publicKey, String token, Guid idNhanVien)
        {
            if (Helper.TrustTest(publicKey, token))
            {

                IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhBoiDuong> objList = WebUser_Factory.New().Context.spd_Web1_QuaTrinhBoiDuong_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_QuaTrinhBoiDuong>();
                return objList;
            }
            else
            {
        ...
        public String ModuleThongTinNhanSu_QuaTrinhBoiDuong_BUH_Json(String publicKey, String token, Guid idNhanVien)
        {//DANG SD
            IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhBoiDuong> objList = ModuleThongTinNhanSu_QuaTrinhBoiDuong_BUH(publicKey, token, idNhanVien);
            String json = JsonConvert.SerializeObject(objList);
            return json;
        }
        #endregion
        ...
        public IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhBoNhiem> ModuleThongTinNhanSu_QuaTrinhBoNhiem_BUH(String publicKey, String token, Guid idNhanVien)
        {
            if (Helper.TrustTest(publicKey, token))
            {

                IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhBoNhiem> objList = WebUser_Factory.New().Context.spd_Web1_QuaTrinhBoNhiem_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_QuaTrinhBoNhiem>();
                return objList;
            }
            else
            {
        ...
        public String ModuleThongTinNhanSu_QuaTrinhBoNhiem_BUH_Json(String publicKey, String token, Guid idNhanVien)
        {//DANG SD
            IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhBoNhiem> objList = ModuleThongTinNhanSu_QuaTrinhBoNhiem_BUH(publicKey, token, idNhanVien);
            String json = JsonConvert.SerializeObject(objList);
            return json;
        }
        #endregion
        ...
        public IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhDiNuocNgoai> ModuleThongTinNhanSu_QuaTrinhDiNuocNgoai_BUH(String publicKey, String token, Guid idNhanVien)
        {
            if (Helper.TrustTest(publicKey, token))
            {

                IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhDiNuocNgoai> objList = WebUser_Factory.New().Context.spd_Web1_QuaTrinhDiNuocNgoai_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_QuaTrinhDiNuocNgoai>();
                return objList;
            }
            else
            {
        ...
        public String ModuleThongTinNhanSu_QuaTrinhDiNuocNgoai_BUH_Json(String publicKey, String token, Guid idNhanVien)
        {//DANG SD
            IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhDiNuocNgoai> objList = ModuleThongTinNhanSu_QuaTrinhDiNuocNgoai_BUH(publicKey, token, idNhanVien);
            String json = JsonConvert.SerializeObject(objList);
            return json;
        }
        #endregion
        ...
        public IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhKhenThuong> ModuleThongTinNhanSu_QuaTrinhKhenThuong_BUH(String publicKey, String token, Guid idNhanVien)
        {
            if (Helper.TrustTest(publicKey, token))
            {

                IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhKhenThuong> objList = WebUser_Factory.New().Context.spd_Web1_QuaTrinhKhenThuong_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_QuaTrinhKhenThuong>();
                return objList;
            }
            else
            {
        ...
        public String ModuleThongTinNhanSu_QuaTrinhKhenThuong_BUH_Json(String publicKey, String token, Guid idNhanVien)
        {//DANG SD
            IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhKhenThuong> objList = ModuleThongTinNhanSu_QuaTrinhKhenThuong_BUH(publicKey, token, idNhanVien);
            String json = JsonConvert.SerializeObject(objList);
            return json;
        }
        #endregion
        ...
        public IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhKyLuat> ModuleThongTinNhanSu_QuaTrinhKyLuat_BUH(String publicKey, String token, Guid idNhanVien)
        {
            if (Helper.TrustTest(publicKey, token))
            {

                IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhKyLuat> objList = WebUser_Factory.New().Context.spd_Web1_QuaTrinhKyLuat_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_QuaTrinhKyLuat>();
                return objList;
            }
            else
            {
        ...
        public String ModuleThongTinNhanSu_QuaTrinhKyLuat_BUH_Json(String publicKey, String token, Guid idNhanVien)
        {//DANG SD
            IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhKyLuat> objList = ModuleThongTinNhanSu_QuaTrinhKyLuat_BUH(publicKey, token, idNhanVien);
            String json = JsonConvert.SerializeObject(objList);
            return json;
        }
        #endregion
        ...
        public IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhNghienCuuKhoaHoc> ModuleThongTinNhanSu_QuaTrinhNghienCuuKhoaHoc_BUH(String publicKey, String token, Guid idNhanVien)
        {
            if (Helper.TrustTest(publicKey, token))
            {

                IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhNghienCuuKhoaHoc> objList = WebUser_Factory.New().Context.spd_Web1_QuaTrinhNghienCuuKhoaHoc_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_QuaTrinhNghienCuuKhoaHoc>();
                return objList;
            }
            else
            {
        ...
        public String ModuleThongTinNhanSu_QuaTrinhNghienCuuKhoaHoc_BUH_Json(String publicKey, String token, Guid idNhanVien)
        {//DANG SD
            IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhNghienCuuKhoaHoc> objList = ModuleThongTinNhanSu_QuaTrinhNghienCuuKhoaHoc_BUH(publicKey, token, idNhanVien);
            String json = JsonConvert.SerializeObject(objList);
            return json;
        }
        #endregion
        ...
        public IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhThamGiaHoatDongXaHoi> ModuleThongTinNhanSu_QuaTrinhThamGiaHoatDongXaHoi_BUH(String publicKey, String token, Guid idNhanVien)
        {
            if (Helper.TrustTest(publicKey, token))
            {

                IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhThamGiaHoatDongXaHoi> objList = WebUser_Factory.New().Context.spd_Web1_QuaTrinhThamGiaHoatDongXaHoi_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_QuaTrinhThamGiaHoatDongXaHoi>();
                return objList;
            }
            else
            {
        ...
        public String ModuleThongTinNhanSu_QuaTrinhThamGiaHoatDongXaHoi_BUH_Json(String publicKey, String token, Guid idNhanVien)
        {//DANG SD
            IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhThamGiaHoatDongXaHoi> objList = ModuleThongTinNhanSu_QuaTrinhThamGiaHoatDongXaHoi_BUH(publicKey, token, idNhanVien);
            String json = JsonConvert.SerializeObject(objList);
            return json;
        }
        #endregion
        ...
        public IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhThamGiaHoiThao> ModuleThongTinNhanSu_QuaTrinhThamGiaHoiThao_BUH(String publicKey, String token, Guid idNhanVien)
        {
            if (Helper.TrustTest(publicKey, token))
            {

                IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhThamGiaHoiThao> objList = WebUser_Factory.New().Context.spd_Web1_QuaTrinhThamGiaHoiThao_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_QuaTrinhThamGiaHoiThao>();
                return objList;
            }
            else
            {
        ...
        public String ModuleThongTinNhanSu_QuaTrinhThamGiaHoiThao_BUH_Json(String publicKey, String token, Guid idNhanVien)
        {//DANG SD
            IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhThamGiaHoiThao> objList = ModuleThongTinNhanSu_QuaTrinhThamGiaHoiThao_BUH(publicKey, token, idNhanVien);
            String json = JsonConvert.SerializeObject(objList);
            return json;
        }
        #endregion
        ...
        public IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhThamGiaLucLuongVuTrang> ModuleThongTinNhanSu_QuaTrinhThamGiaLucLuongVuTrang_BUH(String publicKey, String token, Guid idNhanVien)
        {
            if (Helper.TrustTest(publicKey, token))
            {

                IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhThamGiaLucLuongVuTrang> objList = WebUser_Factory.New().Context.spd_Web1_QuaTrinhThamGiaLucLuongVuTrang_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_QuaTrinhThamGiaLucLuongVuTrang>();
                return objList;
            }
            else
            {
        ...
        public String ModuleThongTinNhanSu_QuaTrinhThamGiaLucLuongVuTrang_BUH_Json(String publicKey, String token, Guid idNhanVien)
        {//DANG SD
            IEnumerable<DTO_ModuleThongTinNhanSu_QuaTrinhThamGiaLucLuongVuTrang> objList = ModuleThongTinNhanSu_QuaTrinhThamGiaLucLuongVuTrang_BUH(publicKey, token, idNhanVien);
            String json = JsonConvert.SerializeObject(objList);
            return json;
        }
        #endregion
        ...
        public DTO_ModuleThongTinNhanSu_DangVien ModuleThongTinNhanSu_DangVien_BUH(String publicKey, String token, Guid idNhanVien)
        {
            if (Helper.TrustTest(publicKey, token))
            {

                DTO_ModuleThongTinNhanSu_DangVien obj = WebUser_Factory.New().Context.spd_Web1_DangVien_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_DangVien>().SingleOrDefault();
                return obj;
            }
            else
            {
        ...
        public String ModuleThongTinNhanSu_DangVien_BUH_Json(String publicKey, String token, Guid idNhanVien)
        {//DANG SD
            DTO_ModuleThongTinNhanSu_DangVien obj = ModuleThongTinNhanSu_DangVien_BUH(publicKey, token, idNhanVien);
            String json = JsonConvert.SerializeObject(obj);
            return json;
        }
        #endregion
        ...
        public DTO_ModuleThongTinNhanSu_DoanVien ModuleThongTinNhanSu_DoanVien_BUH(String publicKey, String token, Guid idNhanVien)
        {
            if (Helper.TrustTest(publicKey, token))
            {

                DTO_ModuleThongTinNhanSu_DoanVien obj = WebUser_Factory.New().Context.spd_Web1_DoanVien_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_DoanVien>().SingleOrDefault();
                return obj;
            }
            else
            {
        ...
        public String ModuleThongTinNhanSu_DoanVien_BUH_Json(String publicKey, String token, Guid idNhanVien)
        {//DANG SD
            DTO_ModuleThongTinNhanSu_DoanVien obj = ModuleThongTinNhanSu_DoanVien_BUH(publicKey, token, idNhanVien);
            String json = JsonConvert.SerializeObject(obj);
            return json;
        }
        #endregion
        ...
        public DTO_ModuleThongTinNhanSu_CongDoan ModuleThongTinNhanSu_CongDoan_BUH(String publicKey, String token, Guid idNhanVien)
        {
            if (Helper.TrustTest(publicKey, token))
            {

                DTO_ModuleThongTinNhanSu_CongDoan obj = WebUser_Factory.New().Context.spd_Web1_CongDoan_BUH(idNhanVien).Map<DTO_ModuleThongTinNhanSu_CongDoan>().SingleOrDefault();
                return obj;
            }
            else
            {
        ...
        public String ModuleThongTinNhanSu_CongDoan_BUH_Json(String publicKey, String token, Guid idNhanVien)
        {//DANG SD
            DTO_ModuleThongTinNhanSu_CongDoan obj = ModuleThongTinNhanSu_CongDoan_BUH(publicKey, token, idNhanVien);
            String json = JsonConvert.SerializeObject(obj);
            return json;
        }
        #endregion
