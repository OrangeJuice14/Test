...
namespace HRMWebApp.ChamCong.Core.Controllers
{
    public class WebServicesController : Controller
    {
        ...
        public string ThongTinNhanSu_SoYeuLyLich_Json(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_SoYeuLyLich_BUH_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ThongTinNhanSu_THONGTINLUONGNHANVIEN(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_THONGTINLUONGNHANVIEN_BUH_Json(PublicKey, _token, new Guid(webUserId));
            }          
            return json;
        ...
        public string ModuleThongTinNhanSu_TRINHDOCHUYENMONNHANVIEN(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_TRINHDOCHUYENMONNHANVIEN_BUH_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_HOPDONGLAODONG(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_HOPDONGLAODONG_BUH_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        }
        ...
        public string ModuleThongTinNhanSu_QuanHeGiaDinh(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuanHeGiaDinh_BUH_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_DienBienLuong(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_DienBienLuong_BUH_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_LichSuBanThan(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_LichSuBanThan_BUH_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_QuaTrinhDaoTao(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuaTrinhDaoTao_BUH_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_QuaTrinhBoiDuong(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuaTrinhBoiDuong_BUH_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_QuaTrinhBoNhiem(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuaTrinhBoNhiem_BUH_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_QuaTrinhDiNuocNgoai(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuaTrinhDiNuocNgoai_BUH_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_QuaTrinhKhenThuong(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuaTrinhKhenThuong_BUH_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_QuaTrinhKyLuat(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuaTrinhKyLuat_BUH_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_QuaTrinhNghienCuuKhoaHoc(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuaTrinhNghienCuuKhoaHoc_BUH_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_QuaTrinhHoatDongXaHoi(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuaTrinhThamGiaHoatDongXaHoi_BUH_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_QuaTrinhHoiThao(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuaTrinhThamGiaHoiThao_BUH_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_QuaTrinhThamGiaLucLuongVuTrang(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuaTrinhThamGiaLucLuongVuTrang_BUH_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_DangVien(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_DangVien_BUH_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_DoanVien(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_DoanVien_BUH_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_CongDoan(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_CongDoan_BUH_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string ModuleThongTinNhanSu_QuaTrinhCongTac(string webUserId)
        {
            ...
            {
                json = _service.ModuleThongTinNhanSu_QuaTrinhCongTac_BUH_Json(PublicKey, _token, new Guid(webUserId));
            }
            return json;
        ...
        public string BangLuong_BUH_LuongNganSach(string webUserId, int nam, int thang)
        {
            String json = "";
            json=_service.BangLuong_BUH_LuongNganSach_Json(PublicKey, _token, new Guid(webUserId), nam, thang);
            return json;
        }
        public string BangLuong_BUH_LuongTamUng(string webUserId, int nam, int thang)
        {
            String json = "";
            json = _service.BangLuong_BUH_LuongTamUng_Json(PublicKey, _token, new Guid(webUserId), nam, thang);
            return json;
        }
        ...
        // Start Edit By Vinh
        public string NgayLamBuTrongNam_Find(int nam)
        {
            return _service.NgayLamBuTrongNam_Find_Json(PublicKey, _token, nam);
        }
        public ActionResult NgayLamBuTrongNam_Save(String TenNgayLamBu, DateTime TuNgay, DateTime DenNgay, int Nam)
        {
            return _service.NgayLamBuTrongNam_Save(PublicKey, _token, TenNgayLamBu, TuNgay, DenNgay, Nam).ToJSON();
            
        }

        public ActionResult NgayLamBuTrongNam_Delete(string Oid)
        {
            if (Oid != "" && Oid != null)
            {
                return _service.NgayLamBuTrongNam_Delete(PublicKey, _token, new Guid(Oid)).ToJSON();
            }
            return Helper.JsonSucess();
        }
        // End Edit By Vinh
