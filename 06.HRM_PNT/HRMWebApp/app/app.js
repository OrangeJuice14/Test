define(['angularAMD', 'ui-route', 'ui-validate', 'ui-bootstrap', 'kendo', 'ui-bootstrap-tpls', 'angular-material', 'ckeditor', 'angular-sanitize', 'angular.treeview'], function (angularAMD) {
    "use strict";
    agGrid.initialiseAgGridWithAngular1(angular);
    var HRMWebApp = angular.module('HRMWebApp', ['ui.router', 'ui.validate', 'ui.bootstrap', 'kendo.directives', 'ngMaterial', 'ngMessages', 'agGrid', 'ngSanitize', 'angularTreeview']);
    HRMWebApp.factory('principal', ['$rootScope', '$q', '$http', '$timeout',
    ...
    HRMWebApp.config(['$stateProvider', '$urlRouterProvider', '$locationProvider', function ($stateProvider, $urlRouterProvider, $locationProvider) {
        ...
        $stateProvider.state('site', {
            ...
            .state('menuRole', {
                ...
                resolve: resolveController(["app/controllers/kpi/menuRoleController",
                                            "app/controllers/kpi/webGroupController"])
            })
            ...
            .state('KyDanhGia', angularAMD.route({
                ...
                url: '/kpi/KyDanhGia',
                templateUrl: '/app/views/abc/ABC_KyDanhGia/manage.html',
                controller: 'ABC_KyDanhGiaController',
                controllerUrl: 'app/controllers/abc/ABC_KyDanhGiaController'
            }))
            // Bao Cao Danh Gia
            .state('BoDanhGia', angularAMD.route({
                data: {
                    roles: ['kpi/BaoCaoDanhGia']
                },
                url: '/kpi/BaoCaoDanhGia',
                templateUrl: '/app/views/abc/ABC_BaoCaoDanhGia/manage.html',
                controller: 'ABC_BoDanhGiaController',
                controllerUrl: 'app/controllers/abc/ABC_BoDanhGiaController'
            }))
            // Tiêu chí danh gia
            .state('TieuChiDanhGia', angularAMD.route({
                data: {
                    roles: ['kpi/ChiTietDanhGia']
                },
                url: '/kpi/ChiTietDanhGia/:BoDanhGiaId',
                templateUrl: '/app/views/abc/ABC_TieuChiDanhGia/manage.html',
                controller: 'ABC_TieuChiDanhGiaController',
                controllerUrl: 'app/controllers/abc/ABC_TieuChiDanhGiaController'
            }))
            // Tiêu chí danh gia năm
            .state('TieuChiDanhGiaNam', angularAMD.route({
                data: {
                    roles: ['kpi/TieuChiDanhGiaNam']
                },
                url: '/kpi/TieuChiDanhGiaNam/:BoDanhGiaId',
                templateUrl: '/app/views/abc/ABC_TieuChiDanhGia/TieuChiDanhGiaNam/manage.html',
                controller: 'ABC_TieuChiDanhGiaNamController',
                controllerUrl: 'app/controllers/abc/ABC_TieuChiDanhGiaController'
            }))
            // Chi tiet Ket Qua
            .state('ChiTietKetQua', angularAMD.route({
                data: {
                    roles: ['kpi/ChiTietKetQua']
                },
                url: '/kpi/ChiTietKetQua/:KyDanhGiaId',
                templateUrl: '/app/views/abc/ABC_ChiTietKetQua/manage.html',
                controller: 'ABC_ChiTietKetQuaController',
                controllerUrl: 'app/controllers/abc/ABC_ChiTietKetQuaController'
            }))

            // Dong Nghiệp đánh gía
            .state('DanhGiaDongNghiep', angularAMD.route({
                data: {
                    roles: ['kpi/DanhGiaDongNghiep']
                },
                url: '/kpi/DanhGiaDongNghiep/:KyDanhGiaId',
                templateUrl: '/app/views/abc/ABC_ChiTietKetQua/DanhGiaDongNghiep/ChiTietDanhGiaDongNghiep.html',
                controller: 'ABC_DongNghiepDanhGiaController',
                controllerUrl: 'app/controllers/abc/ABC_DongNghiepDanhGiaController'
            }))

            // Ky Tu đánh gía
            .state('KyTuDanhGia', angularAMD.route({
                data: {
                    roles: ['kpi/KyTuDanhGia']
                },
                url: '/kpi/KyTuDanhGia',
                templateUrl: '/app/views/abc/ABC_ChiTietKetQua/KyDanhGia.html',
                controller: 'ABC_KyTuDanhGiaController',
                controllerUrl: 'app/controllers/abc/ABC_ChiTietKetQuaController'
            }))

            // Ky Dong Nghiệp đánh gía
            .state('KyDanhGiaDongNghiep', angularAMD.route({
                data: {
                    roles: ['kpi/KyDanhGiaDongNghiep']
                },
                url: '/kpi/KyDanhGiaDongNghiep',
                templateUrl: '/app/views/abc/ABC_ChiTietKetQua/DanhGiaDongNghiep/index.html',
                controller: 'ABC_KyDongNghiepDanhGiaController',
                controllerUrl: 'app/controllers/abc/ABC_DongNghiepDanhGiaController'
            }))

            // Ky đánh gía cấp dưới
            .state('KyDanhGiaCapDuoi', angularAMD.route({
                data: {
                    roles: ['kpi/KyDanhGiaCapDuoi']
                },
                url: '/kpi/KyDanhGiaCapDuoi',
                templateUrl: '/app/views/abc/ABC_ChiTietKetQua/DanhGiaCapDuoi/index.html',
                controller: 'ABC_KyDanhGiaCapDuoiController',
                controllerUrl: 'app/controllers/abc/ABC_DanhGiaCapDuoiController'
            }))

            // Đánh giá cấp dưới
            .state('DanhGiaCapDuoi', angularAMD.route({
                url: '/kpi/DanhGiaCapDuoi/:KyDanhGiaId',
                templateUrl: '/app/views/abc/ABC_ChiTietKetQua/DanhGiaCapDuoi/DanhGiaCapDuoi.html',
                controller: 'ABC_DanhGiaCapDuoiController',
                controllerUrl: 'app/controllers/abc/ABC_DanhGiaCapDuoiController'
            }))

            // Kết quả đồng nghiệp đánh giá
            .state('KetQuaDongNghiepDanhGia', angularAMD.route({
                url: '/kpi/KetQuaDongNghiepDanhGia/:KetQuaId/:StaffId',
                templateUrl: '/app/views/abc/ABC_ChiTietKetQua/KetQuaDongNghiepDanhGia.html',
                controller: 'ABC_KetQuaDongNghiepDanhGiaController',
                controllerUrl: 'app/controllers/abc/ABC_ChiTietKetQuaController'
            }))
            // Đánh giá cấp trên đánh giá
            .state('KetQuaCapTrenDanhGia', angularAMD.route({
                url: '/kpi/KetQuaCapTrenDanhGia/:KetQuaId',
                templateUrl: '/app/views/abc/ABC_ChiTietKetQua/KetQuaCapTrenDanhGia.html',
                controller: 'ABC_KetQuaCapTrenDanhGiaController',
                controllerUrl: 'app/controllers/abc/ABC_ChiTietKetQuaController'
            }))

    }]);

    HRMWebApp.run(['$rootScope', '$transitions', '$rootElement', 'authorization', 'principal',
        function ($rootScope, $transitions, $rootElement, authorization, principal) {
    ...
    HRMWebApp.config(function ($mdDateLocaleProvider) {
