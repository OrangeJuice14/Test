define(['app/app'], function (app) {
    ...
    app.factory('ratingKPIService', ['$http', '$q', function ($http, $q) {
        ...
        serviceResult.getRatingResultDetail = function (id, agentObjectId, planStaffId, supervisorId,isAdminRating) {
            return $http.get('/Api/resultDetailApi/GetRatingResultDetail?planId=' + id + '&agentObjectId=' + agentObjectId + "&planStaffId=" + planStaffId + "&supervisorId=" + supervisorId + "&isAdminRating="+isAdminRating);
        }
