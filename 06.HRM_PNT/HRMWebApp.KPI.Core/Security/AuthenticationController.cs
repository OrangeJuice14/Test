        ...
        public async Task<ActionResult> Login_Gmail()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (user == null)
                    {
                        string html = "<h3>Email của bạn không tồn tại trong hệ thống! Vui lòng <a style='color: blue' href='https://www.google.com/accounts/Logout?continue=https://appengine.google.com/_ah/logout?continue=http://hrm.buh.edu.vn/Authentication/Login_Gmail'>đăng xuất tài khoản email</a> hiện tại rồi đăng nhập bằng tài khoản email khác.</h3>";
