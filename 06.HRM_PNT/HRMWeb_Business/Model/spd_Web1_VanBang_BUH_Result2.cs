...
namespace HRMWeb_Business.Model
{
    ...
    /// </summary>
    [EdmComplexTypeAttribute(NamespaceName="ERPModel", Name="spd_Web1_VanBang_BUH_Result2")]
    [DataContractAttribute(IsReference=true)]
    [Serializable()]
    public partial class spd_Web1_VanBang_BUH_Result2 : ComplexObject
    {
        #region Factory Method
    
        /// <summary>
        /// Create a new spd_Web1_VanBang_BUH_Result2 object.
        /// </summary>
        /// <param name="xepLoai">Initial value of the XepLoai property.</param>
        public static spd_Web1_VanBang_BUH_Result2 Createspd_Web1_VanBang_BUH_Result2(string xepLoai)
        {
            spd_Web1_VanBang_BUH_Result2 spd_Web1_VanBang_BUH_Result2 = new spd_Web1_VanBang_BUH_Result2();
            spd_Web1_VanBang_BUH_Result2.XepLoai = xepLoai;
            return spd_Web1_VanBang_BUH_Result2;
        }
