...
namespace HRMWeb_Business.Model
{
    ...
    /// </summary>
    [EdmComplexTypeAttribute(NamespaceName="ERPModel", Name="spd_Report_CacThongTinLamCoSoTinhTraLuong_Result1")]
    [DataContractAttribute(IsReference=true)]
    [Serializable()]
    public partial class spd_Report_CacThongTinLamCoSoTinhTraLuong_Result1 : ComplexObject
    {
