...
namespace HRMWeb_Business.Model
{
    ...
    /// </summary>
    [EdmComplexTypeAttribute(NamespaceName="ERPModel", Name="spd_Web1_ChiTietThuNhapKhac_Result")]
    [DataContractAttribute(IsReference=true)]
    [Serializable()]
    public partial class spd_Web1_ChiTietThuNhapKhac_Result : ComplexObject
    {
        #region Factory Method
    
        /// <summary>
        /// Create a new spd_Web1_ChiTietThuNhapKhac_Result object.
        /// </summary>
        ...
        public static spd_Web1_ChiTietThuNhapKhac_Result Createspd_Web1_ChiTietThuNhapKhac_Result(string dienGiai, decimal soTien)
        {
            spd_Web1_ChiTietThuNhapKhac_Result spd_Web1_ChiTietThuNhapKhac_Result = new spd_Web1_ChiTietThuNhapKhac_Result();
            spd_Web1_ChiTietThuNhapKhac_Result.DienGiai = dienGiai;
            spd_Web1_ChiTietThuNhapKhac_Result.SoTien = soTien;
            return spd_Web1_ChiTietThuNhapKhac_Result;
        }
