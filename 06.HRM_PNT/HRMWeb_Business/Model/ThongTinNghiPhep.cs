...
namespace HRMWeb_Business.Model
{
    ...
    public partial class ThongTinNghiPhep : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [EdmScalarPropertyAttribute(EntityKeyProperty=false, IsNullable=true)]
        [DataMemberAttribute()]
        public Nullable<byte> TruNgayDiDuong
        {
            get
            {
            ...
            set
            {
    			Nullable<byte> oldValue =  _truNgayDiDuong;
    			bool stopChanging = false;
        ...
        private Nullable<byte> _truNgayDiDuong;
        partial void On_TruNgayDiDuong_Changing(Nullable<byte> currentValue, ref Nullable<byte> newValue, ref bool stopChanging);
        partial void On_TruNgayDiDuong_Changed(Nullable<byte> oldValue, Nullable<byte> currentValue);
