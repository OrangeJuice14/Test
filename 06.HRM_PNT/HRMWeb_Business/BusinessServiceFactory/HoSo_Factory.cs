...
namespace HRMWeb_Business.BusinessServiceFactory
{
    public class HoSo_Factory : BaseFactory<Entities, HoSo>
    {
        ...
        public HoSo GetDepartmentLeaderByStaffID(Guid oid)
        {
            var staff = (from o in this.ObjectSet
                         where o.Oid == oid
                         select o).SingleOrDefault();
            var result = (from o in this.ObjectSet
                          join department in this.Context.BoPhans on o.NhanVien.BoPhan equals department.Oid
                          join chucvu in this.Context.ChucVus on o.NhanVien.ThongTinNhanVien.ChucVu equals chucvu.Oid
                          where department.Oid == staff.NhanVien.BoPhan && (chucvu.MaQuanLy == "TP" || chucvu.MaQuanLy == "TK")
