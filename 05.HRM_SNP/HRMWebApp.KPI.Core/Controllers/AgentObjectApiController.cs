...
namespace HRMWebApp.KPI.Core.Controllers
{
    public class AgentObjectApiController : ApiController
    {
        ...
        public IEnumerable<KyTinhLuongDTO> GetList_KyTinhLuong()
        {
            ...
            {
                ky.Name = ky.Thang.ToString() + "/" + ky.Nam.ToString();
            }
            return result;
        }
        public IEnumerable<ThongTinTruongDTO> GetList_ThongTinTruong()
        {
            List<ThongTinTruongDTO> result = new List<ThongTinTruongDTO>();
            KyTinhLuong_Factory factory = KyTinhLuong_Factory.New();
            result = factory.GetListThongTinTruong().Map<ThongTinTruongDTO>();
            return result;
        }
