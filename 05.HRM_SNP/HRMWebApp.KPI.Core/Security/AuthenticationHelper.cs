        ...
        public static ApplicationUser GetUserById(Guid webUserId, string UserName)
        {
            ...
            SessionManager.DoWork(session =>
            {
                ...
                if (webUser.StaffInfo != null)
                {
                    ...
                    if (staff != null)
                    {
                        result = new ApplicationUser() { Id = staff.Id.ToString(), UserId = webUser.Id.ToString(), ThongTinNhanVien = webUser.Id.ToString(), UserName = UserName, HoVaTen = staff.StaffProfile.Name, WebGroupId = webUser.WebGroupId.ToString() };
                    }
                }
                else
                {
