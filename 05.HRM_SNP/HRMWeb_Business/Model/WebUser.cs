...
namespace HRMWeb_Business.Model
{
    ...
    public partial class WebUser : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_WebUser_Department_WebUsers", "WebUser_Department")]
        public EntityCollection<WebUser_Department> WebUser_Department
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<WebUser_Department>("ERPModel.FK_WebUser_Department_WebUsers", "WebUser_Department");
            }
            set
            {
                if ((value != null))
                {
    				...
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<WebUser_Department>("ERPModel.FK_WebUser_Department_WebUsers", "WebUser_Department", value);
