...
namespace HRMWeb_Business.Model
{
    ...
    public partial class CC_KyChamCong : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_CC_KyChamCong_CompanyInfo", "CompanyInfo")]
        public CompanyInfo CompanyInfo1
        {//test
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<CompanyInfo>("ERPModel.FK_CC_KyChamCong_CompanyInfo", "CompanyInfo").Value;
            }
            set
            {
    			bool stopChanging = false;
    			...
    			if(!stopChanging)
    			{
    				((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<CompanyInfo>("ERPModel.FK_CC_KyChamCong_CompanyInfo", "CompanyInfo").Value = value;
        ...
        public EntityReference<CompanyInfo> CompanyInfo1Reference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<CompanyInfo>("ERPModel.FK_CC_KyChamCong_CompanyInfo", "CompanyInfo");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<CompanyInfo>("ERPModel.FK_CC_KyChamCong_CompanyInfo", "CompanyInfo", value);
                }
            }
        }
