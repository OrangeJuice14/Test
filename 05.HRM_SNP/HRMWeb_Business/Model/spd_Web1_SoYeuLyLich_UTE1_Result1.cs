...
namespace HRMWeb_Business.Model
{
    ...
    /// </summary>
    [EdmComplexTypeAttribute(NamespaceName="ERPModel", Name="spd_Web1_SoYeuLyLich_UTE1_Result1")]
    [DataContractAttribute(IsReference=true)]
    [Serializable()]
    public partial class spd_Web1_SoYeuLyLich_UTE1_Result1 : ComplexObject
    {
        #region Factory Method
    
        /// <summary>
        /// Create a new spd_Web1_SoYeuLyLich_UTE1_Result1 object.
        /// </summary>
        ...
        /// <param name="congViecTuyenDung">Initial value of the CongViecTuyenDung property.</param>
        /// <param name="chucVuKiemNhiem">Initial value of the ChucVuKiemNhiem property.</param>
        /// <param name="chucVuCaoNhatDaQua">Initial value of the ChucVuCaoNhatDaQua property.</param>
        public static spd_Web1_SoYeuLyLich_UTE1_Result1 Createspd_Web1_SoYeuLyLich_UTE1_Result1(string gioiTinh, string hinhThucTuyenDung, string congViecTuyenDung, string chucVuKiemNhiem, string chucVuCaoNhatDaQua)
        {
            spd_Web1_SoYeuLyLich_UTE1_Result1 spd_Web1_SoYeuLyLich_UTE1_Result1 = new spd_Web1_SoYeuLyLich_UTE1_Result1();
            spd_Web1_SoYeuLyLich_UTE1_Result1.GioiTinh = gioiTinh;
            spd_Web1_SoYeuLyLich_UTE1_Result1.HinhThucTuyenDung = hinhThucTuyenDung;
            spd_Web1_SoYeuLyLich_UTE1_Result1.CongViecTuyenDung = congViecTuyenDung;
            spd_Web1_SoYeuLyLich_UTE1_Result1.ChucVuKiemNhiem = chucVuKiemNhiem;
            spd_Web1_SoYeuLyLich_UTE1_Result1.ChucVuCaoNhatDaQua = chucVuCaoNhatDaQua;
            return spd_Web1_SoYeuLyLich_UTE1_Result1;
        }
    ...
    #region Primitive Properties
        ...
        public string CongViecTuyenDung
        {
            ...
            set
            {
    			...
    			if(!stopChanging)
    			{
    				_congViecTuyenDung = StructuralObject.SetValidValue(value, false);
        ...
        public string ChucVuKiemNhiem
        {
            ...
            set
            {
    			...
    			if(!stopChanging)
    			{
    				_chucVuKiemNhiem = StructuralObject.SetValidValue(value, false);
        ...
        public string ChucVuCaoNhatDaQua
        {
            ...
            set
            {
    			...
    			if(!stopChanging)
    			{
    				_chucVuCaoNhatDaQua = StructuralObject.SetValidValue(value, false);
        ...
        [EdmScalarPropertyAttribute(EntityKeyProperty=false, IsNullable=true)]
        [DataMemberAttribute()]
        public Nullable<int> NgayVaoNganhGiaoDuc
        {
            get
            {
            ...
            set
            {
    			Nullable<int> oldValue =  _ngayVaoNganhGiaoDuc;
    			bool stopChanging = false;
        ...
        private Nullable<int> _ngayVaoNganhGiaoDuc;
        partial void On_NgayVaoNganhGiaoDuc_Changing(Nullable<int> currentValue, ref Nullable<int> newValue, ref bool stopChanging);
        partial void On_NgayVaoNganhGiaoDuc_Changed(Nullable<int> oldValue, Nullable<int> currentValue);
