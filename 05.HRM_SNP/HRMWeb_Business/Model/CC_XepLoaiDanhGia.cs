...
namespace HRMWeb_Business.Model
{
    ...
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="ERPModel", Name="CC_XepLoaiDanhGia")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class CC_XepLoaiDanhGia : ERP_Core.BaseEntityObject//EntityObject
    {
    	static CC_XepLoaiDanhGia()
    	{
        ...
        /// <summary>
        /// Create a new CC_XepLoaiDanhGia object.
        /// </summary>
        /// <param name="oid">Initial value of the Oid property.</param>
        public static CC_XepLoaiDanhGia CreateCC_XepLoaiDanhGia(System.Guid oid)
        {
            CC_XepLoaiDanhGia cC_XepLoaiDanhGia = new CC_XepLoaiDanhGia();
            cC_XepLoaiDanhGia.Oid = oid;
            return cC_XepLoaiDanhGia;
        }
        ...
        public string TenXepLoai
        {
            ...
            set
            {
    			string oldValue =  _tenXepLoai;
    			bool stopChanging = false;
                On_TenXepLoai_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("TenXepLoai");
    			if(!stopChanging)
    			{
    				_tenXepLoai = StructuralObject.SetValidValue(value, true);
    				ReportPropertyChanged("TenXepLoai");
    				On_TenXepLoai_Changed(oldValue, _tenXepLoai);//\\
    			}
            }
        }
    	public static String TenXepLoai_PropertyName { get { return "TenXepLoai"; } }
        private string _tenXepLoai;
        partial void On_TenXepLoai_Changing(string currentValue, ref string newValue, ref bool stopChanging);
        partial void On_TenXepLoai_Changed(string oldValue, string currentValue);
        ...
        public Nullable<decimal> HSXL
        {
            ...
            set
            {
    			Nullable<decimal> oldValue =  _hSXL;
    			bool stopChanging = false;
                On_HSXL_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("HSXL");
    			if(!stopChanging)
    			{
    				_hSXL = StructuralObject.SetValidValue(value);
    				ReportPropertyChanged("HSXL");
    				On_HSXL_Changed(oldValue, _hSXL);//\\
    			}
            }
        }
    	public static String HSXL_PropertyName { get { return "HSXL"; } }
        private Nullable<decimal> _hSXL;
        partial void On_HSXL_Changing(Nullable<decimal> currentValue, ref Nullable<decimal> newValue, ref bool stopChanging);
        partial void On_HSXL_Changed(Nullable<decimal> oldValue, Nullable<decimal> currentValue);
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_CC_ChiTietChamCong_XepLoaiCanBo", "CC_ChiTietChamCong")]
        public EntityCollection<CC_ChiTietChamCong> CC_ChiTietChamCong
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<CC_ChiTietChamCong>("ERPModel.FK_CC_ChiTietChamCong_XepLoaiCanBo", "CC_ChiTietChamCong");
            }
            set
            {
                if ((value != null))
                {
    				...
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<CC_ChiTietChamCong>("ERPModel.FK_CC_ChiTietChamCong_XepLoaiCanBo", "CC_ChiTietChamCong", value);
