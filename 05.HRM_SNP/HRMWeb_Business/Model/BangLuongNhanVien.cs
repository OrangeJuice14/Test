...
namespace HRMWeb_Business.Model
{
    ...
    public partial class BangLuongNhanVien : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [EdmScalarPropertyAttribute(EntityKeyProperty=false, IsNullable=true)]
        [DataMemberAttribute()]
        public Nullable<System.Guid> DotTinhLuong
        {
            get
            {
            ...
            set
            {
    			Nullable<System.Guid> oldValue =  _dotTinhLuong;
    			bool stopChanging = false;
                On_DotTinhLuong_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("DotTinhLuong");
    			if(!stopChanging)
    			{
    				_dotTinhLuong = StructuralObject.SetValidValue(value);
    				ReportPropertyChanged("DotTinhLuong");
    				On_DotTinhLuong_Changed(oldValue, _dotTinhLuong);//\\
    			}
            }
        }
    	public static String DotTinhLuong_PropertyName { get { return "DotTinhLuong"; } }
        private Nullable<System.Guid> _dotTinhLuong;
        partial void On_DotTinhLuong_Changing(Nullable<System.Guid> currentValue, ref Nullable<System.Guid> newValue, ref bool stopChanging);
        partial void On_DotTinhLuong_Changed(Nullable<System.Guid> oldValue, Nullable<System.Guid> currentValue);
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_BangLuongNhanVien_CompanyInfo", "CompanyInfo")]
        public CompanyInfo CompanyInfo1
        {//test
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<CompanyInfo>("ERPModel.FK_BangLuongNhanVien_CompanyInfo", "CompanyInfo").Value;
            }
            set
            {
    			bool stopChanging = false;
    			...
    			if(!stopChanging)
    			{
    				((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<CompanyInfo>("ERPModel.FK_BangLuongNhanVien_CompanyInfo", "CompanyInfo").Value = value;
        ...
        public EntityReference<CompanyInfo> CompanyInfo1Reference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<CompanyInfo>("ERPModel.FK_BangLuongNhanVien_CompanyInfo", "CompanyInfo");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<CompanyInfo>("ERPModel.FK_BangLuongNhanVien_CompanyInfo", "CompanyInfo", value);
                }
            }
        }
