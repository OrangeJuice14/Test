...
namespace HRMWeb_Business.Model
{
    ...
    public partial class CC_QuanLyChamCong : ERP_Core.BaseEntityObject//EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_CC_QuanLyChamCong_CompanyInfo", "CompanyInfo")]
        public CompanyInfo CompanyInfo1
        {//test
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<CompanyInfo>("ERPModel.FK_CC_QuanLyChamCong_CompanyInfo", "CompanyInfo").Value;
            }
            set
            {
    			bool stopChanging = false;
    			...
    			if(!stopChanging)
    			{
    				((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<CompanyInfo>("ERPModel.FK_CC_QuanLyChamCong_CompanyInfo", "CompanyInfo").Value = value;
        ...
        public EntityReference<CompanyInfo> CompanyInfo1Reference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<CompanyInfo>("ERPModel.FK_CC_QuanLyChamCong_CompanyInfo", "CompanyInfo");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<CompanyInfo>("ERPModel.FK_CC_QuanLyChamCong_CompanyInfo", "CompanyInfo", value);
                }
            }
        }
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("ERPModel", "FK_CC_QuanLyChamCong_KyTinhLuong", "KyTinhLuong")]
        public KyTinhLuong KyTinhLuong1
        {//test
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<KyTinhLuong>("ERPModel.FK_CC_QuanLyChamCong_KyTinhLuong", "KyTinhLuong").Value;
            }
            set
            {
    			bool stopChanging = false;
    			...
    			if(!stopChanging)
    			{
    				((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<KyTinhLuong>("ERPModel.FK_CC_QuanLyChamCong_KyTinhLuong", "KyTinhLuong").Value = value;
        ...
        public EntityReference<KyTinhLuong> KyTinhLuong1Reference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<KyTinhLuong>("ERPModel.FK_CC_QuanLyChamCong_KyTinhLuong", "KyTinhLuong");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<KyTinhLuong>("ERPModel.FK_CC_QuanLyChamCong_KyTinhLuong", "KyTinhLuong", value);
                }
            }
        }
