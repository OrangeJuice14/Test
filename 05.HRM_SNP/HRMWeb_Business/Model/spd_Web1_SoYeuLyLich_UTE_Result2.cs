...
namespace HRMWeb_Business.Model
{
    ...
    /// </summary>
    [EdmComplexTypeAttribute(NamespaceName="ERPModel", Name="spd_Web1_SoYeuLyLich_UTE_Result2")]
    [DataContractAttribute(IsReference=true)]
    [Serializable()]
    public partial class spd_Web1_SoYeuLyLich_UTE_Result2 : ComplexObject
    {
        #region Factory Method
    
        /// <summary>
        /// Create a new spd_Web1_SoYeuLyLich_UTE_Result2 object.
        /// </summary>
        ...
        public static spd_Web1_SoYeuLyLich_UTE_Result2 Createspd_Web1_SoYeuLyLich_UTE_Result2(string gioiTinh, string hinhThucTuyenDung, string congViecTuyenDung, string chucVuKiemNhiem, string chucVuCaoNhatDaQua)
        {
            spd_Web1_SoYeuLyLich_UTE_Result2 spd_Web1_SoYeuLyLich_UTE_Result2 = new spd_Web1_SoYeuLyLich_UTE_Result2();
            spd_Web1_SoYeuLyLich_UTE_Result2.GioiTinh = gioiTinh;
            spd_Web1_SoYeuLyLich_UTE_Result2.HinhThucTuyenDung = hinhThucTuyenDung;
            spd_Web1_SoYeuLyLich_UTE_Result2.CongViecTuyenDung = congViecTuyenDung;
            spd_Web1_SoYeuLyLich_UTE_Result2.ChucVuKiemNhiem = chucVuKiemNhiem;
            spd_Web1_SoYeuLyLich_UTE_Result2.ChucVuCaoNhatDaQua = chucVuCaoNhatDaQua;
            return spd_Web1_SoYeuLyLich_UTE_Result2;
        }
