...
namespace HRMWeb_Business.Model
{
    ...
    /// </summary>
    [EdmComplexTypeAttribute(NamespaceName="ERPModel", Name="spd_Web1_TrinhDoChuyenMon_UTE_Result2")]
    [DataContractAttribute(IsReference=true)]
    [Serializable()]
    public partial class spd_Web1_TrinhDoChuyenMon_UTE_Result2 : ComplexObject
    {
        #region Factory Method
    
        /// <summary>
        /// Create a new spd_Web1_TrinhDoChuyenMon_UTE_Result2 object.
        /// </summary>
        /// <param name="hocHam">Initial value of the HocHam property.</param>
        /// <param name="namCongNhan">Initial value of the NamCongNhan property.</param>
        /// <param name="dangTheoHoc">Initial value of the DangTheoHoc property.</param>
        /// <param name="lyLuanChinhTri">Initial value of the LyLuanChinhTri property.</param>
        /// <param name="quanLyNhaNuoc">Initial value of the QuanLyNhaNuoc property.</param>
        /// <param name="quanLyKinhTe">Initial value of the QuanLyKinhTe property.</param>
        /// <param name="quanLyGiaoDuc">Initial value of the QuanLyGiaoDuc property.</param>
        /// <param name="danhHieuDuocPhong">Initial value of the DanhHieuDuocPhong property.</param>
        public static spd_Web1_TrinhDoChuyenMon_UTE_Result2 Createspd_Web1_TrinhDoChuyenMon_UTE_Result2(string hocHam, string namCongNhan, string dangTheoHoc, string lyLuanChinhTri, string quanLyNhaNuoc, string quanLyKinhTe, string quanLyGiaoDuc, string danhHieuDuocPhong)
        {
            spd_Web1_TrinhDoChuyenMon_UTE_Result2 spd_Web1_TrinhDoChuyenMon_UTE_Result2 = new spd_Web1_TrinhDoChuyenMon_UTE_Result2();
            spd_Web1_TrinhDoChuyenMon_UTE_Result2.HocHam = hocHam;
            spd_Web1_TrinhDoChuyenMon_UTE_Result2.NamCongNhan = namCongNhan;
            spd_Web1_TrinhDoChuyenMon_UTE_Result2.DangTheoHoc = dangTheoHoc;
            spd_Web1_TrinhDoChuyenMon_UTE_Result2.LyLuanChinhTri = lyLuanChinhTri;
            spd_Web1_TrinhDoChuyenMon_UTE_Result2.QuanLyNhaNuoc = quanLyNhaNuoc;
            spd_Web1_TrinhDoChuyenMon_UTE_Result2.QuanLyKinhTe = quanLyKinhTe;
            spd_Web1_TrinhDoChuyenMon_UTE_Result2.QuanLyGiaoDuc = quanLyGiaoDuc;
            spd_Web1_TrinhDoChuyenMon_UTE_Result2.DanhHieuDuocPhong = danhHieuDuocPhong;
            return spd_Web1_TrinhDoChuyenMon_UTE_Result2;
        }
    ...
    #region Primitive Properties
        ...
        public string HocHam
        {
            ...
            set
            {
    			...
    			if(!stopChanging)
    			{
    				_hocHam = StructuralObject.SetValidValue(value, false);
        ...
        public string NamCongNhan
        {
            ...
            set
            {
    			...
    			if(!stopChanging)
    			{
    				_namCongNhan = StructuralObject.SetValidValue(value, false);
        ...
        public string DangTheoHoc
        {
            ...
            set
            {
    			...
    			if(!stopChanging)
    			{
    				_dangTheoHoc = StructuralObject.SetValidValue(value, false);
        ...
        public string LyLuanChinhTri
        {
            ...
            set
            {
    			...
    			if(!stopChanging)
    			{
    				_lyLuanChinhTri = StructuralObject.SetValidValue(value, false);
        ...
        public string QuanLyNhaNuoc
        {
            ...
            set
            {
    			...
    			if(!stopChanging)
    			{
    				_quanLyNhaNuoc = StructuralObject.SetValidValue(value, false);
        ...
        public string QuanLyKinhTe
        {
            ...
            set
            {
    			...
    			if(!stopChanging)
    			{
    				_quanLyKinhTe = StructuralObject.SetValidValue(value, false);
        ...
        public string QuanLyGiaoDuc
        {
            ...
            set
            {
    			...
    			if(!stopChanging)
    			{
    				_quanLyGiaoDuc = StructuralObject.SetValidValue(value, false);
        ...
        public string DanhHieuDuocPhong
        {
            ...
            set
            {
    			...
    			if(!stopChanging)
    			{
    				_danhHieuDuocPhong = StructuralObject.SetValidValue(value, false);
