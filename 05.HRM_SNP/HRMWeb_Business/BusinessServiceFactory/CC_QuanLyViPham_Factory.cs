        ...
        public IQueryable<DTO_QuanLyViPham_Find> FindForQuanLyViPham(int ngay, int thang, int nam, Guid boPhanId)
        {
            ...
            if (boPhanId!=Guid.Empty)
            {
                result = (from o in this.ObjectSet
                          where o.CC_ChamCongTheoNgay.Ngay.Day == ngay && o.CC_ChamCongTheoNgay.Ngay.Month == thang && o.CC_ChamCongTheoNgay.Ngay.Year == nam && o.CC_ChamCongTheoNgay.Department.Oid == boPhanId
                          ...
                          select new DTO_QuanLyViPham_Find() {
                              ...
                              SoHieuCongChuc = o.CC_ChamCongTheoNgay.HoSo.MaQuanLy,
                              TenPhongBan = o.CC_ChamCongTheoNgay.Department.TenBoPhan,
