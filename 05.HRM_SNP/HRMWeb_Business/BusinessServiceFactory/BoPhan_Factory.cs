...
{
    public class BoPhan_Factory : BaseFactory<Entities, Department>
    {
        ...
        public IQueryable<Department> GetAll_GCRecordIsNull()
        {//su dung cho cham cong only
            var result = from o in this.ObjectSet
                         where o.GCRecord == null
                          //Tan Cang
                          //&& o.BoPhanCha == new Guid("18893825-0B2C-43C6-8201-2DE820E99B21")
                         orderby o.STT ascending, o.TenBoPhan ascending
                         select o;
            return result;
        }
        public Department GetByID(Guid oid)
        {
            var result = (from o in this.ObjectSet
                          where o.Oid == oid
        ...
        public IQueryable<Department> GetDanhSachBoPhan_DuocPhanQuyenChoWebUserId_GCRecordIsNull(Guid webUserId)
        {//su dung cho cham cong only
            var result = (from o in this.Context.Departments
                          where o.WebUser_Department.Any(x => x.IDWebUser == webUserId)
                          //Tan Cang
                          //&& o.BoPhanCha == new Guid("18893825-0B2C-43C6-8201-2DE820E99B21")
                          && o.GCRecord == null
                          orderby o.STT ascending, o.TenBoPhan ascending
        ...
        public IEnumerable<DTO_KiemTraPhongBanXetABC> KiemTraPhongBanXetABC_Find(int thang, int nam, Boolean? daXetXongABC)
        {
            ...
            query = (from o in this.Context.Departments
                     let tonTaiTrangThaiChuaXet = o.CC_ChiTietChamCong.Any(x => x.CC_QuanLyChamCong.KyTinhLuong1.TuNgay.Value.Month == thang
                                                                                && x.CC_QuanLyChamCong.KyTinhLuong1.TuNgay.Value.Year == nam
                                                                            )
