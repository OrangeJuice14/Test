...
namespace HRMWeb_Service
{
    ...
    public partial class Service1 : IService1
    {
        ...
        public IEnumerable<DTO_ChiTietChamCongNhanVien> GetList_ChiTietChamCongNhanVien(String publicKey, String token)
        {
            ...
            {
                var factory = CC_ChiTietChamCong_Factory.New();
        ...
        public IEnumerable<DTO_XepLoaiCanBo> GetList_XepLoai()
        {
                var factory = CC_ChiTietChamCong_Factory.New();
                IEnumerable<DTO_XepLoaiCanBo> list = factory.GetList_XepLoai().Map<DTO_XepLoaiCanBo>().ToList();
                return list;
        }
        public String GetList_XepLoai_Json()
        {
            IEnumerable<DTO_XepLoaiCanBo> list = GetList_XepLoai();
            String json = JsonConvert.SerializeObject(list);
            return json;
        }
        ...
        public bool Save_ChiTietChamCongNhanVien(String publicKey, String token, DTO_ChiTietChamCongNhanVien obj)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                if (obj != null)
                {
                    CC_ChiTietChamCong_Factory factory = CC_ChiTietChamCong_Factory.New();
                    CC_ChiTietChamCong objFromDB = factory.GetById(obj.Oid);
                    if (objFromDB == null)
                    {
                        //them moi
                        //map sang entity
        ...
        public bool Delete_ChiTietChamCongNhanVienBy_Id(String publicKey, String token, Guid id)
        {
            ...
            {
                var factory = CC_ChiTietChamCong_Factory.New();
                CC_ChiTietChamCong obj = factory.GetById(id);
                if (obj != null)
                {
                    try
                    {
                        CC_ChiTietChamCong_Factory.FullDelete(factory.Context, obj);
                        factory.SaveChanges();
                        return true;
                    }
                    catch (Exception ex)
        ...
        public bool ChiTietChamCongNhanVien_Save(Guid Oid, decimal NgayCongChuan,
                        ...
                        decimal NgayNghiKhongPhep, decimal NgayNghiThaiSan, Guid XepLoaiCanBo,
                        decimal HeSoXepLoai, decimal HeSoNgayCong)
        {
                CC_ChiTietChamCong_Factory factory = CC_ChiTietChamCong_Factory.New();
                if (Oid != Guid.Empty)
                {
                CC_ChiTietChamCong obj = factory.GetById(Oid);
                    if (obj != null)
                    {
                    obj.NgayCongChuan = NgayCongChuan;
                    obj.NgayCongThucTe = NgayCongThucTe;
                    obj.NgayCongCangTra = NgayCongCangTra;
                    obj.NgayCongNghi = NgayCongNghi;
                    obj.NgayCongSuaChua = NgayCongSuaChua;
                    obj.NgayCongLamLe = NgayCongLamLe;
                    obj.NgayCongNghiLe = NgayCongNghiLe;
                    obj.NgayCongAnCa = NgayCongAnCa;
                    obj.NgayCongDocHai = NgayCongDocHai;
                    obj.NgayCongLamDem = NgayCongLamDem;
                    obj.NgayNghiPhep = NgayNghiPhep;
                    obj.NgayNghiKhongPhep = NgayNghiKhongPhep;
                    obj.NgayNghiThaiSan = NgayNghiThaiSan;
                    obj.XepLoaiCanBo = XepLoaiCanBo;
                    obj.HeSoXepLoai = HeSoXepLoai;
                    obj.HeSoNgayCong = HeSoNgayCong;
                }
                    try
                    {
                        factory.SaveChanges();
        ...
        public bool DeleteList_ChiTietChamCongNhanVienBy_IdList(String publicKey, String token, List<Guid> idList)
        {
            if (Helper.TrustTest(publicKey, token))
            {
                ...
                if (objList != null)
                {
                    try
                    {
                        CC_ChiTietChamCong_Factory.FullDelete(factory.Context, objList);
                        factory.SaveChanges();
                        return true;
                    }
                    catch (Exception ex)
