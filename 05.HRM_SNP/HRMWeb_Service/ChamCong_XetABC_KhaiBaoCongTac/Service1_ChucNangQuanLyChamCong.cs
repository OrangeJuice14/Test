...
namespace HRMWeb_Service
{
    ...
    public partial class Service1 : IService1
    {
        ...
        */
        ...
        public IEnumerable<DTO_ChiTietChamCong_Find> ChiTietChamCong_Find(String publicKey, String token, int thang, int nam, Guid? boPhanId)
        {
            if (Helper.TrustTest(publicKey, token))
            {

                CC_ChiTietChamCong_Factory factory = CC_ChiTietChamCong_Factory.New();
                IEnumerable<DTO_ChiTietChamCong_Find> list = null;
                    list = factory.ChiTietChamCong_Thang(thang, nam, boPhanId);
                return list;
            }
            else
            {
        ...
        public String ChiTietChamCong_Find_Json(String publicKey, String token,int thang, int nam, Guid? boPhanId)
        {//DANG SD
            IEnumerable<DTO_ChiTietChamCong_Find> list = ChiTietChamCong_Find(publicKey, token, thang, nam, boPhanId);
            String json = JsonConvert.SerializeObject(list);
            return json;
        }
