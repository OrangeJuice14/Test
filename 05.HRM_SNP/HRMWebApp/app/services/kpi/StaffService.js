define(['app/app'], function (app) {
    ...
    app.factory('staffService', ['$http', '$q', function ($http, $q) {
        ...
        serviceResult.getDepartmentStaff = function (agentObjectTypeId) {
            return $http.get('/Api/staffApi/GetDepartmentStaff?agentObjectTypeId=' + agentObjectTypeId);
        };
        ...
        serviceResult.getViceDepartmentStaff = function (typeId, departmentId) {
            return $http.get('/Api/staffApi/GetViceDepartmentStaff?typeId=' + typeId + '&departmentId=' + departmentId);
        };
