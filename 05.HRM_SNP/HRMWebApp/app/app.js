define(['angularAMD', 'ui-route', 'ui-validate', 'ui-bootstrap', 'kendo', 'ui-bootstrap-tpls'], function (angularAMD) {
    ...
    HRMWebApp.config(['$stateProvider', '$urlRouterProvider','$locationProvider', function ($stateProvider, $urlRouterProvider, $locationProvider) {
        ...
        ////////////////////***********  CHAM CONG ********************///////////////////////////
            ...
            .state('chitietchamcongthang', angularAMD.route({
                data: {
                    roles: ['kpi/chitietchamcongthang']
                },
                resolve: {
                    authorize: ['authorization',
                        function (authorization) {
                ...
                url: '/kpi/chitietchamcongthang',
                templateUrl: '/app/views/chamcong/QuanLyChamCong/ChiTietChamCongThang.html'
            }))
        ...
        .state('importexcel', angularAMD.route({
            ...
            url: '/kpi/importexcel',
            templateUrl: '/app/views/chamcong/QuanLyChamCong/ImportDulieuChamCong.html',
            controller: 'ImportDuLieuChamCongController',
            controllerUrl: 'app/controllers/chamcong/ImportDuLieuChamCongController'
        }))
